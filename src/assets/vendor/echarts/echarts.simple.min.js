...
!(function (t, e) {
  ...
  var a,
    ...
    u = {
      ...
      measureText: function (t, e) {
        if (!a) {
          var n = u.createCanvas();
          a = n && n.getContext('2d');
        }
        if (a) return s !== e && (s = a.font = e || o), a.measureText(t);
        t = t || '';
        var i = /(\d+)px/.exec((e = e || o)),
          r = (i && +i[1]) || 12,
          h = 0;
        if (e.indexOf('mono') >= 0) h = r * t.length;
        else
  ...
  function T(t) {
    ...
    } else if (!c[n] && !ut(t) && !j(t))
      for (var a in ((e = {}), t))
        t.hasOwnProperty(a) && a !== w && (e[a] = T(t[a]));
    return e;
  }
  function C(t, e, n) {
    if (!Y(e) || !Y(t)) return n ? T(e) : t;
    for (var i in e)
  ...
  function R(t, e, n) {
    if (t && e)
      if (t.forEach && t.forEach === g) t.forEach(e, n);
  ...
  function N(t, e, n) {
    if (!t) return [];
    if (!e) return it(t);
    if (t.map && t.map === m) return t.map(e, n);
  ...
  var ht = (function () {
    ...
    ct = 'function' == typeof Map;
  var pt = (function () {
    function t(e) {
      var n = H(e);
      this.data = ct ? new Map() : new ht();
      var i = this;
      function r(t, e) {
        n ? i.set(t, e) : i.set(e, t);
      }
      e instanceof t ? e.each(r) : e && R(e, r);
    }
    return (
      ...
      return (
        (t.prototype._dragStart = function (t) {
          ...
          e &&
            ...
            (this._x = t.offsetX),
            (this._y = t.offsetY),
            this.handler.dispatchToElement(new Vt(e, t), 'dragstart', t.event));
        }),
        (t.prototype._drag = function (t) {
          ...
          if (e) {
            ...
            (this._x = n),
              (this._y = i),
              e.drift(r, o, t),
              this.handler.dispatchToElement(new Vt(e, t), 'drag', t.event);
        ...
        (t.prototype._dragEnd = function (t) {
          var e = this._draggingTarget;
          e && (e.dragging = !1),
            this.handler.dispatchToElement(new Vt(e, t), 'dragend', t.event),
            this._dropTarget &&
              this.handler.dispatchToElement(
                new Vt(this._dropTarget, t),
                'drop',
                t.event
              ),
  ...
  function Ut(t, e, n, i, r, o) {
    ...
    for (var c = 0, p = 0, f = 0; p < s; p++) {
      var d = 1 << p;
      d & r ||
        ((c += (f % 2 ? -1 : 1) * t[n][p] * Ut(t, e - 1, h, u, r | d, o)), f++);
    }
    return (o[a] = c), c;
  }
  function Xt(t, e) {
  ...
  function qt(t, e, n, i, o) {
    if (e.getBoundingClientRect && r.domSupported && !Zt(e)) {
      var a = e[Yt] || (e[Yt] = {}),
        s = (function (t, e) {
          var n = e.markers;
          if (n) return n;
        ...
        l = (function (t, e, n) {
          ...
          return l && r
            ? r
            : ((e.srcCoords = a), (e[i] = n ? Xt(s, a) : Xt(a, s)));
        })(s, a, o);
  ...
  function $t(t) {
    return null == t
      ? ''
      : (t + '').replace(jt, function (t, e) {
          return Kt[e];
        });
  }
  var Qt = /^(?:mouse|pointer|contextmenu|drag|drop)|click/,
    Jt = [],
    te = r.browser.firefox && +r.browser.version.split('.')[0] < 39;
  function ee(t, e, n, i) {
    return (
      (n = n || {}),
      i
        ? ne(t, e, n)
        : te && null != e.layerX && e.layerX !== e.offsetX
  ...
  function ne(t, e, n) {
    if (r.domSupported && t.getBoundingClientRect) {
      ...
      if (qt(Jt, t, i, o)) return (n.zrX = Jt[0]), void (n.zrY = Jt[1]);
    }
    n.zrX = n.zrY = 0;
  }
  function ie(t) {
      ...
      return (
        (t.prototype.union = function (t) {
          ...
          isFinite(this.x) && isFinite(this.width)
            ? (this.width = _e(t.x + t.width, this.x + this.width) - e)
            : (this.width = t.width),
            isFinite(this.y) && isFinite(this.height)
              ? (this.height = _e(t.y + t.height, this.y + this.height) - n)
        ...
        (t.prototype.calculateTransform = function (t) {
          var e = this,
            ...
            r = [1, 0, 0, 1, 0, 0];
          return (
            pe(r, r, [-e.x, -e.y]), de(r, r, [n, i]), pe(r, r, [t.x, t.y]), r
          );
        }),
        (t.prototype.intersect = function (e, n) {
          ...
          if (n) {
            var f = 1 / 0,
              ...
              x = Math.min(v, m);
            o < l || u < r
              ? _ > d && ((d = _), g < y ? ve.set(Te, -g, 0) : ve.set(Te, y, 0))
              : _ < f &&
                ((f = _), g < y ? ve.set(Me, g, 0) : ve.set(Me, -y, 0)),
              s < h || c < a
                ? x > d &&
                  ((d = x), v < m ? ve.set(Te, 0, -v) : ve.set(Te, 0, m))
                : _ < f &&
                  ((f = _), v < m ? ve.set(Me, 0, v) : ve.set(Me, 0, -m));
          }
          return n && ve.copy(n, p ? Me : Te), p;
        }),
        ...
        (t.applyTransform = function (e, n, i) {
          if (i) {
            ...
            (xe.x = be.x = n.x),
              (xe.y = Se.y = n.y),
              (we.x = Se.x = n.x + n.width),
              (we.y = be.y = n.y + n.height),
              xe.transform(i),
              Se.transform(i),
              we.transform(i),
              be.transform(i),
              (e.x = me(xe.x, we.x, be.x, Se.x)),
              (e.y = me(xe.y, we.y, be.y, Se.y));
            var l = _e(xe.x, we.x, be.x, Se.x),
              u = _e(xe.y, we.y, be.y, Se.y);
    ...
    Oe = (function (t) {
      ...
      return (
        ...
        (e.prototype.mousemove = function (t) {
          ...
          var a = (this._hovered = i ? new Ae(e, n) : this.findHover(e, n)),
            s = a.target,
            l = this.proxy;
        ...
        (e.prototype.findHover = function (t, e, n) {
          var i = this.storage.getDisplayList(),
            r = new Ae(t, e);
          if ((Ne(i, r, t, e, n), this._pointerSize && !r.target)) {
            for (
              var o = [],
                a = this._pointerSize,
                s = a / 2,
                l = new Ce(t - s, e - s, a, a),
                u = i.length - 1;
              u >= 0;
              u--
            ) {
              ...
              h === n ||
                ...
                h.transform && Pe.applyTransform(h.transform),
                Pe.intersect(l) && o.push(h));
            }
            if (o.length)
              for (var c = Math.PI / 12, p = 2 * Math.PI, f = 0; f < s; f += 4)
                for (var d = 0; d < p; d += c) {
                  if (
                    (Ne(o, r, t + f * Math.cos(d), e + f * Math.sin(d), n),
                    r.target)
                  )
                    return r;
                }
        ...
        (e.prototype.processGesture = function (t, e) {
          this._gestureMgr || (this._gestureMgr = new oe());
  ...
  function Ne(t, e, n, i, r) {
    for (var o = t.length - 1; o >= 0; o--) {
      ...
      if (
        ...
        !a.ignore &&
        (s = Re(a, n, i)) &&
        (!e.topTarget && (e.topTarget = a), s !== De)
      ) {
        e.target = a;
        break;
      }
      ...
      Oe.prototype[t] = function (e) {
        ...
        if (
          ...
          if (
            ...
            !this._downPoint ||
            Pt(this._downPoint, [e.zrX, e.zrY]) > 4
          )
            return;
  ...
  function He(t, e) {
    ...
    function s(s) {
      ...
      (i[s] = u + c),
        ...
        o--;
      var p = Ve(t[h], t, l, u, 0, e);
      (l += p),
        0 !== (u -= p) &&
          0 !== (c = Fe(t[l + u - 1], t, h, c, c - 1, e)) &&
          (u <= c
            ? (function (n, i, o, s) {
                var l = 0;
  ...
  function We(t, e, n, i) {
    ...
    if (!(r < 2)) {
      var o = 0;
      if (r < 32) Be(t, n, i, n + (o = ze(t, n, i, e)), e);
      else {
        var a = He(t, e),
          s = (function (t) {
  ...
  var Ye = (function () {
      ...
      return (
        ...
        (t.prototype.updateDisplayList = function (t) {
          ...
          (n.length = this._displayListLen), We(n, Xe);
        }),
            ...
            if (t.childrenRef) {
              ...
              e && e.length
                ...
                : u.__clipPaths &&
                  ...
                  (u.__clipPaths = []),
                isNaN(u.z) && (Ue(), (u.z = 0)),
                isNaN(u.z2) && (Ue(), (u.z2 = 0)),
                isNaN(u.zlevel) && (Ue(), (u.zlevel = 0)),
  ...
  function un(t, e, n, i, r, o) {
    ...
    if (on(h) && on(c)) {
      ...
      if (on(d)) {
        ...
        (M =
          (-s -
            ((m = m < 0 ? -je(-m, tn) : je(m, tn)) +
              (_ = _ < 0 ? -je(-_, tn) : je(_, tn)))) /
          (3 * a)) >= 0 &&
          M <= 1 &&
          (o[f++] = M);
      } else {
        var x = (2 * h * s - 3 * a * c) / (2 * Ke(h * h * h)),
          w = Math.acos(x) / 3,
          b = Ke(h),
          S = Math.cos(w),
          M = (-s - 2 * b * S) / (3 * a),
          T =
            ((y = (-s + b * (S + Je * Math.sin(w))) / (3 * a)),
            (-s + b * (S - Je * Math.sin(w))) / (3 * a));
        M >= 0 && M <= 1 && (o[f++] = M),
          y >= 0 && y <= 1 && (o[f++] = y),
          T >= 0 && T <= 1 && (o[f++] = T);
      }
  ...
  var xn = (function () {
      function t(t) {
        (this._inited = !1),
          ...
          (this.loop = t.loop || !1),
          (this.onframe = t.onframe || mt),
          (this.ondestroy = t.ondestroy || mt),
          (this.onrestart = t.onrestart || mt),
      ...
      return (
        ...
        (t.prototype.setEasing = function (t) {
          (this.easing = t), (this.easingFunc = W(t) ? t : Ze[t] || _n(t));
        }),
        t
      );
    })(),
  ...
  var On = new Sn(20),
    Rn = null;
  function Nn(t, e) {
    Rn && Pn(Rn, e), (Rn = On.put(t, Rn || e.slice()));
  }
  function En(t, e) {
    if (t) {
      e = e || [];
      ...
      if (i in Mn) return Pn(e, Mn[i]), Nn(t, e), e;
      var r,
        o = i.length;
      if ('#' === i.charAt(0))
        return 4 === o || 5 === o
  ...
  var Xn = Object.freeze({
    ...
    modifyHSL: function (t, e, n, i) {
      ...
      if (t)
        return (
          ...
          null != e &&
            (o[0] = ((r = e), (r = Math.round(r)) < 0 ? 0 : r > 360 ? 360 : r)),
          null != n && (o[1] = In(n)),
          null != i && (o[2] = In(i)),
          Gn(zn(o), 'rgba')
        );
    ...
    modifyAlpha: function (t, e) {
      var n = En(t);
      if (n && null != e) return (n[3] = Cn(e)), Gn(n, 'rgba');
    },
    stringify: Gn,
    lum: Un,
    random: function () {
  ...
  var Yn = Array.prototype.slice;
  function qn(t, e, n) {
    return (e - t) * n + t;
  }
  function Zn(t, e, n, i) {
    for (var r = e.length, o = 0; o < r; o++) t[o] = qn(e[o], n[o], i);
    return t;
  }
  function jn(t, e, n, i) {
  ...
  function Qn(t, e, n) {
    ...
    if (i.push && r.push) {
      ...
      if (o !== a)
        if (o > a) i.length = a;
        else for (var s = o; s < a; s++) i.push(1 === n ? r[s] : Yn.call(r[s]));
  ...
  function Jn(t) {
    if (O(t)) {
      var e = t.length;
      if (O(t[0])) {
        for (var n = [], i = 0; i < e; i++) n.push(Yn.call(t[i]));
        return n;
      }
      return Yn.call(t);
    }
      ...
      return (
        ...
        (t.prototype.addKeyframe = function (t, e, n) {
          ...
          if (O(e)) {
            ...
            var h = D({}, s);
            (h.colorStops = N(e.colorStops, function (t) {
              return { offset: t.offset, color: En(t.color) };
            })),
              'linear' === e.type
                ? (a = 4)
                : (function (t) {
          ...
          return (
            n && ((c.easing = n), (c.easingFunc = W(n) ? n : Ze[n] || _n(n))),
            i.push(c),
            c
          );
        }),
          ...
          if (
            ...
            for (u = 0; u < r; u++)
              0 === i
                ...
                : 3 === i
                  ? (n[u].additiveValue = jn([], n[u].value, f, -1))
                  : ni(i) &&
                    (n[u].additiveValue =
                      1 === i
                        ? jn([], n[u].value, f, -1)
          ...
          if (!this._finished) {
            ...
            if (1 === u) i = r = l[0];
              ...
              if (e < 0) n = 0;
                ...
                for (n = f(p + 1, u - 1); n >= 0 && !(l[n].percent <= e); n--);
                n = f(n, u - 2);
              } else {
            ...
            if (i && r) {
              ...
              var d = r.percent - i.percent,
                g = 0 === d ? 1 : f((e - i.percent) / d, 1);
              r.easingFunc && (g = r.easingFunc(g));
              var y = o ? this._additiveValue : c ? ii : t[h];
              if (
                ((!ni(s) && !c) || y || (y = this._additiveValue = []),
                this.discrete)
              )
                ...
                (t[h] = {
                  ...
                  x: qn(v.x, m.x, g),
                  y: qn(v.y, m.y, g),
                  colorStops: N(v.colorStops, function (t, e) {
                    var n = m.colorStops[e];
                    return {
                      offset: qn(t.offset, n.offset, g),
                      color: ti(Zn([], t.color, n.color, g)),
                    };
                  }),
                  global: m.global,
                }),
                  _
                    ? ((t[h].x2 = qn(v.x2, m.x2, g)),
                      (t[h].y2 = qn(v.y2, m.y2, g)))
                    : (t[h].r = qn(v.r, m.r, g));
              } else if (c) Zn(y, i[a], r[a], g), o || (t[h] = ti(y));
              else {
                var x = qn(i[a], r[a], g);
                o ? (this._additiveValue = x) : (t[h] = x);
              }
        ...
        (t.prototype._addToTarget = function (t) {
          ...
          0 === e
            ? (t[n] = t[n] + i)
            : 3 === e
              ? (En(t[n], ii), jn(ii, ii, i, 1), (t[n] = ti(ii)))
              : 1 === e
                ? jn(t[n], t[n], i, 1)
                : 2 === e && Kn(t[n], t[n], i, 1);
        }),
    ...
    oi = (function () {
      function t(t, e, n, i) {
        (this._tracks = {}),
          ...
          (this._loop = e),
          e && i
            ? M("Can' use additive animation on looped animation.")
      ...
      return (
          ...
          for (var r = this._tracks, o = 0; o < n.length; o++) {
            ...
            if (!s) {
              ...
              if (u) {
                var h = u.keyframes,
                  c = h[h.length - 1];
                (l = c && c.value), 3 === u.valType && l && (l = ti(l));
              } else l = this._target[a];
              if (null == l) continue;
              t > 0 && s.addKeyframe(0, Jn(l), i), this._trackKeys.push(a);
            }
            s.addKeyframe(t, Jn(e[a]), i);
          }
        ...
        (t.prototype.getTracks = function () {
          var t = this;
          return N(this._trackKeys, function (e) {
            return t._tracks[e];
          });
        }),
  ...
  var si,
    ...
    ui = (function (t) {
      ...
      return (
        ...
        (e.prototype.update = function (t) {
          for (
            var e = ai() - this._pausedTime, n = e - this._time, i = this._head;
            i;
        ...
        (e.prototype._startLoop = function () {
          ...
          (this._running = !0),
            qe(function e() {
              t._running && (qe(e), !t._paused && t.update());
            });
        }),
        (e.prototype.start = function () {
          this._running ||
            ((this._time = ai()), (this._pausedTime = 0), this._startLoop());
        }),
        (e.prototype.stop = function () {
          this._running = !1;
        }),
        (e.prototype.pause = function () {
          this._paused || ((this._pauseStart = ai()), (this._paused = !0));
        }),
        (e.prototype.resume = function () {
          this._paused &&
            ((this._pausedTime += ai() - this._pauseStart),
            (this._paused = !1));
        }),
    ...
    hi = r.domSupported,
    ci =
      ((li = { pointerdown: 1, pointerup: 1, pointermove: 1, pointerout: 1 }),
      {
        mouse: (si = [
          'click',
          'dblclick',
        ...
        pointer: N(si, function (t) {
          var e = t.replace('mouse', 'pointer');
          return li.hasOwnProperty(e) ? e : t;
        }),
      }),
    pi = ['mousemove', 'mouseup'],
    fi = ['pointermove', 'pointerup'],
    di = !1;
  function gi(t) {
    var e = t.pointerType;
  ...
  var mi = function (t, e) {
      (this.stopPropagation = mt),
        (this.stopImmediatePropagation = mt),
        (this.preventDefault = mt),
        (this.type = e.type),
    ...
    _i = {
      ...
      mouseout: function (t) {
        vi(this, (t = re(this.dom, t)).toElement || t.relatedTarget) ||
          (this.__pointerCapturing && (t.zrEventControl = 'no_globalout'),
          this.trigger('mouseout', t));
      },
      wheel: function (t) {
        (di = !0), (t = re(this.dom, t)), this.trigger('mousewheel', t);
      },
      mousewheel: function (t) {
        di || ((t = re(this.dom, t)), this.trigger('mousewheel', t));
      },
      ...
      pointermove: function (t) {
        gi(t) || _i.mousemove.call(this, t);
      },
      pointerup: function (t) {
        _i.mouseup.call(this, t);
      },
      pointerout: function (t) {
        gi(t) || _i.mouseout.call(this, t);
      },
    };
  R(['click', 'dblclick', 'contextmenu'], function (t) {
    _i[t] = function (e) {
  ...
  function wi(t, e) {
    ...
    r.pointerEventsSupported
      ? R(ci.pointer, function (i) {
          Si(e, i, function (e) {
            n[i].call(t, e);
          });
        })
      : (r.touchEventsSupported &&
          R(ci.touch, function (i) {
            Si(e, i, function (r) {
              n[i].call(t, r),
                (function (t) {
                  (t.touching = !0),
  ...
  function bi(t, e) {
    ...
    r.pointerEventsSupported ? R(fi, n) : r.touchEventsSupported || R(pi, n);
  }
  function Si(t, e, n, i) {
    (t.mounted[e] = n),
      (t.listenerOpts[e] = i),
    ...
    Ci = (function (t) {
      function e(e, n) {
        ...
        return (
          ...
          hi && (i._globalHandlerScope = new Ti(document, xi)),
      ...
      return (
        n(e, t),
        (e.prototype.dispose = function () {
          Mi(this._localHandlerScope), hi && Mi(this._globalHandlerScope);
        }),
      ...
      return (
        ...
        (t.prototype.decomposeTransform = function () {
          if (this.transform) {
            var t = this.parent,
              e = this.transform;
            t && t.transform && (ce(Ni, t.invTransform, e), (e = Ni));
            var n = this.originX,
              i = this.originY;
            (n || i) &&
              ((Ei[4] = n),
        ...
        (t.prototype.getLineScale = function () {
          ...
          return t && zi(t[0] - 1) > 1e-10 && zi(t[3] - 1) > 1e-10
            ? Math.sqrt(zi(t[0] * t[3] - t[2] * t[1]))
            : 1;
        }),
  ...
  function Wi(t, e, n, i) {
    var r = Hi(t, e),
      ...
      a = Ui(0, r, n),
      s = Xi(0, o, i);
    return new Ce(a, s, r, o);
  }
  function Gi(t, e, n, i) {
    var r = ((t || '') + '').split('\n');
    if (1 === r.length) return Wi(r[0], e, n, i);
    for (var o = new Ce(0, 0, 0, 0), a = 0; a < r.length; a++) {
      var s = Wi(r[a], e, n, i);
      ...
      return (
            ...
            if ((r.copyTransform(e), null != n.position)) {
              ...
              n.layoutRect
                ...
                this.calculateTextPosition
                  ? this.calculateTextPosition(Qi, n, u)
                  : Zi(Qi, n, u),
                (r.x = Qi.x),
                (r.y = Qi.y),
                (o = Qi.align),
              ...
              if (h && null != n.rotation) {
                ...
                'center' === h
                  ...
                  : ((c = qi(h[0], u.width)), (p = qi(h[1], u.height))),
                  (l = !0),
          ...
          'textConfig' === t
            ...
            : 'textContent' === t
              ...
              : 'clipPath' === t
                ? this.setClipPath(e)
                : 'extra' === t
                  ? ((this.extra = this.extra || {}), D(this.extra, e))
                  : (this[t] = e);
        }),
        ...
        (t.prototype._innerSaveToNormal = function (t) {
          ...
          e || (e = this._normalState = {}),
            ...
            this._savePrimaryToNormal(t, e, Ki);
        }),
        ...
        (t.prototype._mergeStates = function (t) {
          for (var e, n = {}, i = 0; i < t.length; i++) {
            var r = t[i];
            D(n, r), r.textConfig && D((e = e || {}), r.textConfig);
          }
        ...
        (t.prototype._applyStateObj = function (t, e, n, i, r, o) {
          var a = !(e && i);
          e && e.textConfig
            ? ((this.textConfig = D({}, i ? this.textConfig : n.textConfig)),
              D(this.textConfig, e.textConfig))
            : a && n.textConfig && (this.textConfig = n.textConfig);
          for (var s = {}, l = !1, u = 0; u < Ki.length; u++) {
            var h = Ki[u],
              c = r && $i[h];
            e && null != e[h]
              ? c
          ...
          if (!r)
            for (u = 0; u < this.animators.length; u++) {
              var p = this.animators[u],
                f = p.targetName;
              p.getLoop() || p.__changeFinalValue(f ? (e || n)[f] : e || n);
            }
        ...
        (t.prototype._transitionState = function (t, e, n, i) {
          for (var r = er(this, e, n, i), o = 0; o < r.length; o++)
  ...
  function rr(t, e, n, i, r, o, a, s) {
    for (
      ...
      var v = l[y],
        m = i[v];
      if (null != m && null != n[v] && (f || o[v]))
        if (!Y(m) || O(m) || K(m)) g.push(v);
        else {
          if (e) {
            s || ((n[v] = m), t.updateDuringAnimation(e));
            continue;
          }
          rr(t, v, n[v], m, r, o && o[v], a, s);
        }
    ...
    if (
      ...
      if (s) {
        (M = {}), p && (S = {});
        for (x = 0; x < _; x++) {
          (M[(v = g[x])] = n[v]), p ? (S[v] = i[v]) : (n[v] = i[v]);
        }
      } else if (p) {
        T = {};
        for (x = 0; x < _; x++) {
          (T[(v = g[x])] = Jn(n[v])), ir(n, i, v);
        }
      }
      ((b = new oi(
        n,
        ...
        r.scope && (b.scope = r.scope),
        p && S && b.whenWithKeys(0, S, g),
        T && b.whenWithKeys(0, T, g),
        b.whenWithKeys(null == u ? 500 : u, s ? M : i, g).delay(h || 0),
        t.addAnimator(b, e),
        a.push(b);
    }
  }
      ...
      (e.prototype.getBoundingRect = function (t) {
        for (
          ...
          if (!a.ignore && !a.invisible) {
            ...
            l
              ? (Ce.applyTransform(e, s, l), (r = r || e.clone()).union(e))
              : (r = r || s.clone()).union(s);
          }
        }
        return r || e;
  ...
  var lr = (function () {
    function t(t, e, n) {
      ...
      var s = new ar[a](e, o, n, t),
        l = n.ssr || s.ssrOnly;
      (this.storage = o), (this.painter = s);
      var u,
        h =
          r.node || r.worker || l ? null : new Ci(s.getViewportRoot(), s.root),
        c = n.useCoarsePointer;
      (null == c || 'auto' === c ? r.touchEventsSupported : !!c) &&
        (u = et(n.pointerSize, 44)),
        (this.handler = new Oe(o, s, h, s.root, u)),
        (this.animation = new ui({
          stage: {
            update: l
              ? null
              : function () {
    ...
    return (
      ...
      (t.prototype.setBackgroundColor = function (t) {
        this.painter.setBackgroundColor && this.painter.setBackgroundColor(t),
          ...
          (this._darkMode = (function (t) {
            if (!t) return !1;
            if ('string' == typeof t) return Un(t, 1) < 0.4;
            if (t.colorStops) {
      ...
      (t.prototype.clear = function () {
        for (var t = this.storage.getRoots(), e = 0; e < t.length; e++)
          t[e] instanceof or && t[e].removeSelfFromZr(this);
  ...
  var cr = Object.freeze({
      ...
      disposeAll: function () {
        for (var t in sr) sr.hasOwnProperty(t) && sr[t].dispose();
        sr = {};
      },
  ...
  function xr(t, e) {
    var n = Math.max(yr(t), yr(e)),
      i = t + e;
    return n > 20 ? i : gr(i, n);
  }
  function wr(t) {
    var e = 2 * Math.PI;
    return ((t % e) + e) % e;
  ...
  function Ir(t) {
    var e = parseFloat(t);
    return e == t && (0 !== e || !G(t) || t.indexOf('x') <= 0) ? e : NaN;
  }
  function kr(t) {
    return !isNaN(Ir(t));
  }
  ...
  function Fr(t) {
    return !Y(t) || H(t) || t instanceof Date ? t : t.value;
  }
  function Vr(t) {
    return Y(t) && !(t instanceof Array);
  }
  function Hr(t, e, n) {
    var i = 'normalMerge' === n,
      r = 'replaceMerge' === n,
      ...
      u = (function (t, e, n) {
        ...
        for (var r = 0; r < t.length; r++) {
          ...
          o && null != o.id && e.set(o.id, r),
            i.push({
              existing: 'replaceMerge' === n || Yr(o) ? null : o,
              newOption: null,
              keyInfo: null,
              brandNew: null,
            });
    ...
    return (
        ...
        (function (t, e, n, i) {
          R(i, function (r, o) {
            if (r && null != r.id) {
              ...
              if (null != s) {
                var l = t[s];
                ot(!l.newOption, 'Duplicated option on id "' + a + '".'),
                  (l.newOption = r),
                  (l.existing = e[s]),
                  (i[o] = null);
              }
            ...
            R(e, function (e) {
              if (e) {
                for (
                  ...
                  (i.newOption ||
                    Yr(i.existing) ||
                    (i.existing && null != e.id && !Wr('id', e, i.existing)));
      ...
      R(s, function (t, e) {
        var n = t.existing,
          ...
          r = t.keyInfo;
        if (Y(i)) {
          if (((r.name = null != i.name ? Gr(i.name) : n ? n.name : Nr + e), n))
            r.id = Gr(n.id);
          else if (null != i.id) r.id = Gr(i.id);
          else {
            var o = 0;
            do {
              r.id = '\0' + r.name + '\0' + o++;
  ...
  function Ur(t, e) {
    return null == t ? e : G(t) ? t : X(t) || U(t) ? t + '' : e;
  }
  function Xr(t) {
    var e = t.name;
    return !(!e || !e.indexOf(Nr));
  }
  function Yr(t) {
    return t && null != t.id && 0 === Gr(t.id).indexOf('\0_ec_\0');
  }
  function qr(t, e) {
  ...
  function Zr() {
    var t = '__ec_inner_' + jr++;
    return function (e) {
      return e[t] || (e[t] = {});
    };
  }
  var jr = Math.round(9 * Math.random());
  function Kr(t, e, n) {
    var i = $r(e, n),
      ...
      R(n, function (t, n) {
        if ('dataIndex' !== n && 'dataIndexInside' !== n) {
          ...
          if (
            s &&
            l &&
            !(e && e.includeMainTypes && A(e.includeMainTypes, s) < 0)
          )
  ...
  var Qr = { useDefault: !0, enableAll: !1, enableNone: !1 };
  function Jr(t, e, n, i) {
    i = i || Qr;
    var r = n.index,
      o = n.id,
    ...
    return 'none' === r || !1 === r
      ? (ot(
        ...
        s)
      : ('all' === r &&
          (ot(i.enableAll, '`"all"` is not a valid value on index option.'),
          (r = o = a = null)),
  ...
  var eo = '___EC__COMPONENT__CONTAINER___',
    no = '___EC__EXTENDED_CLASS___';
  function io(t) {
    var e = { main: '', sub: '' };
    if (t) {
      var n = t.split('.');
    ...
    (t.$constructor = t),
      (t.extend = function (t) {
        var e,
          ...
          r = this;
        return (
          W((i = r)) && /^class\s/.test(Function.prototype.toString.call(i))
            ? (e = (function (t) {
                function e() {
  ...
  var ao = Math.round(10 * Math.random());
  function so(t, e) {
  ...
  function yo(t, e, n, i, r) {
    if (t) {
      if ('string' == typeof t) {
        ...
        return (
          o
            ? !mo((e = o.image)) && o.pending.push(a)
            : (((e = u.loadImage(t, vo, vo)).__zrImageSrc = t),
              fo.put(t, (e.__cachedImgObj = { image: e, pending: [a] }))),
          e
        );
      }
      return t;
  ...
  function xo(t, e, n, i, r) {
    ...
    var o = (t + '').split('\n');
    r = wo(e, n, i, r);
    for (var a = 0, s = o.length; a < s; a++) o[a] = bo(o[a], r);
    return o.join('\n');
  }
  function wo(t, e, n, i) {
    var r = D({}, (i = i || {}));
    (r.font = e),
      (n = et(n, '...')),
      (r.maxIterations = et(i.maxIterations, 2));
    var o = (r.minChar = et(i.minChar, 0));
    r.cnCharWidth = Hi('国', e);
    var a = (r.ascCharWidth = Hi('a', e));
    r.placeholder = et(i.placeholder, '');
  ...
  function bo(t, e) {
    ...
    for (var a = 0; ; a++) {
      ...
      var s =
        0 === a
          ? So(t, r, e.ascCharWidth, e.cnCharWidth)
          : o > 0
            ? Math.floor((t.length * r) / o)
            : 0;
      o = Hi((t = t.substr(0, s)), i);
    }
    ...
    for (var y = 0; y < o.length; y++) {
      ...
      if (
        ...
        'number' == typeof l.width
          ? (m.width = l.width)
          : (m.width = a ? a[y] : Hi(v, h)),
        y || c)
      )
        u.push(new To([m]));
      else {
        var _ = (u[u.length - 1] || (u[0] = new To())).tokens,
          x = _.length;
  ...
  var Lo = '__zr_style_' + Math.round(10 * Math.random()),
    Po = {
      shadowBlur: 0,
      shadowOffsetX: 0,
      shadowOffsetY: 0,
      ...
      return (
        ...
        (e.prototype.shouldBePainted = function (t, e, n, i) {
          ...
          if (
            ...
            (this.culling &&
              (function (t, e, n) {
                zo.copy(t.getBoundingRect()),
                  t.transform && zo.applyTransform(t.transform);
                return (Bo.width = e), (Bo.height = n), !zo.intersect(Bo);
              })(this, t, e)) ||
            (r && !r[0] && !r[3])
          )
            return !1;
        ...
        (e.prototype.getPaintRect = function () {
          ...
          if (!this._paintRect || this.__dirty) {
            var e = this.transform,
              ...
              o = i.shadowOffsetX || 0,
              a = i.shadowOffsetY || 0;
            (t = this._paintRect || (this._paintRect = new Ce(0, 0, 0, 0))),
              e ? Ce.applyTransform(t, n, e) : t.copy(n),
              (r || o || a) &&
        ...
        (e.prototype.setPrevPaintRect = function (t) {
          t
            ? ((this._prevPaintRect =
                this._prevPaintRect || new Ce(0, 0, 0, 0)),
        ...
        (e.prototype.setStyle = function (t, e) {
          return (
            'string' == typeof t ? (this.style[t] = e) : D(this.style, t),
            this.dirtyStyle(),
            this
          );
        }),
        ...
        (e.prototype._innerSaveToNormal = function (e) {
          ...
          e.style &&
            ...
            this._savePrimaryToNormal(e, n, Ro);
        }),
  ...
  function qo(t, e, n, i, r, o) {
    (r[0] = Fo(t, n)), (r[1] = Fo(e, i)), (o[0] = Vo(t, n)), (o[1] = Vo(e, i));
  }
  var Zo = [],
    jo = [];
  function Ko(t, e, n, i, r, o, a, s, l, u) {
    var h = hn,
      c = sn,
      p = h(t, n, r, a, Zo);
    (l[0] = 1 / 0), (l[1] = 1 / 0), (u[0] = -1 / 0), (u[1] = -1 / 0);
    for (var f = 0; f < p; f++) {
      var d = c(t, n, r, a, Zo[f]);
      (l[0] = Fo(d, l[0])), (u[0] = Vo(d, u[0]));
    }
    p = h(e, i, o, s, jo);
    for (f = 0; f < p; f++) {
      var g = c(e, i, o, s, jo[f]);
      (l[1] = Fo(g, l[1])), (u[1] = Vo(g, u[1]));
    }
    (l[0] = Fo(t, l[0])),
      (u[0] = Vo(t, u[0])),
      (l[0] = Fo(a, l[0])),
  ...
  var Jo = { M: 1, L: 2, C: 3, Q: 4, A: 5, Z: 6, R: 7 },
    ta = [],
    ea = [],
    na = [],
    ia = [],
    ...
    ca = Math.PI,
    pa = 2 * ca,
    fa = 'undefined' != typeof Float32Array,
    da = [];
  function ga(t) {
    return ((Math.round((t / ca) * 1e8) / 1e8) % 2) * ca;
  }
  var ya = (function () {
    function t(t) {
      (this.dpr = 1),
    ...
    return (
      ...
      (t.prototype.setScale = function (t, e, n) {
        (n = n || 0) > 0 &&
          ((this._ux = ha(n / Ii / t) || 0), (this._uy = ha(n / Ii / e) || 0));
      }),
      ...
      (t.prototype.arc = function (t, e, n, i, r, o) {
        ...
        var a = (r = da[1]) - i;
        return (
          this.addData(Jo.A, t, e, n, n, i, a, 0, o ? 0 : 1),
      ...
      (t.prototype.rect = function (t, e, n, i) {
        return (
          ...
          this.addData(Jo.R, t, e, n, i),
          this
        );
      }),
      (t.prototype.closePath = function () {
        this._drawPendingPt(), this.addData(Jo.Z);
        var t = this._ctx,
          e = this._x0,
          n = this._y0;
      ...
      (t.prototype.toStatic = function () {
        if (this._saveData) {
          ...
          t instanceof Array &&
            ((t.length = this._len),
            fa && this._len > 11 && (this.data = new Float32Array(t)));
        }
      }),
      (t.prototype.getBoundingRect = function () {
        (na[0] = na[1] = ra[0] = ra[1] = Number.MAX_VALUE),
          (ia[0] = ia[1] = oa[0] = oa[1] = -Number.MAX_VALUE);
        var t,
          e = this.data,
          n = 0,
          i = 0,
        ...
        for (t = 0; t < this._len; ) {
          ...
          switch ((s && ((r = n = e[t]), (o = i = e[t + 1])), a)) {
            case Jo.M:
              ...
              break;
            case Jo.L:
              qo(n, i, e[t], e[t + 1], ra, oa), (n = e[t++]), (i = e[t++]);
              break;
            case Jo.C:
              Ko(n, i, e[t++], e[t++], e[t++], e[t++], e[t], e[t + 1], ra, oa),
                (n = e[t++]),
                (i = e[t++]);
              break;
            case Jo.Q:
              $o(n, i, e[t++], e[t++], e[t], e[t + 1], ra, oa),
                (n = e[t++]),
                (i = e[t++]);
              break;
            case Jo.A:
              ...
              t += 1;
              var d = !e[t++];
              s && ((r = la(p) * h + l), (o = ua(p) * c + u)),
                Qo(l, u, h, c, p, f, d, ra, oa),
                (n = la(f) * h + l),
                (i = ua(f) * c + u);
              break;
            case Jo.R:
          ...
          zt(na, na, ra), Bt(ia, ia, oa);
        }
        return (
          0 === t && (na[0] = na[1] = ia[0] = ia[1] = 0),
          new Ce(na[0], na[1], ia[0] - na[0], ia[1] - na[1])
        );
      }),
        ...
        for (var l = this._pathSegLen, u = 0, h = 0, c = 0; c < e; ) {
          ...
          switch (p) {
            ...
            case Jo.L:
              var g = t[c++],
                y = (_ = t[c++]) - o;
              (ha((k = g - r)) > n || ha(y) > i || c === e - 1) &&
                ((d = Math.sqrt(k * k + y * y)), (r = g), (o = _));
              break;
            case Jo.C:
              var v = t[c++],
                m = t[c++],
                ...
                x = t[c++],
                w = t[c++];
              (d = pn(r, o, v, m, g, _, x, w, 10)), (r = x), (o = w);
              break;
            case Jo.Q:
              (d = vn(
                r,
            ...
            case Jo.A:
              ...
              c += 1;
              t[c++];
              f && ((a = la(C) * M + b), (s = ua(C) * T + S)),
                (d = sa(M, T) * aa(pa, Math.abs(D))),
                (r = la(I) * M + b),
                (o = ua(I) * T + S);
              break;
            case Jo.R:
          ...
          t: for (var x = 0; x < g; ) {
            ...
            switch (
              ...
              case Jo.C:
                ...
                if (y) {
                  if (v + (Z = l[m++]) > u) {
                    cn(r, D, k, L, (T = (u - v) / Z), ta),
                      cn(o, I, A, P, T, ea),
                      t.bezierCurveTo(ta[1], ea[1], ta[2], ea[2], ta[3], ea[3]);
                    break t;
                  }
                  v += Z;
                }
                t.bezierCurveTo(D, I, k, A, L, P), (r = L), (o = P);
                break;
              case Jo.Q:
                (D = p[x++]), (I = p[x++]), (k = p[x++]), (A = p[x++]);
                if (y) {
                  if (v + (Z = l[m++]) > u) {
                    yn(r, D, k, (T = (u - v) / Z), ta),
                      yn(o, I, A, T, ea),
                      t.quadraticCurveTo(ta[1], ea[1], ta[2], ea[2]);
                    break t;
                  }
                  v += Z;
                }
                t.quadraticCurveTo(D, I, k, A), (r = k), (o = A);
                break;
              case Jo.A:
                var O = p[x++],
                  R = p[x++],
                ...
                if (
                  (W && t.ellipse
                    ? t.ellipse(O, R, N, E, F, z, G, V)
                    : t.arc(O, R, H, z, G, V),
                  U)
                )
                  break t;
                b && ((n = la(z) * N + O), (i = ua(z) * E + R)),
                  (r = la(G) * N + O),
                  (o = ua(G) * E + R);
                break;
              case Jo.R:
                ...
                if (y) {
                  if (v + (Z = l[m++]) > u) {
                    ...
                    t.moveTo(a, s),
                      t.lineTo(a + aa(q, X), s),
                      (q -= X) > 0 && t.lineTo(a + X, s + aa(q, Y)),
                      (q -= Y) > 0 && t.lineTo(a + sa(X - q, 0), s + Y),
                      (q -= X) > 0 && t.lineTo(a, s + sa(Y - q, 0));
                    break t;
                  }
                  v += Z;
                }
  ...
  function ma(t, e, n, i, r, o, a, s, l, u, h) {
    if (0 === l) return !1;
    var c = l;
    if (
      ...
      return !1;
    var p = (function (t, e, n, i, r, o, a, s, l, u, h) {
      var c,
        p,
        f,
        d,
      ...
      for (var m = 0; m < 1; m += 0.05)
        (nn[0] = sn(t, n, r, a, m)),
          (nn[1] = sn(e, i, o, s, m)),
          (d = Rt(en, nn)) < v && ((c = m), (v = d));
      v = 1 / 0;
      for (var _ = 0; _ < 32 && !(y < Qe); _++)
        (p = c - y),
          (f = c + y),
          (nn[0] = sn(t, n, r, a, p)),
          (nn[1] = sn(e, i, o, s, p)),
      ...
      return (
        h && ((h[0] = sn(t, n, r, a, c)), (h[1] = sn(e, i, o, s, c))), Ke(v)
      );
    })(t, e, n, i, r, o, a, s, u, h, null);
    return p <= c / 2;
  }
  function _a(t, e, n, i, r, o, a, s, l) {
    if (0 === a) return !1;
    var u = a;
    if (
      (l > e + u && l > i + u && l > o + u) ||
    ...
    var h = (function (t, e, n, i, r, o, a, s, l) {
      ...
      for (var p = 0; p < 1; p += 0.05)
        (nn[0] = fn(t, n, r, p)),
          (nn[1] = fn(e, i, o, p)),
          (y = Rt(en, nn)) < c && ((u = p), (c = y));
      c = 1 / 0;
      for (var f = 0; f < 32 && !(h < Qe); f++) {
        var d = u - h,
          g = u + h;
        (nn[0] = fn(t, n, r, d)), (nn[1] = fn(e, i, o, d));
        var y = Rt(nn, en);
        if (d >= 0 && y < c) (u = d), (c = y);
        else {
          (rn[0] = fn(t, n, r, g)), (rn[1] = fn(e, i, o, g));
          var v = Rt(rn, en);
          g <= 1 && v < c ? ((u = g), (c = v)) : (h *= 0.5);
        }
      }
      return l && ((l[0] = fn(t, n, r, u)), (l[1] = fn(e, i, o, u))), Ke(c);
  ...
  var ba = 2 * Math.PI;
  function Sa(t, e, n, i, r, o, a, s, l) {
    if (0 === a) return !1;
    var u = a;
    (s -= t), (l -= e);
    var h = Math.sqrt(s * s + l * l);
    if (h - u > n || h + u < n) return !1;
    if (Math.abs(i - r) % ba < 1e-4) return !0;
    if (o) {
      var c = i;
      (i = wa(r)), (r = wa(c));
    } else (i = wa(i)), (r = wa(r));
    ...
    return (
      p < 0 && (p += ba), (p >= i && p <= r) || (p + ba >= i && p + ba <= r)
    );
  }
  ...
  var Da = [-1, -1, -1],
    Ia = [-1, -1];
  function ka(t, e, n, i, r, o, a, s, l, u) {
    if (
      (u > e && u > i && u > o && u > s) ||
      (u < e && u < i && u < o && u < s)
    )
    ...
    for (var p = 0, f = -1, d = void 0, g = void 0, y = 0; y < c; y++) {
      ...
      sn(t, n, r, a, v) < l ||
        (f < 0 &&
          ...
          Ia[1] < Ia[0] &&
            f > 1 &&
            ((h = void 0), (h = Ia[0]), (Ia[0] = Ia[1]), (Ia[1] = h)),
          (d = sn(e, i, o, s, Ia[0])),
          f > 1 && (g = sn(e, i, o, s, Ia[1]))),
        2 === f
          ? v < Ia[0]
            ? (p += d < e ? m : -m)
            : v < Ia[1]
  ...
  function Aa(t, e, n, i, r, o, a, s) {
    ...
    var l = (function (t, e, n, i, r) {
      var o = t - 2 * e + n,
        ...
        s = t - i,
        l = 0;
      if (on(o)) an(a) && (h = -s / a) >= 0 && h <= 1 && (r[l++] = h);
      else {
        var u = a * a - 4 * o * s;
        if (on(u)) (h = -a / (2 * o)) >= 0 && h <= 1 && (r[l++] = h);
        else if (u > 0) {
          var h,
            c = Ke(u),
            p = (-a - c) / (2 * o);
    ...
    var u = gn(e, i, o);
    if (u >= 0 && u <= 1) {
      for (var h = 0, c = fn(e, i, o, u), p = 0; p < l; p++) {
        var f = 0 === Da[p] || 1 === Da[p] ? 0.5 : 1;
        fn(t, n, r, Da[p]) < a ||
          (Da[p] < u ? (h += c < e ? f : -f) : (h += o < c ? f : -f));
      }
      return h;
    }
    f = 0 === Da[0] || 1 === Da[0] ? 0.5 : 1;
    return fn(t, n, r, Da[0]) < a ? 0 : o < e ? f : -f;
  }
  ...
  function Pa(t, e, n, i, r) {
    for (
      ...
      switch (
        ...
        case Ta.L:
          if (n) {
            if (va(p, f, u[y], u[y + 1], e, i, r)) return !0;
          } else c += Ma(p, f, u[y], u[y + 1], i, r) || 0;
          (p = u[y++]), (f = u[y++]);
          break;
        case Ta.C:
          if (n) {
            if (
              ma(p, f, u[y++], u[y++], u[y++], u[y++], u[y], u[y + 1], e, i, r)
            )
              return !0;
          } else
            c +=
              ka(p, f, u[y++], u[y++], u[y++], u[y++], u[y], u[y + 1], i, r) ||
              0;
          (p = u[y++]), (f = u[y++]);
          break;
        case Ta.Q:
          if (n) {
            if (_a(p, f, u[y++], u[y++], u[y], u[y + 1], e, i, r)) return !0;
          } else c += Aa(p, f, u[y++], u[y++], u[y], u[y + 1], i, r) || 0;
          (p = u[y++]), (f = u[y++]);
          break;
        case Ta.A:
          var _ = u[y++],
          ...
          (o = Math.cos(S) * w + _),
            (a = Math.sin(S) * b + x),
            m ? ((d = o), (g = a)) : (c += Ma(p, f, o, a, i, r));
          var C = ((i - _) * b) / w + _;
          if (n) {
            if (Sa(_, x, b, S, S + M, T, e, C, r)) return !0;
          } else c += La(_, x, b, S, S + M, T, C, r);
          (p = Math.cos(S + M) * w + _), (f = Math.sin(S + M) * b + x);
          break;
        case Ta.R:
          if (
            ((d = p = u[y++]),
            ...
            if (
              ...
              return !0;
          } else (c += Ma(o, g, o, a, i, r)), (c += Ma(d, a, d, g, i, r));
          break;
        case Ta.Z:
          if (n) {
            if (va(p, f, d, g, e, i, r)) return !0;
          } else c += Ma(p, f, d, g, i, r);
          (p = d), (f = g);
      }
    }
    return (
  ...
  var Oa = I(
    ...
    Na = Fi.concat(['invisible', 'culling', 'z', 'z2', 'zlevel', 'parent']),
    Ea = (function (t) {
      function e(e) {
        return t.call(this, e) || this;
      }
      ...
      return (
        ...
        (e.prototype.update = function () {
          ...
          if (i.decal) {
            ...
            for (var s = 0; s < Na.length; ++s) r[Na[s]] = this[Na[s]];
            r.__dirty |= 1;
        ...
        (e.prototype.getInsideTextStroke = function (t) {
          ...
          if (G(e)) {
            var n = this.__zr;
            if (!(!n || !n.isDarkMode()) === Un(t, 0) < 0.4) return e;
          }
        }),
        ...
        (e.prototype._innerSaveToNormal = function (e) {
          t.prototype._innerSaveToNormal.call(this, e);
          var n = this._normalState;
          e.shape && !n.shape && (n.shape = D({}, this.shape));
        }),
        (e.prototype._applyStateObj = function (e, n, i, r, o, a) {
          t.prototype._applyStateObj.call(this, e, n, i, r, o, a);
          var s,
          ...
          if (
            (n && n.shape
              ? o
                ? r
                  ? (s = n.shape)
                  : ((s = D({}, i.shape)), D(s, n.shape))
                : ((s = D({}, r ? this.shape : i.shape)), D(s, n.shape))
              : l && (s = i.shape),
            s)
          )
            if (o) {
              this.shape = D({}, this.shape);
              for (var u = {}, h = B(s), c = 0; c < h.length; c++) {
                var p = h[c];
                'object' == typeof s[p]
                  ? (this.shape[p] = s[p])
                  : (u[p] = s[p]);
      ...
      return (
        ...
        (e.prototype.getBoundingRect = function () {
          ...
          if (!this._rect) {
            var e = t.text;
            null != e ? (e += '') : (e = '');
            var n = Gi(e, t.font, t.textAlign, t.textBaseline);
  ...
  function Ga(t, e, n) {
    if (e) {
      ...
      var s = n && n.lineWidth;
      return s
        ? (Wa(2 * i) === Wa(2 * r) && (t.x1 = t.x2 = Ua(i, s, !0)),
          Wa(2 * o) === Wa(2 * a) && (t.y1 = t.y2 = Ua(o, s, !0)),
          t)
        : t;
    }
  }
  function Ua(t, e, n) {
    if (!e) return t;
    var i = Wa(2 * t);
    return (i + Wa(e)) % 2 == 0 ? i / 2 : (i + (n ? 1 : -1)) / 2;
  }
  var Xa = function () {
    ...
    Ka = (function (t) {
      ...
      return (
        ...
        (e.prototype._updatePlainTexts = function () {
          var t = this.style,
            ...
            i = (function (t, e) {
              ...
              var v = f,
                m = 0;
              for (y = 0; y < n.length; y++) m = Math.max(Hi(n[y], o), m);
              null == c && (c = m);
              var _ = m;
              return (
                r &&
                  ((v += r[0] + r[2]), (_ += r[1] + r[3]), (c += r[1] + r[3])),
                u && (_ = c),
                {
                  lines: n,
                  height: f,
            ...
            v = f,
            m = Xi(d, i.contentHeight, y);
          if (r || n) {
            var _ = Ui(f, l, g),
              x = Xi(d, s, y);
            r && this._renderBackground(t, t, _, x, l, s);
          }
          (m += c / 2),
            n &&
              ((v = os(f, g, n)),
          ...
          for (
            var w = 0,
              b = !1,
              S = rs(('fill' in t) ? t.fill : ((b = !0), p.fill)),
              M = is(
                ('stroke' in t)
                  ? t.stroke
                  : a || (p.autoStroke && !b)
              ...
              C =
                ...
                ('truncate' === t.overflow ||
                  'break' === t.overflow ||
                  'breakAll' === t.overflow),
              D = i.calculatedLineHeight,
              I = 0;
            I < h.length;
            I++
          ) {
            var k = this._getOrCreateChild(Ba),
              A = k.createStyle();
            k.useStyle(A),
              (A.text = h[I]),
              (A.x = v),
              ...
              C &&
                k.setBoundingRect(
                  new Ce(
                    Ui(A.x, t.width, A.textAlign),
                    Xi(A.y, D, A.textBaseline),
                    u,
                    D
                  )
                );
        ...
        (e.prototype._updateRichTexts = function () {
          var t = this.style,
            e = (function (t, e) {
              ...
              for (
                ...
                var u = i.index;
                u > l && Do(n, t.substring(l, u), e, s),
                  Do(n, i[2], e, s, i[1]),
                  (l = _o.lastIndex);
              }
              l < t.length && Do(n, t.substring(l, t.length), e, s);
              var h = [],
                c = 0,
                p = 0,
                f = e.padding,
              ...
              t: for (var v = 0; v < n.lines.length; v++) {
                for (
                  ...
                  var b =
                      ((P = m.tokens[w]).styleName && e.rich[P.styleName]) ||
                      {},
                    S = (P.textPadding = b.padding),
                    M = S ? S[1] + S[3] : 0,
                    T = (P.font = b.font || e.font);
                  P.contentHeight = Yi(T);
                  var C = et(b.height, P.contentHeight);
                  if (
                    ((P.innerHeight = C),
                    S && (C += S[0] + S[2]),
                    (P.height = C),
                    (P.lineHeight = nt(b.lineHeight, e.lineHeight, C)),
                    (P.align = (b && b.align) || e.align),
                    (P.verticalAlign = (b && b.verticalAlign) || 'middle'),
                  ...
                  if ('string' == typeof D && '%' === D.charAt(D.length - 1))
                    (P.percentWidth = D),
                      h.push(P),
                      (P.contentWidth = Hi(P.text, T));
                  else {
                    if (I) {
                      var k = b.backgroundColor,
                        A = k && k.image;
                      A &&
                        mo((A = go(A))) &&
                        (P.width = Math.max(P.width, (A.width * C) / A.height));
                    }
                    var L = d && null != r ? r - x : null;
                    null != L && L < P.width
                      ? !I || L < M
                        ? ((P.text = ''), (P.width = P.contentWidth = 0))
                        : ((P.text = xo(P.text, L - M, T, e.ellipsis, {
                            minChar: e.truncateMinChar,
                          })),
                          (P.width = P.contentWidth = Hi(P.text, T)))
                      : (P.contentWidth = Hi(P.text, T));
                  }
                  (P.width += M),
                    (x += P.width),
                    b && (_ = Math.max(_, P.lineHeight));
                }
                y(m, x, _);
              }
              for (
                n.outerWidth = n.width = et(r, p),
                  n.outerHeight = n.height = et(o, c),
                  n.contentHeight = c,
                  n.contentWidth = p,
                  f &&
          ...
          o && ((f += o[3]), (d += o[0]));
          var g = f + n;
          ss(t) && this._renderBackground(t, t, c, p, i, r);
          for (var y = !!t.backgroundColor, v = 0; v < e.lines.length; v++) {
            for (
              var m = e.lines[v],
                ...
                C = x - 1,
                D = void 0;
              S < x && (!(D = _[S]).align || 'left' === D.align);

            )
              this._placeToken(D, t, w, d, M, 'left', y),
                (b -= D.width),
                (M += D.width),
                S++;
            for (; C >= 0 && 'right' === (D = _[C]).align; )
              this._placeToken(D, t, w, d, T, 'right', y),
                (b -= D.width),
                (T -= D.width),
                C--;
            for (M += (n - (M - f) - (g - T) - b) / 2; S <= C; )
              (D = _[S]),
                this._placeToken(D, t, w, d, M + D.width / 2, 'center', y),
                (M += D.width),
                S++;
            d += w;
          }
        }),
        (e.prototype._placeToken = function (t, e, n, i, r, a, s) {
          ...
          var c = !!l.backgroundColor,
            p = t.textPadding;
          p &&
            ((r = os(r, a, p)), (h -= t.height / 2 - p[0] - t.innerHeight / 2));
          var f = this._getOrCreateChild(Ba),
            d = f.createStyle();
          f.useStyle(d);
          var g = this._defaultStyle,
            ...
            v = 0,
            m = rs(
              'fill' in l ? l.fill : 'fill' in e ? e.fill : ((y = !0), g.fill)
            ),
            _ = is(
              'stroke' in l
                ? l.stroke
            ...
            x = l.textShadowBlur > 0 || e.textShadowBlur > 0;
          (d.text = t.text),
            (d.x = r),
            (d.y = h),
            x &&
              ((d.shadowBlur = l.textShadowBlur || e.textShadowBlur || 0),
              (d.shadowColor =
                l.textShadowColor || e.textShadowColor || 'transparent'),
              (d.shadowOffsetX =
                l.textShadowOffsetX || e.textShadowOffsetX || 0),
              (d.shadowOffsetY =
                l.textShadowOffsetY || e.textShadowOffsetY || 0)),
            (d.textAlign = a),
            (d.textBaseline = 'middle'),
            (d.font = t.font || o),
            (d.opacity = nt(l.opacity, e.opacity, 1)),
            es(d, l),
            _ &&
              ((d.lineWidth = nt(l.lineWidth, e.lineWidth, v)),
              (d.lineDash = et(l.lineDash, e.lineDash)),
          ...
          var w = t.contentWidth,
            b = t.contentHeight;
          f.setBoundingRect(
            new Ce(Ui(d.x, w, d.textAlign), Xi(d.y, b, d.textBaseline), w, b)
          );
        }),
        (e.prototype._renderBackground = function (t, e, n, i, r, o) {
          ...
          if (f)
            ((l = a.style).fill = u || null),
              (l.fillOpacity = et(t.fillOpacity, 1));
          else if (p) {
          ...
          h &&
            ...
            (l.stroke = c),
            (l.strokeOpacity = et(t.strokeOpacity, 1)),
          ...
          (m.shadowBlur = t.shadowBlur || 0),
            ...
            (m.opacity = nt(t.opacity, e.opacity, 1));
        }),
        (e.makeFont = function (t) {
          ...
          return (
            ...
            (e && at(e)) || t.textFont || t.font
          );
        }),
        e
      );
    })(Eo),
    $a = { left: !0, right: 1, center: 1 },
    Qa = { top: 1, bottom: 1, middle: 1 },
    Ja = ['fontStyle', 'fontWeight', 'fontSize', 'fontFamily'];
  function ts(t) {
    return 'string' != typeof t ||
      (-1 === t.indexOf('px') &&
        -1 === t.indexOf('rem') &&
  ...
  function ns(t) {
    if (t) {
      t.font = Ka.makeFont(t);
      var e = t.align;
      'middle' === e && (e = 'center'),
        (t.align = null == e || $a[e] ? e : 'left');
      var n = t.verticalAlign;
      'center' === n && (n = 'middle'),
        (t.verticalAlign = null == n || Qa[n] ? n : 'top'),
        t.padding && (t.padding = rt(t.padding));
    }
  }
  function is(t, e) {
  ...
  function bs(t) {
    if (G(t)) {
      var e = ws.get(t);
      return e || ((e = Bn(t, -0.1)), ws.put(t, e)), e;
    }
    if (K(t)) {
      var n = D({}, t);
      return (
        (n.colorStops = N(t.colorStops, function (t) {
          return { offset: t.offset, color: Bn(t.color, -0.1) };
        })),
        n
      );
    }
  ...
  function Ts(t) {
    2 === t.hoverState && Ss(t, 'normal', 0);
  }
  function Cs(t) {
    Ss(t, 'blur', 1);
  }
  function Ds(t) {
    1 === t.hoverState && Ss(t, 'normal', 0);
  }
  function Is(t) {
    t.selected = !0;
  }
        ...
        return (function (t, e, n, i) {
          ...
          if (t instanceof Ea) {
            ...
            if (xs(s) || xs(l)) {
              var u = (i = i || {}).style || {};
              'inherit' === u.fill
                ? ((o = !0), (i = D({}, i)), ((u = D({}, u)).fill = s))
                : !xs(u.fill) && xs(s)
                  ? ((o = !0), (i = D({}, i)), ((u = D({}, u)).fill = bs(s)))
                  : !xs(u.stroke) &&
                    xs(l) &&
                    (o || ((i = D({}, i)), (u = D({}, u))), (u.stroke = bs(l))),
                (i.style = u);
            }
          }
          if (i && null == i.z2) {
      ...
      if ('blur' === t)
        return (function (t, e, n) {
          ...
          return (
            null == a.opacity &&
              ((n = D({}, n)),
              (a = D({ opacity: i ? r : 0.1 * o.opacity }, a)),
              (n.style = a)),
            n
          );
        })(this, t, n);
  ...
  function Rs(t) {
    ...
    e && (e.stateProxy = Os), n && (n.stateProxy = Os);
  }
  function Ns(t, e) {
    !Ws(t, e) && !t.__highByOuter && Ls(t, Ms);
  }
  function Es(t, e) {
    !Ws(t, e) && !t.__highByOuter && Ls(t, Ts);
  }
  function zs(t, e) {
    (t.__highByOuter |= 1 << (e || 0)), Ls(t, Ms);
  }
  function Bs(t, e) {
    !(t.__highByOuter &= ~(1 << (e || 0))) && Ls(t, Ts);
  }
  function Fs(t) {
    Ls(t, Ds);
  }
        ...
        if (
          ...
          if (
            (i.getViewOfSeriesModel(t).group.traverse(function (t) {
              (t.__highByOuter && r && 'self' === e) || Cs(t);
            }),
            O(e))
          )
            o(t.getData(), e);
          else if (Y(e))
            for (var h = B(e), c = 0; c < h.length; c++)
              o(t.getData(h[c]), e[h[c]]);
          l.push(t), (ps(t).isBlured = !0);
        }
      }),
  ...
  function qs(t) {
    R(t.getAllData(), function (e) {
      var n = e.data,
        i = e.type;
      n.eachItemGraphicEl(function (e, n) {
        t.isSelected(n, i) ? Vs(e) : Hs(e);
      });
    });
  }
  function Zs(t) {
  ...
  function fl(t, e) {
    return (t[0] * e[0] + t[1] * e[1]) / (pl(t) * pl(e));
  }
  function dl(t, e) {
    return (t[0] * e[1] < t[1] * e[0] ? -1 : 1) * Math.acos(fl(t, e));
  }
  function gl(t, e, n, i, r, o, a, s, l, u, h) {
    var c = l * (cl / 180),
      p = (hl(c) * (t - n)) / 2 + (ul(c) * (e - i)) / 2,
      f = (-1 * ul(c) * (t - n)) / 2 + (hl(c) * (e - i)) / 2,
      d = (p * p) / (a * a) + (f * f) / (s * s);
    d > 1 && ((a *= ll(d)), (s *= ll(d)));
    var g =
        (r === o ? -1 : 1) *
      ...
      y = (g * a * f) / s,
      v = (g * -s * p) / a,
      m = (t + n) / 2 + hl(c) * y - ul(c) * v,
      _ = (e + i) / 2 + ul(c) * y + hl(c) * v,
      x = dl([1, 0], [(p - y) / a, (f - v) / s]),
      w = [(p - y) / a, (f - v) / s],
      b = [(-1 * p - y) / a, (-1 * f - v) / s],
      S = dl(w, b);
    if ((fl(w, b) <= -1 && (S = cl), fl(w, b) >= 1 && (S = 0), S < 0)) {
      var M = Math.round((S / cl) * 1e6) / 1e6;
      S = 2 * cl + (M % 2) * cl;
    }
    h.addData(u, m, _, a, s, x, S, c, o);
  }
  var yl = /([mlvhzcqtsa])([^mlvhzcqtsa]*)/gi,
    vl = /-?([0-9]*\.)?[0-9]+([eE]-?[0-9]+)?/g;
  var ml = (function (t) {
    function e() {
      return (null !== t && t.apply(this, arguments)) || this;
            ...
            switch (c) {
              ...
              case 'S':
                (v = i),
                  ...
                  (C = e.len()),
                  (D = e.data),
                  n === s.C && ((v += i - D[C - 4]), (m += r - D[C - 3])),
                  (p = s.C),
                  (M = f[y++]),
                  (T = f[y++]),
                  (i = f[y++]),
                  (r = f[y++]),
                  e.addData(p, v, m, M, T, i, r);
                break;
              case 's':
                (v = i),
                  (m = r),
            ...
            for (r = 0, o = 0; r < u; ) {
              switch (((n = l[r++]), (o = r), (i = 0), n)) {
                ...
                case d:
                  var y = e[4],
                    v = e[5],
                    m = al(e[0] * e[0] + e[1] * e[1]),
                    _ = al(e[2] * e[2] + e[3] * e[3]),
                    x = sl(-e[1] / _, e[0] / m);
                  (l[r] *= m),
                    (l[r++] += y),
                    (l[r] *= _),
  ...
  function zl(t, e) {
    ...
    if (o || r > 0) {
      ...
      if (!isNaN(s) && !isNaN(l)) {
        ...
        if ((f > Nl && (p = f), i > Nl))
          if (p > Cl - Nl)
            t.moveTo(u + i * Il(s), h + i * Dl(s)),
              t.arc(u, h, i, s, l, !c),
              r > Nl &&
                (t.moveTo(u + r * Il(l), h + r * Dl(l)),
                t.arc(u, h, r, l, s, c));
          else {
            var d = void 0,
              g = void 0,
                  ...
                  var B = A - z[0],
                    ...
                    G =
                      ...
                      Dl(
                        kl(
                          (B * V + F * W) /
                            (Pl(B * B + F * F) * Pl(V * V + W * W))
                        ) / 2
                      ),
                    U = Pl(z[0] * z[0] + z[1] * z[1]);
                  (M = Rl(b, (i - U) / (G + 1))),
                    (T = Rl(S, (r - U) / (G - 1)));
                }
              }
            ...
            if (R)
              if (M > Nl) {
                var X = Rl(y, M),
                  ...
                  q = El(I, k, A, L, i, X, c),
                  Z = El(C, D, P, O, i, Y, c);
                t.moveTo(u + q.cx + q.x0, h + q.cy + q.y0),
                  M < b && X === Y
                    ? t.arc(
                        u + q.cx,
                        h + q.cy,
                    ...
                    : (X > 0 &&
                      ...
                      t.arc(
                        ...
                        h,
                        i,
                        Al(q.cy + q.y1, q.cx + q.x1),
                        Al(Z.cy + Z.y1, Z.cx + Z.x1),
                        !c
                      ),
                      Y > 0 &&
                        t.arc(
              ...
              } else t.moveTo(u + A, h + L), t.arc(u, h, i, s, l, !c);
            else t.moveTo(u + A, h + L);
            if (r > Nl && R)
              if (T > Nl) {
                (X = Rl(d, T)),
                  (q = El(P, O, C, D, r, -(Y = Rl(g, T)), c)),
                  (Z = El(A, L, I, k, r, -X, c));
                t.lineTo(u + q.cx + q.x0, h + q.cy + q.y0),
                  T < S && X === Y
                    ? t.arc(
                        u + q.cx,
                        h + q.cy,
              ...
              } else t.lineTo(u + P, h + O), t.arc(u, h, r, l, s, c);
        ...
        var o = (function (t, e, n, i) {
          ...
          if (i) {
            ...
            for (var p = 0, f = t.length; p < f; p++)
              zt(a, a, t[p]), Bt(s, s, t[p]);
            zt(a, a, i[0]), Bt(s, s, i[1]);
          }
          for (p = 0, f = t.length; p < f; p++) {
            ...
            var g = Lt(d, r),
              y = Lt(d, o),
              v = g + y;
            0 !== v && ((g /= v), (y /= v)), kt(h, u, -g), kt(c, u, y);
            var m = St([], d, h),
              _ = St([], d, c);
            i && (Bt(m, m, a), zt(m, m, s), Bt(_, _, a), zt(_, _, s)),
              l.push(m),
              l.push(_);
          }
  ...
  function Ql(t, e, n) {
    ...
    return null != i || null != r
      ? [
          (n ? ln : sn)(t.x1, t.cpx1, t.cpx2, t.x2, e),
          (n ? ln : sn)(t.y1, t.cpy1, t.cpy2, t.y2, e),
        ]
      : [
          (n ? dn : fn)(t.x1, t.cpx1, t.x2, e),
          (n ? dn : fn)(t.y1, t.cpy1, t.y2, e),
        ];
  }
  var Jl = (function (t) {
    function e(e) {
    ...
    return (
      ...
      (e.prototype.pointAt = function (t) {
        return Ql(this.shape, t, !1);
      }),
      (e.prototype.tangentAt = function (t) {
        var e = Ql(this.shape, t, !0);
        return At(e, e);
      }),
      e
    );
  })(Ea);
  Jl.prototype.type = 'bezier-curve';
  var tu = function () {
      (this.cx = 0),
        (this.cy = 0),
        (this.r = 0),
  ...
  var nu = (function (t) {
      ...
      return (
        ...
        (e.prototype.getBoundingRect = function () {
          return (
            ...
            Ea.prototype.getBoundingRect.call(this)
          );
        }),
        e
      );
    ...
    hu = (function () {
      function t(t, e) {
        ...
        for (var n = 0; n < 4; n++) this._corners[n] = new ve();
        for (n = 0; n < 2; n++) this._axes[n] = new ve();
      ...
      return (
        ...
        (t.prototype.intersect = function (t, e) {
          ...
          return (
            lu.set(1 / 0, 1 / 0),
            uu.set(0, 0),
            (!this._intersectCheckOneSide(this, t, lu, uu, i, 1) &&
              ((n = !1), i)) ||
              (!this._intersectCheckOneSide(t, this, lu, uu, i, -1) &&
                ((n = !1), i)) ||
              i ||
              ve.copy(e, n ? lu : uu),
            n
        ...
        (t.prototype._intersectCheckOneSide = function (t, e, n, i, r, o) {
          for (var a = !0, s = 0; s < 2; s++) {
            var l = this._axes[s];
            if (
              (this._getProjMinMaxOnAxis(s, t._corners, au),
              this._getProjMinMaxOnAxis(s, e._corners, su),
              au[1] < su[0] || au[0] > su[1])
            ) {
              if (((a = !1), r)) return a;
              var u = Math.abs(su[0] - au[1]),
                h = Math.abs(au[0] - su[1]);
              Math.min(u, h) > i.len() &&
                (u < h ? ve.scale(i, l, -u * o) : ve.scale(i, l, h * o));
            } else if (n) {
              (u = Math.abs(su[0] - au[1])), (h = Math.abs(au[0] - su[1]));
              Math.min(u, h) < n.len() &&
                (u < h ? ve.scale(n, l, u * o) : ve.scale(n, l, -h * o));
            }
          }
          return a;
        }),
          ...
          if (!this._rect) {
            for (
              ...
              n.needLocalTransform() &&
                i.applyTransform(n.getLocalTransform(cu)),
                t.union(i);
            }
            this._rect = t;
          }
  ...
  function gu(t, e, n, i, r, o) {
    du('update', t, e, n, i, r, o);
  }
  function yu(t, e, n, i, r, o) {
    du('enter', t, e, n, i, r, o);
  }
  function vu(t) {
    if (!t.__zr) return !0;
  ...
  function mu(t, e, n, i, r, o) {
    vu(t) || du('leave', t, e, n, i, r, o);
  }
  function _u(t, e, n, i) {
    t.removeTextContent(),
      t.removeTextGuideLine(),
      mu(t, { style: { opacity: 0 } }, e, n, i);
  }
  function xu(t, e, n) {
    function i() {
    ...
    t.isGroup
      ? t.traverse(function (t) {
          t.isGroup || _u(t, e, n, i);
        })
      : _u(t, e, n, i);
  }
  function wu(t) {
    fu(t).oldStyle = t.style;
  }
  var bu = Math.max,
    Su = Math.min,
    Mu = {};
  var Tu = function (t, e) {
    ...
    return (function (t) {
      function e(e) {
        ...
        return (
          (n.applyTransform = i.applyTransform), (n.buildPath = i.buildPath), n
        );
      }
      return n(e, t), e;
    })(ml);
  ...
  function Du(t, e, n, i) {
    var r = (function (t, e) {
      return new ml(xl(t, e));
    })(t, e);
    return (
      n && ('center' === i && (n = ku(n, r.getBoundingRect())), Lu(r, n)), r
    );
  }
  function Iu(t, e, n) {
    var i = new Ha({
  ...
  function Nu(t, e) {
    if (t)
      if (H(t)) for (var n = 0; n < t.length; n++) Ru(t[n], e);
      else Ru(t, e);
  }
  Cu('circle', bl),
    Cu('ellipse', Ml),
  ...
  function zu(t, e, n) {
    ...
    r &&
      ...
      null == i &&
        (i = W(t.defaultText) ? t.defaultText(o, t, n) : t.defaultText);
  ...
  function Bu(t, e, n, i) {
    n = n || Eu;
    for (var r = t instanceof Ka, o = !1, a = 0; a < ds.length; a++) {
    ...
    if (o) {
      r ||
        (s || ((s = new Ka()), t.setTextContent(s)),
        t.stateProxy && (s.stateProxy = t.stateProxy));
      var l = zu(n, e),
        u = e.normal,
        h = !!u.getShallow('show'),
        c = Vu(u, i && i.normal, n, !1, !r);
      (c.text = l.normal), r || t.setTextConfig(Hu(u, n, !1));
      for (a = 0; a < fs.length; a++) {
        var p,
          f = fs[a];
        if ((p = e[f])) {
          var d = s.ensureState(f),
            g = !!et(p.getShallow('show'), h);
          if (
            (g !== h && (d.ignore = !g),
            (d.style = Vu(p, i && i[f], n, !0, !r)),
            (d.style.text = l[f]),
            !r)
          )
            t.ensureState(f).textConfig = Hu(p, n, !0);
        }
      }
  ...
  function Hu(t, e, n) {
    ...
    var i,
      ...
      a = et(t.getShallow('distance'), n ? null : 5),
  ...
  function Xu(t, e, n, i, r, o, a, s) {
    ...
    var l = i && i.inheritColor,
      ...
      c = et(e.getShallow('opacity'), n.opacity);
    ('inherit' !== u && 'auto' !== u) || (u = l || null),
      ('inherit' !== h && 'auto' !== h) || (h = l || null),
      o || ((u = u || n.color), (h = h || n.textBorderColor)),
      null != u && (t.fill = u),
      null != h && (t.stroke = h);
    var p = et(e.getShallow('textBorderWidth'), n.textBorderWidth);
    null != p && (t.lineWidth = p);
    var f = et(e.getShallow('textBorderType'), n.textBorderType);
    null != f && (t.lineDash = f);
    var d = et(e.getShallow('textBorderDashOffset'), n.textBorderDashOffset);
    null != d && (t.lineDashOffset = d),
      r || null != c || s || (c = i && i.defaultOpacity),
      null != c && (t.opacity = c),
      r || o || (null == t.fill && i.inheritColor && (t.fill = i.inheritColor));
    for (var g = 0; g < Wu.length; g++) {
      var y = Wu[g];
      null != (m = et(e.getShallow(y), n[y])) && (t[y] = m);
    }
    for (g = 0; g < Gu.length; g++) {
      y = Gu[g];
    ...
    Qu = (function () {
      ...
      return (
        (t.prototype.getTextColor = function (t) {
          var e = this.ecModel;
          return this.getShallow('color') || (!t && e ? e.get(ju) : null);
        }),
        ...
        (t.prototype.getTextRect = function (t) {
          ...
          return $u.useStyle(e), $u.update(), $u.getBoundingRect();
        }),
        t
      );
    })(),
  ...
  ro(oh),
    (qu = oh),
    (Zu = ['__\0is_clz', ao++].join('_')),
    (qu.prototype[Zu] = !0),
    (qu.isInstance = function (t) {
      return !(!t || !t[Zu]);
    }),
    P(oh, eh),
    P(oh, rh),
    P(oh, po),
    P(oh, Qu);
  var ah = Math.round(10 * Math.random());
  function sh(t) {
    return [t || '', ah++].join('_');
  }
  var lh = 'ZH',
    ...
    fh =
      ...
      (
        ...
        : hh;
  function dh(t, e) {
    (t = t.toUpperCase()), (ph[t] = new oh(e)), (ch[t] = e);
  }
  dh(uh, {
    time: {
      month: [
  ...
  var gh = 1e3,
    ...
    Sh = ['year', 'month', 'day', 'hour', 'minute', 'second', 'millisecond'],
    Mh = [
      'year',
      'half-year',
      'quarter',
  ...
  function Ih(t, e, n, i) {
    var r = Mr(t),
      ...
      m = y.get('monthAbbr'),
      _ = y.get('dayOfWeek'),
      x = y.get('dayOfWeekAbbr');
    return (e || '')
      .replace(/{yyyy}/g, o + '')
      .replace(/{yy}/g, Th((o % 100) + '', 2))
      .replace(/{Q}/g, s + '')
      .replace(/{MMMM}/g, v[a - 1])
      .replace(/{MMM}/g, m[a - 1])
      .replace(/{MM}/g, Th(a, 2))
      .replace(/{M}/g, a + '')
      .replace(/{dd}/g, Th(l, 2))
  ...
  function jh(t, e, n) {
    ...
    for (var r = e[0].$vars || [], o = 0; o < r.length; o++) {
      var a = qh[o];
      t = t.replace(Zh(a), Zh(a, 0));
    }
    for (var s = 0; s < i; s++)
      for (var l = 0; l < r.length; l++) {
        var u = e[s][r[l]];
        t = t.replace(Zh(qh[l], s), n ? $t(u) : u);
      }
    return t;
  }
  function Kh(t, e) {
    return (
      (e = e || 'transparent'),
      G(t) ? t : (Y(t) && t.colorStops && (t.colorStops[0] || {}).color) || e
    );
  }
  var $h = R,
    Qh = ['left', 'right', 'top', 'bottom', 'width', 'height'],
    Jh = [
      ['width', 'left', 'right'],
      ['height', 'top', 'bottom'],
    ];
  ...
  function ic(t, e, n) {
    ...
    function a(n, r) {
      ...
      if (
        ...
        return (
          l(e, n[1]) ? (u[n[2]] = null) : l(e, n[2]) && (u[n[1]] = null), u
        );
      if (2 !== h && a) {
        if (a >= 2) return o;
  ...
  var oc = Zr(),
    ac = (function (t) {
      function e(e, n, i) {
        ...
        return (r.uid = sh('ec_cpt_model')), r;
      }
      return (
        n(e, t),
  ...
  oo(ac, oh),
    ...
    (function (t, e) {
              ...
              return (
                R(t, function (o) {
                  ...
                  (a.entryCount = s.length),
                    ...
                    R(s, function (t) {
                      A(a.predecessor, t) < 0 && a.predecessor.push(t);
                      var e = n(i, t);
                      A(e.successor, t) < 0 && e.successor.push(o);
                    });
                }),
      ...
      var e = [];
      R(ac.getClassesByMainType(t), function (t) {
        e = e.concat(t.dependencies || t.prototype.dependencies || []);
      }),
        (e = N(e, function (t) {
          return io(t).main;
        })),
        'dataset' !== t && A(e, 'dataset') <= 0 && e.unshift('dataset');
      return e;
    });
  var sc = '';
  'undefined' != typeof navigator && (sc = navigator.platform || '');
  var lc = 'rgba(0, 0, 0, 0.2)',
    uc = {
      darkMode: 'auto',
      colorBy: 'series',
      color: [
      ...
      textStyle: {
        fontFamily: sc.match(/^Win/) ? 'Microsoft YaHei' : 'sans-serif',
        fontSize: 12,
        fontStyle: 'normal',
        fontWeight: 'normal',
      },
  ...
  function Sc(t, e, n) {
    ...
    R((t = t.slice()), function (e, n) {
      var r = Y(e) ? e : (t[n] = { name: e });
      'ordinal' === r.type && null == o && ((o = n), (a = d(r))),
        (i[r.name] = []);
    });
  ...
  function Mc(t, e, n) {
    ...
    (o !== fc && o !== dc) ||
      R(a, function (t, e) {
        'name' === (Y(t) ? t.name : t) && (r = e);
      });
    var s = (function () {
      for (var t = {}, i = {}, s = [], l = 0, u = Math.min(5, n); l < u; l++) {
        var h = Dc(e.data, o, e.seriesLayoutBy, a, e.startIndex, l);
        s.push(h);
        var c = h === wc;
        if (
          (c && null == t.v && l !== r && (t.v = l),
          (null == t.n || t.n === t.v || (!c && s[t.n] === wc)) && (t.n = l),
          p(t) && s[t.n] !== wc)
        )
          return t;
        c ||
          (h === xc && null == i.v && l !== r && (i.v = l),
  ...
  function Dc(t, e, n, i, r, o) {
    ...
    if (i) {
      var u = i[o];
      Y(u) ? ((s = u.name), (l = u.type)) : G(u) && (s = u);
    }
    if (null != l) return 'ordinal' === l ? _c : wc;
    if (e === pc) {
      var h = t;
      if (n === mc) {
    ...
    Rc = (function () {
      ...
      return (
        (t.prototype.getColorFromPalette = function (t, e, n) {
          var i = Er(this.get('color', !0)),
            r = this.get('colorLayer', !0);
          return Ec(this, Pc, i, r, t, e, n);
        }),
  ...
  function Nc(t, e, n, i) {
    var r = Er(t.get(['aria', 'decal', 'decals']));
    return Ec(t, Oc, r, null, e, n, i);
  }
  function Ec(t, e, n, i, r, o, a) {
    var s = e((o = o || t)),
      l = s.paletteIdx || 0,
  ...
  var Bc = (function (t) {
    ...
    return (
      ...
      (e.prototype.init = function (t, e, n, i, r, o) {
        (i = i || {}),
          (this.option = null),
          (this._theme = new oh(i)),
          (this._locale = new oh(r)),
      ...
      (e.prototype.resetOption = function (t, e) {
        return this._resetOption(t, Hc(e));
      }),
      ...
      (e.prototype._mergeOption = function (t, e) {
        ...
        (bc(this).datasetMap = ft()),
          R(t, function (t, e) {
            null != t &&
              (ac.hasClass(e)
                ? e && (o.push(e), a.set(e, !0))
                : (n[e] = null == n[e] ? T(t) : C(n[e], t, !0)));
          }),
          s &&
            s.each(function (t, e) {
              ac.hasClass(e) && !a.get(e) && (o.push(e), a.set(e, !0));
            }),
          ac.topologicalTravel(
            o,
            ac.getAllClassMainTypes(),
            function (e) {
              ...
              R(
                ...
                function (t, n) {
                  ...
                  if (r) {
                    var o = 'series' === e,
                      a = ac.getClass(e, t.keyInfo.subType, !o);
                    if (!a) return;
                    if ('tooltip' === e) {
                      if (h) return void 0;
                      h = !0;
                    ...
                    if (i && i.constructor === a)
                      ...
                      var s = D({ componentIndex: n }, t.keyInfo);
                      D((i = new a(r, this, this, s)), s),
                        t.brandNew && (i.__requireNewView = !0),
                        i.init(r, this, this),
                        i.optionUpdated(null, !0);
                    }
                  } else
                    i && (i.mergeOption({}, this), i.optionUpdated({}, !1));
                  i
                    ? (c.push(i.option), p.push(i), f++)
      ...
      (e.prototype.getOption = function () {
        ...
        return (
          R(t, function (e, n) {
            if (ac.hasClass(n)) {
              for (var i = Er(e), r = i.length, o = !1, a = r - 1; a >= 0; a--)
                i[a] && !Yr(i[a]) ? (o = !0) : ((i[a] = null), !o && r--);
              (i.length = r), (t[n] = i);
            }
          }),
          delete t[zc],
      ...
      (e.prototype.findComponents = function (t) {
        var e,
          ...
          u = l
            ...
            : z(this._componentsMap.get(s), function (t) {
                return !!t;
              });
        return (o = Vc(u, t)), t.filter ? z(o, t.filter) : o;
      }),
      (e.prototype.eachComponent = function (t, e, n) {
        ...
        if (W(t)) {
          ...
          for (
            var a = G(t) ? i.get(t) : Y(t) ? this.findComponents(t) : null,
              s = 0;
            a && s < a.length;
            s++
          ) {
      ...
      (e.prototype.getSeriesByName = function (t) {
        var e = Ur(t, null);
        return z(this._componentsMap.get('series'), function (t) {
      ...
      (e.prototype.getSeriesByType = function (t) {
        return z(this._componentsMap.get('series'), function (e) {
      ...
      (e.prototype.isSeriesFiltered = function (t) {
        return Ac(this), null == this._seriesIndicesMap.get(t.componentIndex);
      }),
      ...
      (e.prototype.restoreData = function (t) {
        ...
        var e = this._componentsMap,
          n = [];
        e.each(function (t, e) {
          ac.hasClass(e) && n.push(e);
        }),
          ac.topologicalTravel(n, ac.getAllClassMainTypes(), function (n) {
            R(e.get(n), function (e) {
              !e ||
                ('series' === n &&
                  (function (t, e) {
                    if (e) {
      ...
      (e.internalField =
        ...
        (Ac = function (t) {}),
        void (Lc = function (t, e) {
          (t.option = {}),
            (t.option[zc] = 1),
            (t._componentsMap = ft({ series: [] })),
            (t._componentsCount = ft());
          var n = e.aria;
          Y(n) && null == n.enabled && (n.enabled = !0),
            (function (t, e) {
  ...
  function Fc(t, e, n) {
    if (H(e)) {
      ...
      return (
        R(e, function (t) {
          null != t && null != Ur(t, null) && i.set(t, !0);
        }),
        z(n, function (e) {
          return e && i.get(e[t]);
        })
  ...
  function Hc(t) {
    ...
    return (
      t &&
        R(Er(t.replaceMerge), function (t) {
          e.set(t, !0);
        }),
    ...
    qc = (function () {
      ...
      return (
        (t.prototype.setOption = function (t, e, n) {
          t &&
            (R(Er(t.series), function (t) {
              t && t.data && Z(t.data) && lt(t.data);
            }),
            R(Er(t.dataset), function (t) {
              t && t.source && Z(t.source) && lt(t.source);
            })),
            (t = T(t));
  ...
  function Jc(t, e, n) {
    if (t && t[e] && (t[e].normal || t[e].emphasis)) {
      var i = t[e].normal,
        r = t[e].emphasis;
      i &&
        (n ? ((t[e].normal = t[e].emphasis = null), I(t[e], i)) : (t[e] = i)),
        r &&
          ((t.emphasis = t.emphasis || {}),
          (t.emphasis[e] = r),
  ...
  function np(t) {
    t && (tp(t), ep(t, 'label'), t.emphasis && ep(t.emphasis, 'label'));
  }
  function ip(t) {
    return H(t) ? t : t ? [t] : [];
  }
  ...
  function op(t, e) {
        ...
        (function (t) {
          if (Kc(t)) {
            Qc(t),
              ...
              t.emphasis &&
                (ep(t.emphasis, 'label'),
                ep(t.emphasis, 'upperLabel'),
                ep(t.emphasis, 'edgeLabel'));
            var e = t.markPoint;
            e && (Qc(e), np(e));
            var n = t.markLine;
            n && (Qc(n), np(n));
            ...
            if ('graph' === t.type) {
              ...
              if (o && !Z(o)) for (var a = 0; a < o.length; a++) np(o[a]);
              R(t.categories, function (t) {
                tp(t);
              });
            }
            if (r && !Z(r)) for (a = 0; a < r.length; a++) np(r[a]);
            if ((e = t.markPoint) && e.data) {
              var s = e.data;
              for (a = 0; a < s.length; a++) np(s[a]);
            }
            if ((n = t.markLine) && n.data) {
              var l = n.data;
              for (a = 0; a < l.length; a++)
                H(l[a]) ? (np(l[a][0]), np(l[a][1])) : np(l[a]);
            }
            'gauge' === t.type
              ? (ep(t, 'axisLabel'), ep(t, 'title'), ep(t, 'detail'))
              : 'treemap' === t.type
                ? (Jc(t.breadcrumb, 'itemStyle'),
                  R(t.levels, function (t) {
                    tp(t);
                  }))
                : 'tree' === t.type && tp(t.leaves);
          }
        })(t);
    });
    var n = [
    ...
    e && n.push('valueAxis', 'categoryAxis', 'logAxis', 'timeAxis'),
      jc(n, function (e) {
        jc(ip(t[e]), function (t) {
          t && (ep(t, 'axisLabel'), ep(t.axisPointer, 'label'));
        });
      }),
      jc(ip(t.parallel), function (t) {
        var e = t && t.parallelAxisDefault;
        ep(e, 'axisLabel'), ep(e && e.axisPointer, 'label');
      }),
      jc(ip(t.calendar), function (t) {
        Jc(t, 'itemStyle'),
          ep(t, 'dayLabel'),
          ep(t, 'monthLabel'),
          ep(t, 'yearLabel');
      }),
      jc(ip(t.radar), function (t) {
        ep(t, 'name'),
          t.name &&
            null == t.axisName &&
      ...
      jc(ip(t.geo), function (t) {
        Kc(t) &&
          (np(t),
          jc(ip(t.regions), function (t) {
            np(t);
          }));
      }),
      jc(ip(t.timeline), function (t) {
        np(t), Jc(t, 'label'), Jc(t, 'itemStyle'), Jc(t, 'controlStyle', !0);
        var e = t.data;
        H(e) &&
          R(e, function (t) {
            Y(t) && (Jc(t, 'label'), Jc(t, 'itemStyle'));
          });
      }),
      jc(ip(t.toolbox), function (t) {
        Jc(t, 'iconStyle'),
          jc(t.feature, function (t) {
            Jc(t, 'iconStyle');
          });
      }),
      ep(rp(t.axisPointer), 'label'),
      ep(rp(t.tooltip).axisPointer, 'label');
  }
  function ap(t) {
    t &&
      R(sp, function (e) {
  ...
  function fp(t, e) {
    if (t)
      for (var n = 0; n < t.length; n++) e(t[n]), t[n] && fp(t[n].children, e);
  }
  function dp(t, e) {
    op(t, e),
      (t.series = Er(t.series)),
        ...
        if (Y(t)) {
          ...
          if ('line' === e) null != t.clipOverflow && (t.clip = t.clipOverflow);
            ...
            if (
              ...
              for (var n = 0; n < r.length; n++) cp(r[n]);
            null != t.hoverOffset &&
              ((t.emphasis = t.emphasis || {}),
            ...
            if (
              (hp(t),
              hp(t.backgroundStyle),
              hp(t.emphasis),
              (r = t.data) && !Z(r))
            )
              for (n = 0; n < r.length; n++)
                'object' == typeof r[n] &&
                  (hp(r[n]), hp(r[n] && r[n].emphasis));
          } else if ('sunburst' === e) {
            ...
            'graph' === e || 'sankey' === e
              ...
              : 'map' === e &&
                ...
                t.mapLocation && I(t, t.mapLocation));
  ...
  function gp(t) {
    R(t, function (e, n) {
      ...
      a.modify(o, function (o, u, h) {
        var c,
          p,
          f = a.get(e.stackedDimension, h);
        if (isNaN(f)) return r;
        s ? (p = a.getRawIndex(h)) : (c = a.get(e.stackedByDimension, h));
        for (var d = NaN, g = n - 1; g >= 0; g--) {
          var y = t[g];
  ...
  var yp,
    ...
    xp,
    wp = function (t) {
      (this.data = t.data || (t.sourceFormat === dc ? {} : [])),
        (this.sourceFormat = t.sourceFormat || yc),
        (this.seriesLayoutBy = t.seriesLayoutBy || vc),
      ...
      if (e)
        for (var n = 0; n < e.length; n++) {
          var i = e[n];
          null == i.type && Cc(this, n) === _c && (i.type = 'ordinal');
        }
    };
  function bp(t) {
    return t instanceof wp;
  }
  function Sp(t, e, n) {
    n = n || Tp(t);
  ...
  function Mp(t) {
    return new wp({ data: t, sourceFormat: Z(t) ? gc : cc });
  }
  function Tp(t) {
    var e = yc;
    if (Z(t)) e = gc;
  ...
  var kp = (function () {
        ...
        (t.internalField = (function () {
          ...
          xp = function (t, r, o) {
            ...
            if ((D(t, h), a === gc))
              ...
              var c = Pp(a, s);
              t.getItem = F(c, null, r, l, u);
              var p = Np(a, s);
              t.count = F(p, null, r, l, u);
            }
          };
          var e = function (t, e) {
              (t -= this._offset), (e = e || []);
    ...
    Lp =
      (((yp = {})[pc + '_' + vc] = function (t, e, n, i) {
        return t[i + e];
      }),
      (yp[pc + '_' + mc] = function (t, e, n, i, r) {
        i += e;
  ...
  var Op = function (t, e, n) {
    ...
    Rp =
      (((vp = {})[pc + '_' + vc] = function (t, e, n) {
        return Math.max(0, t.length - e);
      }),
      (vp[pc + '_' + mc] = function (t, e, n) {
        var i = t[0];
        return i ? Math.max(0, i.length - e) : 0;
      }),
      (vp[fc] = Op),
      (vp[dc] = function (t, e, n) {
        var i = n[0].name;
        var r = t[i];
        return r ? r.length : 0;
      }),
  ...
  var Ep = function (t, e, n) {
    ...
    zp =
      (((mp = {})[pc] = Ep),
      (mp[fc] = function (t, e, n) {
        return t[n];
      }),
      (mp[dc] = Ep),
      (mp[cc] = function (t, e, n) {
        var i = Fr(t);
    ...
    Wp = (function () {
      ...
      return (
        ...
        (t.prototype.getFormattedLabel = function (t, e, n, i, r, o) {
          ...
          null != i && H(s.value) && (s.value = s.value[i]),
          r) ||
            (r = a
              .getItemModel(t)
              .get(
          ...
          return W(r)
            ...
            : G(r)
              ? jh(r, s).replace(Hp, function (e, n) {
                  var i = n.length,
                    r = n;
                  '[' === r.charAt(0) &&
                    ']' === r.charAt(i - 1) &&
        ...
        (t.prototype._doProgress = function (t, e, n, i, r) {
          Xp.reset(e, n, i, r),
            ...
            this._callingProgress(
              { start: e, end: n, count: n - e, next: Xp.next },
              this.context
            );
        }),
  ...
  function jp(t) {
    ...
    if (e === fc) {
      for (r = [], o = 0, a = n.length; o < a; o++) r.push(D({}, n[o]));
      return r;
    }
  }
  function Kp(t, e, n) {
    if (null != n)
      return X(n) || (!isNaN(n) && !vt(e, n)) ? t[n] : vt(e, n) ? e[n] : void 0;
  }
  function $p(t) {
    return T(t);
  }
    ...
    var s = N(e, function (t) {
        return (function (t, e) {
          ...
          e.__isBuiltIn &&
            ...
            (n.getRawData = F(Zp, null, t))),
            (n.cloneRawData = F(jp, null, t));
          var p = Np(r, vc);
          n.count = F(p, null, i, o, s);
          var f = Bp(r);
          ...
          return (
            (n.getDimensionInfo = F(Kp, null, s, l)),
            (n.cloneAllDimensionInfo = F($p, null, s)),
            n
          );
        })(t, a);
      }),
      l = Er(
        a.transform({ upstream: s[0], upstreamList: s, config: T(t.config) })
      );
    return N(l, function (t, n) {
      var i,
        r = '';
      Y(t) || Or(r), t.data || Or(r), tf(Tp(t.data)) || Or(r);
      var o = e[0];
      if (o && 0 === n && !t.dimensions) {
        ...
        i = { seriesLayoutBy: vc, sourceHeader: 0, dimensions: t.dimensions };
      return Sp(t.data, i, null);
    });
  }
  function tf(t) {
    return t === pc || t === fc;
  ...
  var ef,
    nf = 'undefined',
    rf = typeof Uint32Array === nf ? Array : Uint32Array,
    of = typeof Uint16Array === nf ? Array : Uint16Array,
    af = typeof Int32Array === nf ? Array : Int32Array,
    sf = typeof Float64Array === nf ? Array : Float64Array,
    lf = { float: sf, int: af, ordinal: Array, number: Array, time: sf };
  function uf(t) {
    return t > 65535 ? rf : of;
  }
  ...
  var cf = (function () {
      ...
      return (
        (t.prototype.initData = function (t, e, n) {
          ...
          var i = t.getSource(),
            r = (this.defaultDimValueGetter = ef[i.sourceFormat]);
        ...
        (t.prototype.ensureCalculationDimension = function (t, e) {
          ...
          return (
            (i[r] = { type: e }),
            n.set(t, r),
            (this._chunks[r] = new lf[e || 'float'](this._rawCount)),
        ...
        (t.prototype.appendValues = function (t, e) {
          for (
            ...
            hf(n, l, (f = i[l]).type, s, !0);
          }
          for (var u = [], h = a; h < s; h++)
            for (var c = h - a, p = 0; p < r; p++) {
              var f = i[p],
                d = ef.arrayRows.call(this, t[c] || u, f.property, c, p);
              n[p][h] = d;
              var g = o[p];
        ...
        (t.prototype._initDataFromProvider = function (t, e, n) {
          for (
            ...
            var h = o[u];
            s[u] || (s[u] = [1 / 0, -1 / 0]), hf(r, u, h.type, e, n);
          }
        ...
        (t.prototype.getIndices = function () {
          ...
          if (e) {
            ...
            t = new (n = uf(this._rawCount))(this.count());
        ...
        (t.prototype.downSample = function (t, e, n, i) {
          for (
            var r = this.clone([t], !0),
              ...
              c = new (uf(this._rawCount))(Math.ceil(u / s)),
              p = 0,
              f = 0;
            f < u;
            f += s
        ...
        (t.internalField = (function () {
          function t(t, e, n, i) {
            return Yp(t[i], this._dimensions[i]);
          }
          ef = {
            arrayRows: t,
            objectRows: function (t, e, n, i) {
              return Yp(t[e], this._dimensions[i]);
            },
            keyedColumns: t,
            original: function (t, e, n, i) {
              var r = t && (null == t.value ? t : t.value);
              return Yp(r instanceof Array ? r[i] : r, this._dimensions[i]);
            },
      ...
      return (
          ...
          if (df(n)) {
            ...
            if (r) {
              ...
              u.prepareSource(),
                ...
                (s = l.sourceFormat),
                (e = [u._getVersionSign()]);
            } else (s = Z((a = o.get('data', !0))) ? gc : cc), (e = []);
            var h = this._getSourceMetaRawOption() || {},
              c = (l && l.metaRawOption) || {},
              p = et(h.seriesLayoutBy, c.seriesLayoutBy) || null,
              f = et(h.sourceHeader, c.sourceHeader),
              d = et(h.dimensions, c.dimensions);
            t =
            ...
            if (r) {
              ...
              (t = [
                Sp(g.get('source', !0), this._getSourceMetaRawOption(), null),
              ]),
                (e = []);
            }
          }
          ...
          return (
            R(t, function (t) {
              ...
              var e = t.getSource(r || 0),
                n = '';
              null == r || e || gf(n), s.push(e), l.push(t._getVersionSign());
            }),
            i
              ? (e = (function (t, e, n) {
                  var i = Er(t),
        ...
        (t.prototype._innerGetDataStore = function (t, e, n) {
          ...
          if (!o) {
            ...
            df(this._sourceHost) && a
              ? (o = a._innerGetDataStore(t, e, n))
              : (o = new cf()).initData(new kp(e, t.length), t),
              (r[n] = o);
          }
          return o;
        }),
  ...
  function ff(t) {
    t.option.transform && lt(t.option.transform);
  }
  function df(t) {
  ...
  function vf(t) {
    var e,
      ...
      p = H(c),
      f = (function (t, e) {
        return Kh(t.getData().getItemVisual(e, 'style')[t.visualDrawType]);
      })(o, a);
    if (h > 1 || (p && !h)) {
    ...
    return (
      ...
      (e.prototype.init = function (t, e, n) {
        (this.seriesIndex = this.componentIndex),
          (this.dataTask = Gp({ count: bf, reset: Sf })),
          (this.dataTask.context = { model: this }),
          this.mergeDefaultAndTheme(t, n),
          (mf(this).sourceManager = new pf(this)).prepareSource();
        var i = this.getInitialData(t, n);
        Tf(i, this),
          (this.dataTask.context.data = i),
          (mf(this).dataBeforeProcessed = i),
          wf(this),
      ...
      (e.prototype.getSourceManager = function () {
        return mf(this).sourceManager;
      }),
      (e.prototype.getSource = function () {
        return this.getSourceManager().getSource();
      }),
      (e.prototype.getRawData = function () {
        return mf(this).dataBeforeProcessed;
      }),
      ...
      (e.prototype.formatTooltip = function (t, e, n) {
        return vf({ series: this, dataIndex: t, multipleSeries: e });
      }),
      ...
      (e.prototype.getColorFromPalette = function (t, e, n) {
        var i = this.ecModel,
          r = Rc.prototype.getColorFromPalette.call(this, t, e, n);
  ...
  function Sf(t) {
    var e = t.model;
    return e.setData(e.getRawData().cloneShallow()), Mf;
  }
  function Mf(t, e) {
    e.outputData &&
  ...
  function Tf(t, e) {
    R(dt(t.CHANGABLE_METHODS, t.DOWNSAMPLE_METHODS), function (n) {
      t.wrapMethod(n, V(Cf, e));
    });
  }
  function Cf(t, e) {
    var n = Df(t);
  ...
  P(xf, Wp), P(xf, Rc), oo(xf, ac);
  var If = (function () {
    function t() {
      (this.group = new or()), (this.uid = sh('viewComponent'));
    }
    return (
  ...
  var Af = Zr(),
    ...
    Pf = (function () {
      function t() {
        (this.group = new or()),
          (this.uid = sh('viewChart')),
          (this.renderTask = Gp({ plan: Nf, reset: Ef })),
  ...
  function Ef(t) {
    var e = t.model,
      ...
      a = t.view,
      s = r && Af(r).updateMethod,
      l = o ? 'incrementalPrepareRender' : s && a[s] ? s : 'render';
    return 'render' !== l && a[l](e, n, i, r), zf[l];
  }
  ro(Pf), uo(Pf);
  var zf = {
  ...
  var Ff = Zr(),
    Vf = { itemStyle: ho(nh, !0), lineStyle: ho(Ju, !0) },
    Hf = { lineStyle: 'stroke', itemStyle: 'fill' };
  function Wf(t, e) {
    var n = t.visualStyleMapper || Vf[e];
    return n || (console.warn("Unknown style type '" + e + "'."), Vf.itemStyle);
  }
  function Gf(t, e) {
    var n = t.visualDrawType || Hf[e];
      ...
      reset: function (t, e) {
        ...
        if (!o[s] || u || h) {
          ...
          o[s] || ((o[s] = c), n.setVisual('colorFromPalette', !0)),
            (o.fill = 'auto' === o.fill || W(o.fill) ? c : o.fill),
            (o.stroke = 'auto' === o.stroke || W(o.stroke) ? c : o.stroke);
        }
        if (
          (n.setVisual('style', o),
            ...
            dataEach: n.hasItemOption
              ? function (t, e) {
                  ...
                  if (n && n[i]) {
                    Xf.option = n[i];
                    var a = r(Xf);
                    D(t.ensureUniqueItemVisual(e, 'style'), a),
                      Xf.option.decal &&
                        (t.setItemVisual(e, 'decal', Xf.option.decal),
                        (Xf.option.decal.dirty = !0)),
  ...
  var jf = (function () {
    ...
    return (
      ...
      (t.prototype._createSeriesStageTask = function (t, e, n, i) {
        ...
        function u(e) {
          var s = e.uid,
            l = a.set(
              s,
              (o && o.get(s)) || Gp({ plan: td, reset: ed, count: rd })
            );
          (l.context = {
            model: e,
            ecModel: n,
      ...
      (t.prototype._createOverallStageTask = function (t, e, n, i) {
        var r = this,
          o = (e.overallTask = e.overallTask || Gp({ reset: Kf }));
        o.context = {
          ecModel: n,
          api: i,
        ...
        function f(t) {
          var e = t.uid,
            n = s.set(
              e,
              (a && a.get(e)) || ((c = !0), Gp({ reset: $f, onDirty: Jf }))
            );
      ...
      (t.wrapStageHandler = function (t, e) {
        return (
          W(t) && (t = { overallReset: t, seriesType: od(t) }),
          (t.uid = sh('stageHandler')),
          e && (t.visualType = e),
          t
        );
      }),
  ...
  var ad,
    ...
    ld = {};
  function ud(t, e) {
    for (var n in e.prototype) t[n] = mt;
  }
  ud(sd, Bc),
    ud(ld, Gc),
    (sd.eachSeriesByType = sd.eachRawSeriesByType =
      function (t) {
        ad = t;
      }),
    (sd.eachComponent = function (t) {
      'series' === t.mainType && t.subType && (ad = t.subType);
    });
  var hd = [
      '#37A2DA',
      '#32C5E9',
    ...
    yd = {
      ...
      legend: { textStyle: { color: pd } },
      textStyle: { color: pd },
      title: {
        textStyle: { color: '#EEF1FA' },
        subtextStyle: { color: '#B9B8CE' },
      },
      toolbox: { iconStyle: { borderColor: pd } },
      dataZoom: {
        borderColor: '#71708A',
        textStyle: { color: pd },
      ...
      visualMap: { textStyle: { color: pd } },
      timeline: {
        lineStyle: { color: pd },
        label: { color: pd },
        controlStyle: { color: pd, borderColor: pd },
      },
      calendar: {
        itemStyle: { color: fd },
        dayLabel: { color: pd },
  ...
  yd.categoryAxis.splitLine.show = !1;
  var vd = (function () {
      function t() {}
      return (
    ...
    md = ['symbol', 'symbolSize', 'symbolRotate', 'symbolOffset'],
    _d = md.concat(['symbolKeepAspect']),
    xd = {
      createOnAllSeries: !0,
      performRawSeries: !0,
      reset: function (t, e) {
        ...
        if (
          ...
          for (var i = {}, r = {}, o = !1, a = 0; a < md.length; a++) {
            var s = md[a],
              l = t.get(s);
            W(l) ? ((o = !0), (r[s] = l)) : (i[s] = l);
          }
          if (
            ...
            return {
              dataEach: o
                ? function (e, n) {
                    for (
                      var i = t.getRawValue(n), o = t.getDataParams(n), a = 0;
                      a < u.length;
                      a++
                    ) {
                      var s = u[a];
        ...
        if (t.hasSymbolVisual && !e.isSeriesFiltered(t))
          return {
            dataEach: t.getData().hasItemOption
              ? function (t, e) {
                  for (var n = t.getItemModel(e), i = 0; i < _d.length; i++) {
                    var r = _d[i],
                      o = n.getShallow(r, !0);
      ...
      i.eachComponent({ mainType: 'series', subType: 'pie' }, function (t) {
        for (
          ...
          if (a[s].seriesIndex === e) {
            var l = t.getData(),
              u = qr(l, r.fromActionPayload);
            n.trigger(o, {
              type: o,
              seriesId: t.id,
              name: H(u) ? l.getName(u[0]) : l.getName(u),
              selected: G(i) ? i : D({}, i),
            });
          }
      });
  ...
  var Md = Math.round(9 * Math.random()),
    Td = 'function' == typeof Object.defineProperty,
    Cd = (function () {
      function t() {
        this._id = '__ec_inner_' + Md++;
      }
      return (
        (t.prototype.get = function (t) {
  ...
  var Od = Ea.extend({
    ...
    buildPath: function (t, e, n) {
      ...
      if ('none' !== i) {
        var r = Pd[i];
        r || (r = Pd[(i = 'rect')]),
          Ld[i](e.x, e.y, e.width, e.height, r.shape),
  ...
  function Nd(t, e, n, i, r, o, a) {
    ...
    return (
      ...
      ((s =
        0 === t.indexOf('image://')
          ? Iu(t.slice(8), new Ce(e, n, i, r), a ? 'center' : 'cover')
          : 0 === t.indexOf('path://')
            ? Du(t.slice(7), {}, new Ce(e, n, i, r), a ? 'center' : 'cover')
            : new Od({
  ...
  function Ed(t, e) {
    if (null != t)
      return (
        H(t) || (t = [t, t]),
        [dr(t[0], e[0]) || 0, dr(et(t[1], t[0]), e[1]) || 0]
      );
  }
  function zd(t) {
    return isFinite(t);
  ...
  var jd = ['shadowBlur', 'shadowOffsetX', 'shadowOffsetY'],
    Kd = [
      ['lineCap', 'butt'],
      ['lineJoin', 'miter'],
      ['miterLimit', 10],
  ...
  function $d(t, e, n, i, r) {
    ...
    if (i || e.opacity !== n.opacity) {
      ...
      t.globalAlpha = isNaN(a) ? Po.opacity : a;
    }
    (i || e.blend !== n.blend) &&
      (o || (tg(t, r), (o = !0)),
      (t.globalCompositeOperation = e.blend || Po.blend));
    for (var s = 0; s < jd.length; s++) {
      var l = jd[s];
      (i || e[l] !== n[l]) &&
        (o || (tg(t, r), (o = !0)), (t[l] = t.dpr * (e[l] || 0)));
    }
    return (
      (i || e.shadowColor !== n.shadowColor) &&
        (o || (tg(t, r), (o = !0)),
        (t.shadowColor = e.shadowColor || Po.shadowColor)),
      o
    );
  }
  function Qd(t, e, n, i, r) {
    var o = eg(e, r.inHover),
      a = i ? null : (n && eg(n, r.inHover)) || {};
    if (o === a) return !1;
    var s = $d(t, o, a, i, r);
    if (
      ((i || o.fill !== a.fill) &&
        (s || (tg(t, r), (s = !0)), Ud(o.fill) && (t.fillStyle = o.fill)),
      (i || o.stroke !== a.stroke) &&
        (s || (tg(t, r), (s = !0)), Ud(o.stroke) && (t.strokeStyle = o.stroke)),
      ...
      t.lineWidth !== l && (s || (tg(t, r), (s = !0)), (t.lineWidth = l));
    }
    for (var u = 0; u < Kd.length; u++) {
      var h = Kd[u],
        c = h[0];
      (i || o[c] !== a[c]) &&
        (s || (tg(t, r), (s = !0)), (t[c] = o[c] || h[1]));
    }
    return s;
  }
  function Jd(t, e) {
  ...
  function ng(t, e) {
    ig(t, e, { inHover: !1, viewWidth: 0, viewHeight: 0 }, !0);
  }
  function ig(t, e, n, i) {
    var r = e.transform;
    ...
    if (
      ...
      c && p
        ...
        ? (tg(t, n), Jd(t, e))
        : f || tg(t, n);
      var d = eg(e, n.inHover);
      e instanceof Ea
        ? (1 !== n.lastDrawType && ((u = !0), (n.lastDrawType = 1)),
          Qd(t, e, h, u, n),
          (f && (n.batchFill || n.batchStroke)) || t.beginPath(),
          (function (t, e, n, i) {
            var r,
              o = Gd(n),
              a = Xd(n),
            ...
            if (!i) {
              ...
              (d || g) && (b = e.getBoundingRect()),
                d &&
                  ((m = c ? Bd(t, p, b) : e.__canvasFillGradient),
                  (e.__canvasFillGradient = m)),
                g &&
                  ((_ = c ? Bd(t, f, b) : e.__canvasStrokeGradient),
                ...
                d ? (t.fillStyle = m) : y && (x ? (t.fillStyle = x) : (a = !1)),
                g
                  ? (t.strokeStyle = _)
                  : v && (w ? (t.strokeStyle = w) : (o = !1));
            }
            var S,
              M,
              T = e.getGlobalScale();
            h.setScale(T[0], T[1], e.segmentIgnoreThreshold),
              t.setLineDash && n.lineDash && ((S = (r = Hd(e))[0]), (M = r[1]));
            var C = !0;
            (u || 4 & c) &&
              (h.setDPR(t.dpr),
          ...
          f && ((n.batchFill = d.fill || ''), (n.batchStroke = d.stroke || '')))
        : e instanceof Ba
            ...
            (function (t, e, n) {
              ...
              if ((null != r && (r += ''), r)) {
                ...
                t.setLineDash &&
                  n.lineDash &&
                  ((a = (i = Hd(e))[0]), (s = i[1])),
                  a && (t.setLineDash(a), (t.lineDashOffset = s)),
                  n.strokeFirst
                    ? (Gd(n) && t.strokeText(r, n.x, n.y),
                      Xd(n) && t.fillText(r, n.x, n.y))
                    : (Xd(n) && t.fillText(r, n.x, n.y),
                      Gd(n) && t.strokeText(r, n.x, n.y)),
                  a && t.setLineDash([]);
              }
          ...
          : e instanceof Ha
            ? (2 !== n.lastDrawType && ((u = !0), (n.lastDrawType = 2)),
              (function (t, e, n, i, r) {
                $d(t, eg(e, r.inHover), n && eg(n, r.inHover), i, r);
              })(t, e, h, u, n),
              (function (t, e, n) {
                var i = (e.__image = yo(n.image, e.__image, e, e.onload));
                if (i && mo(i)) {
                  var r = n.x || 0,
                    o = n.y || 0,
                    a = e.getWidth(),
  ...
  function sg(t, e) {
    ...
    return (
      (function (t) {
        for (var e, o = [n], s = !0, l = 0; l < ag.length; ++l) {
          var h = a[ag[l]];
          if (null != h && !H(h) && !G(h) && !X(h) && 'boolean' != typeof h) {
            s = !1;
            break;
          }
          o.push(h);
        ...
        var p,
          ...
          x = (function () {
            for (var t = 1, e = 0, n = y.length; e < n; ++e) t = Lr(t, y[e]);
            var i = 1;
            for (e = 0, n = g.length; e < n; ++e) i = Lr(i, g[e].length);
            t *= i;
  ...
  function lg(t) {
    ...
    if (e) return lg([t]);
    var i = [];
    for (n = 0; n < t.length; ++n) G(t[n]) ? i.push([t[n]]) : i.push(t[n]);
    return i;
  }
  function ug(t) {
    if (!t || 0 === t.length) return [[0, 0]];
    if (X(t)) return [[(r = Math.ceil(t)), r]];
    for (var e = !0, n = 0; n < t.length; ++n)
      if (!X(t[n])) {
        e = !1;
        break;
  ...
  var dg = 2e3,
    ...
    vg = '__flagInMainProcess',
    mg = '__pendingUpdate',
    _g = '__needsUpdateStatus',
    xg = /^[a-zA-Z0-9_]+$/,
    wg = '__connectUpdateStatus';
  function bg(t) {
    return function () {
      for (var e = [], n = 0; n < arguments.length; n++) e[n] = arguments[n];
      if (!this.isDisposed()) return Mg(this, t, e);
      Zg(this.id);
    };
  }
  function Sg(t) {
  ...
  function Mg(t, e, n) {
    return (n[0] = n[0] && n[0].toLowerCase()), Wt.prototype[e].apply(t, n);
  }
  var Tg,
    Cg,
    Dg,
    ...
    Ug = Gg.prototype;
  (Ug.on = Sg('on')), (Ug.off = Sg('off'));
  var Xg = (function (t) {
      function e(e, n, i) {
        var r = t.call(this, new vd()) || this;
        (r._chartsViews = []),
          (r._chartsMap = {}),
          (r._componentsViews = []),
          (r._componentsMap = {}),
        ...
        var o = 'canvas',
          ...
          l = (r._zr = ur(e, {
            ...
            height: i.height,
            ssr: i.ssr,
            useDirtyRect: et(i.useDirtyRect, s),
            useCoarsePointer: et(i.useCoarsePointer, a),
            pointerSize: i.pointerSize,
          }));
        (r._ssr = i.ssr),
          (r._throttledZrFlush = Bf(F(l.flush, l), 17)),
          (n = T(n)) && dp(n, !0),
          (r._theme = n),
          (r._locale = (function (t) {
            if (G(t)) {
              var e = ch[t.toUpperCase()] || {};
              return t === lh || t === uh ? T(e) : C(T(e), T(ch[hh]), !1);
            }
            return C(T(t), T(ch[hh]), !1);
          })(i.locale || fh)),
          (r._coordSysMgr = new Xc());
        var u = (r._api = Fg(r));
        function h(t, e) {
        ...
        return (
          We(Jg, h),
          We($g, h),
          (r._scheduler = new jf(r, u, $g, Jg)),
          (r._messageCenter = new Gg()),
          r._initEvents(),
          (r.resize = F(r.resize, r)),
      ...
      return (
        ...
        (e.prototype._onframe = function () {
          if (!this._disposed) {
            ...
            if (this[mg]) {
              var e = this[mg].silent;
              this[vg] = !0;
              try {
                Tg(this), Ig.update.call(this, null, this[mg].updateParams);
              } catch (t) {
                throw ((this[vg] = !1), (this[mg] = null), t);
              }
              this._zr.flush(),
                (this[vg] = !1),
                (this[mg] = null),
          ...
          if (!this[vg])
            if (this._disposed) Zg(this.id);
              ...
              if (
                ...
                var a = new qc(this._api),
                  s = this._theme,
                  l = (this._model = new Bc());
                (l.scheduler = this._scheduler),
                  (l.ssr = this._ssr),
                  l.init(null, null, null, s, this._locale, a);
              }
              this._model.setOption(t, { replaceMerge: r }, Qg);
              var u = { seriesTransition: o, optionChanged: !0 };
              if (n)
                (this[mg] = { silent: i, updateParams: u }),
                  (this[vg] = !1),
                  this.getZr().wakeUp();
              else {
                try {
                  Tg(this), Ig.update.call(this, null, u);
                } catch (t) {
                  throw ((this[mg] = null), (this[vg] = !1), t);
                }
        ...
        (e.prototype.getSvgDataURL = function () {
          if (r.svgSupported) {
            var t = this._zr;
            return (
              R(t.storage.getDisplayList(), function (t) {
        ...
        (e.prototype.convertToPixel = function (t, e) {
          return kg(this, 'convertToPixel', t, e);
        }),
        (e.prototype.convertFromPixel = function (t, e) {
          return kg(this, 'convertFromPixel', t, e);
        }),
        ...
        (e.prototype.getVisual = function (t, e) {
          var n = Kr(this._model, t, { defaultMainType: 'series' }),
            i = n.seriesModel;
          var r = i.getData(),
        ...
        (e.prototype._initEvents = function () {
          ...
          R(qg, function (t) {
                      ...
                      function (t) {
                        ...
                        if (e && null != e.dataIndex) {
                          ...
                          return (
                            (n =
                              (i &&
                                i.getDataParams(e.dataIndex, e.dataType, o)) ||
                              {}),
                            !0
                          );
                        }
                        if (e.eventData) return (n = D({}, e.eventData)), !0;
                      },
                      !0
                    ),
                n)
            ...
            t.on('selectchanged', function (t) {
              var i = n.getModel();
              t.isFromClick
                ? (bd('map', 'selectchanged', e, i, t),
                  bd('pie', 'selectchanged', e, i, t))
                : 'select' === t.fromAction
                  ? (bd('map', 'selected', e, i, t),
                    bd('pie', 'selected', e, i, t))
                  : 'unselect' === t.fromAction &&
                    (bd('map', 'unselected', e, i, t),
                    bd('pie', 'unselected', e, i, t));
            });
        }),
        ...
        (e.prototype.clear = function () {
          this._disposed ? Zg(this.id) : this.setOption({ series: [] }, !0);
        }),
        (e.prototype.dispose = function () {
          if (this._disposed) Zg(this.id);
          else {
            (this._disposed = !0), this.getDom() && to(this.getDom(), ay, '');
            var t = this,
              e = t._api,
              n = t._model;
              ...
              if ((this._loadingFX && this._loadingFX.resize(), e)) {
                ...
                try {
                  n && Tg(this),
                    Ig.update.call(this, {
                      type: 'resize',
                      animation: D({ duration: 0 }, t && t.animation),
                    });
                } catch (t) {
                  throw ((this[vg] = !1), t);
                }
                (this[vg] = !1), Pg.call(this, i), Og.call(this, i);
              }
            }
        }),
        ...
        (e.prototype.makeActionFromEvent = function (t) {
          var e = D({}, t);
          return (e.type = Kg[t.type]), e;
        }),
        (e.prototype.dispatchAction = function (t, e) {
          if (this._disposed) Zg(this.id);
          else if ((Y(e) || (e = { silent: !!e }), jg[t.type] && this._model))
            if (this[vg]) this._pendingActions.push(t);
            else {
              var n = e.silent;
              Lg.call(this, t, n);
              var i = e.flush;
              i
                ? this._zr.flush()
                : !1 !== i && r.browser.weChat && this._throttledZrFlush(),
                Pg.call(this, n),
                Og.call(this, n);
            }
        }),
        (e.prototype.updateLabelLayout = function () {
          cg.trigger('series:layoutlabels', this._model, this._api, {
            updatedSeries: [],
          });
        }),
        (e.prototype.appendData = function (t) {
          ...
          (Tg = function (t) {
            ...
            (Cg = function (t, e) {
              ...
              function u(t) {
                ...
                if (!h) {
                  var c = io(t.type),
                    p = e ? If.getClass(c.main, c.sub) : Pf.getClass(c.sub);
                  0,
                    (h = new p()).init(n, s),
                    (o[u] = h),
                    r.push(h),
            ...
            (Dg = function (t, e, n, i, r) {
                          ...
                          if (il(n))
                            if (e instanceof xf)
                              ...
                              n.type === gs &&
                                r &&
                                !n.notBlur &&
                                Xs(e.mainType, e.componentIndex, t._api),
                                o &&
                                  R(o, function (t) {
                                    n.type === gs ? zs(t) : Bs(t);
                                  });
              ...
              } else R([].concat(t._componentsViews).concat(t._chartsViews), h);
              function h(i) {
            ...
            (Ig = {
              ...
              updateView: function (e) {
                ...
                n &&
                  ...
                  Pf.markUpdateMethod(e, 'updateView'),
                  t(n),
                  this._scheduler.performVisualTasks(n, e, { setDirty: !0 }),
                  Eg(this, n, this._api, e, {}),
                  cg.trigger('afterupdate', n, this._api));
              },
              updateVisual: function (e) {
                ...
                i &&
                  ...
                  Pf.markUpdateMethod(e, 'updateVisual'),
                  t(i),
                  this._scheduler.performVisualTasks(i, e, {
                    visualType: 'visual',
                    setDirty: !0,
                  ...
                  cg.trigger('afterupdate', i, this._api));
              },
            ...
            (Lg = function (t, e) {
              ...
              t.batch &&
                ((p = !0),
                (c = N(t.batch, function (e) {
                  return ((e = I(D({}, e), t)).batch = null), e;
                })));
              var f,
                d = [],
                g = nl(t),
              ...
              if (
                ...
                R(c, function (e) {
                  if (
                    (((f =
                      (f = a.action(e, n._model, n._api)) || D({}, e)).type =
                      s.event || f.type),
                    d.push(f),
                    y)
                  ) {
                    ...
                    g
                      ? (Dg(n, u, e, 'series'), Hg(n))
                      : h && Dg(n, u, e, h.main, h.sub);
                }),
                'none' !== u && !y && !g && !h)
              )
                try {
                  this[mg]
                    ? (Tg(this), Ig.update.call(this, t), (this[mg] = null))
                    : Ig[u].call(this, t);
                } catch (t) {
                  throw ((this[vg] = !1), t);
                }
                ...
                n &&
                  (!(function (t, e, n) {
                    var i = ls(t),
                      ...
                      a = r.focusSelf;
                    o
                      ? (a && Xs(i.componentMainType, i.componentIndex, n),
                        R(o, function (t) {
                          return Ns(t, e);
                        }))
                      : (Us(i.seriesIndex, i.focus, i.blurScope, n),
                        'self' === i.focus &&
                          Xs(i.componentMainType, i.componentIndex, n),
                        Ns(t, e));
                  })(n, t, e._api),
                  Hg(e));
              })
            ...
            (zg = function (t, e, n, r, o, l) {
              R(l || t._componentsViews, function (t) {
                var o = t.__model;
                a(o, t), t.render(o, e, n, r), i(o, t), s(o, t);
              });
            }),
            (Bg = function (t, e, n, o, l, u) {
              var h = t._scheduler;
              (l = D(l || {}, { updatedSeries: e.getSeries() })),
                cg.trigger('series:beforeupdate', e, n, l);
              var c = !1;
              e.eachSeries(function (e) {
                ...
                cg.trigger('series:layoutlabels', e, n, l),
                cg.trigger('series:transition', e, n, l),
                e.eachSeries(function (e) {
                  var n = t._chartsMap[e.__viewId];
                  i(e, n), s(e, n);
                }),
                ...
                cg.trigger('series:afterupdate', e, n, l);
            }),
            (Hg = function (t) {
              (t[_g] = !0), t.getZr().wakeUp();
            }),
            (Wg = function (t) {
              t[_g] &&
  ...
  function yy(t, e, n) {
    W(e) && ((n = e), (e = ''));
    var i = Y(t) ? t.type : [t, (t = { event: e })][0];
    (t.event = (t.event || i).toLowerCase()),
      (e = t.event),
      Kg[e] ||
        (ot(xg.test(i) && xg.test(e)),
        jg[i] || (jg[i] = { action: n, actionInfo: t }),
        (Kg[e] = i));
  }
  function vy(t, e) {
    Xc.register(t, e);
  ...
  function my(t, e) {
    wy(Jg, t, e, 1e3, 'layout');
  }
  function _y(t, e) {
    wy(Jg, t, e, 3e3, 'visual');
  }
  var xy = [];
  function wy(t, e, n, i, r) {
    if (((W(e) || Y(e)) && ((n = e), (e = i)), !(A(xy, n) >= 0))) {
      xy.push(n);
      var o = jf.wrapStageHandler(n, r);
  ...
  _y(dg, Uf),
        ...
        if (!t.isSeriesFiltered(n)) {
          ...
          i.hasItemVisual() &&
            i.each(function (t) {
              ...
              n && (i.ensureUniqueItemVisual(t, 'style').decal = sg(n, e));
            });
          var r = i.getVisual('decal');
          if (r) i.getVisual('style').decal = sg(r, e);
        }
      });
    }),
    cy(dp),
      ...
      return (
        ...
        e.showSpinner &&
          ((r = new eu({
            ...
            .animateShape(!0)
            .when(1e3, { endAngle: (3 * Zf) / 2 })
            .start('circularInOut'),
          r
            .animateShape(!0)
            .when(1e3, { startAngle: (3 * Zf) / 2 })
            .delay(300)
            .start('circularInOut'),
          n.add(r)),
        (n.resize = function () {
    ...
    yy({ type: gs, event: gs, update: gs }, mt),
    yy({ type: ys, event: ys, update: ys }, mt),
    yy({ type: vs, event: vs, update: vs }, mt),
    yy({ type: ms, event: ms, update: ms }, mt),
    yy({ type: _s, event: _s, update: _s }, mt),
    hy('light', cd),
    hy('dark', yd);
  var Ty = [],
    Cy = {
      registerPreprocessor: cy,
      registerProcessor: py,
      registerPostInit: fy,
      registerPostUpdate: dy,
      registerUpdateLifecycle: gy,
      registerAction: yy,
      registerCoordinateSystem: vy,
      registerLayout: my,
      registerVisual: _y,
      ...
      registerSubTypeDefaulter: function (t, e) {
        ac.registerSubTypeDefaulter(t, e);
      },
  ...
  function Dy(t) {
    H(t)
      ...
      : A(Ty, t) >= 0 ||
        (Ty.push(t), W(t) && (t = { install: t }), t.install(Cy));
  }
  function Iy(t) {
  ...
  var Ay = (function () {
      function t(t, e, n, i, r, o) {
        (this._old = t),
          (this._new = e),
          (this._oldKeyGetter = n || ky),
          (this._newKeyGetter = i || ky),
          (this.context = r),
        ...
        (t.prototype._performRestAdd = function (t, e) {
          for (var n = 0; n < t.length; n++) {
            var i = t[n],
              r = e[i],
              o = Iy(r);
            if (o > 1) for (var a = 0; a < o; a++) this._add && this._add(r[a]);
  ...
  var Oy = function (t) {
      (this.otherDims = {}), null != t && D(this, t);
    },
    Ry = Zr(),
    Ny = { float: 'f', int: 'i', ordinal: 'o', number: 'n', time: 't' },
    Ey = (function () {
      function t(t) {
      ...
      return (
        ...
        (t.prototype._updateDimOmitted = function (t) {
          (this._dimOmitted = t),
            t && (this._dimNameMap || (this._dimNameMap = Fy(this.source)));
        }),
  ...
  function Fy(t) {
    var e = Ry(t);
    return e.dimNameMap || (e.dimNameMap = By(t.dimensionsDefine));
  }
  function Vy(t) {
    return t > 30;
  }
  var Hy,
    ...
    Zy = Y,
    jy = N,
    Ky = 'undefined' == typeof Int32Array ? Array : Int32Array,
    $y = [
      'hasItemOption',
      '_nameList',
      '_idList',
    ...
    Jy = (function () {
      function t(t, e) {
        ...
        for (
          ...
          var h = n[u],
            c = G(h) ? new Oy({ name: h }) : h instanceof Oy ? h : new Oy(h),
            p = c.name;
          (c.type = c.type || 'float'),
      ...
      return (
        ...
        (t.prototype.initData = function (t, e, n) {
          var i,
            r = this;
          if ((t instanceof cf && (i = t), !i)) {
            var o = this.dimensions,
              a = bp(t) || O(t) ? new kp(t, o.length) : t;
            i = new cf();
            var s = jy(o, function (t) {
          ...
          (this._store = i),
            ...
            (this._dimSummary = (function (t, e) {
                ...
                if (u) {
                  ...
                  (Py(i, u)[h] = e),
                    l.isExtraCoord ||
                      ...
                      (Py(s, u)[h] = t.getDimensionIndex(l.name))),
                    l.defaultTooltip && a.push(e);
                }
                hc.each(function (t, e) {
                  var n = Py(i, e),
                    r = l.otherDims[e];
              ...
              r.each(function (t, e) {
                ...
                (n.dataDimsOnCoord = l),
                (n.dataDimIndicesOnCoord = N(l, function (e) {
        ...
        (t.prototype.appendValues = function (t, e) {
          ...
          if ((this._updateOrdinalMeta(), e))
            for (var a = i; a < r; a++) {
              var s = a - i;
              (this._nameList[a] = e[s]), o && qy(this, a);
            }
        }),
        ...
        (t.prototype._doInit = function (t, e) {
          if (!(t >= e)) {
            ...
            var i = this._nameList,
              r = this._idList;
            if (n.getSource().sourceFormat === cc && !n.pure)
              for (var o = [], a = t; a < e; a++) {
                var s = n.getItem(a, o);
                if (
                  (!this.hasItemOption && Vr(s) && (this.hasItemOption = !0), s)
                ) {
                  var l = s.name;
                  null == i[a] && null != l && (i[a] = Ur(l, null));
                  var u = s.id;
                  null == r[a] && null != u && (r[a] = Ur(u, null));
                }
              }
            if (this._shouldMakeIdFromName())
              for (a = t; a < e; a++) qy(this, a);
            Hy(this);
          }
        }),
        ...
        (t.prototype.setCalculationInfo = function (t, e) {
          Zy(t) ? D(this._calculationInfo, t) : (this._calculationInfo[t] = e);
        }),
        ...
        (t.prototype.getId = function (t) {
          return Wy(this, this.getRawIndex(t));
        }),
        (t.prototype.count = function () {
        ...
        (t.prototype.each = function (t, e, n) {
          W(t) && ((n = e), (e = t), (t = []));
          var i = n || this,
            r = jy(Uy(t), this._getStoreDimIndex, this);
          this._store.each(r, i ? F(e, i) : e);
        }),
        (t.prototype.filterSelf = function (t, e, n) {
          W(t) && ((n = e), (e = t), (t = []));
          var i = n || this,
            r = jy(Uy(t), this._getStoreDimIndex, this);
          return (this._store = this._store.filter(r, i ? F(e, i) : e)), this;
        }),
        (t.prototype.selectRange = function (t) {
          var e = this,
            n = {};
        ...
        (t.prototype.map = function (t, e, n, i) {
          var r = n || i || this,
            o = jy(Uy(t), this._getStoreDimIndex, this),
            a = Yy(this);
          return (a._store = this._store.map(o, r ? F(e, r) : e)), a;
        }),
        (t.prototype.modify = function (t, e, n, i) {
          var r = n || i || this;
          var o = jy(Uy(t), this._getStoreDimIndex, this);
          this._store.modify(o, r ? F(e, r) : e);
        }),
        (t.prototype.downSample = function (t, e, n, i) {
          var r = Yy(this);
          return (
        ...
        (t.prototype.setVisual = function (t, e) {
          (this._visual = this._visual || {}),
            Zy(t) ? D(this._visual, t) : (this._visual[t] = e);
        }),
        ...
        (t.prototype.setItemVisual = function (t, e, n) {
          ...
          (this._itemVisuals[t] = i), Zy(e) ? D(i, e) : (i[e] = n);
        }),
        (t.prototype.clearAllVisual = function () {
          (this._visual = {}), (this._itemVisuals = []);
        }),
        (t.prototype.setLayout = function (t, e) {
          Zy(t) ? D(this._layout, t) : (this._layout[t] = e);
        }),
        ...
        (t.prototype.setItemLayout = function (t, e, n) {
          this._itemLayouts[t] = n ? D(this._itemLayouts[t] || {}, e) : e;
        }),
        ...
        (t.prototype.setItemGraphicEl = function (t, e) {
          ...
          })(this.hostModel && this.hostModel.seriesIndex, this.dataType, t, e),
          ...
          return (
            e ||
              (e = new t(
                this._schema
                  ? this._schema
                  : jy(this.dimensions, this._getDimInfo, this),
                this.hostModel
              )),
            Xy(e, this),
        ...
        (t.prototype.wrapMethod = function (t, e) {
          ...
          W(n) &&
            ...
            (this[t] = function () {
              ...
              return e.apply(this, [t].concat(it(arguments)));
            }));
        }),
        (t.internalField =
          ((Hy = function (t) {
            ...
            R(e, function (n, i) {
              var r = t._dimInfos[i],
                ...
                a = t._store;
              if (o) {
                n = e[i] = new Ky(o.categories.length);
          ...
          (Gy = function (t, e, n) {
            return Ur(t._getCategory(e, n), null);
          }),
          (Wy = function (t, e) {
            var n = t._idList[e];
            return (
              null == n && null != t._idDimIdx && (n = Gy(t, t._idDimIdx, e)),
              null == n && (n = 'e\0\0' + e),
              n
            );
          }),
          ...
          (Yy = function (e) {
            var n = new t(
              e._schema ? e._schema : jy(e.dimensions, e._getDimInfo, e),
              e.hostModel
            );
            return Xy(n, e), n;
          }),
          (Xy = function (t, e) {
            R($y.concat(e.__wrappedMethods || []), function (n) {
              e.hasOwnProperty(n) && (t[n] = e[n]);
            }),
              ...
              (t._calculationInfo = D({}, e._calculationInfo));
          }),
          void (qy = function (t, e) {
            var n = t._nameList,
              i = t._idList,
              r = t._nameDimIdx,
              o = t._idDimIdx,
              ...
              s = i[e];
            if (
              (null == a && null != r && (n[e] = a = Gy(t, r, e)),
              null == s && null != o && (i[e] = s = Gy(t, o, e)),
              null == s && null != a)
            ) {
  ...
  function tv(t, e) {
    ...
    var n = (e = e || {}).coordDimensions || [],
      ...
      a = (function (t, e, n, i) {
        ...
        return (
          R(e, function (t) {
            var e;
            Y(t) && (e = t.dimsDef) && (r = Math.max(r, e.length));
          }),
          r
        );
      })(t, n, i, e.dimensionsCount),
      s = e.canOmitUnusedDimensions && Vy(a),
      l = i === t.dimensionsDefine,
      u = l ? Fy(t) : By(i),
      h = e.encodeDefine;
    !h && e.encodeDefaulter && (h = e.encodeDefaulter(t, a));
    for (var c = ft(h), p = new af(a), f = 0; f < p.length; f++) p[f] = -1;
    function d(t) {
      var e = p[t];
      if (e < 0) {
        var n = i[t],
    ...
    if (!s) for (f = 0; f < a; f++) d(f);
    c.each(function (t, e) {
      var n = Er(t).slice();
      if (1 === n.length && !G(n[0]) && n[0] < 0) c.set(e, !1);
      else {
        var i = c.set(e, []);
        R(n, function (t, n) {
          var r = G(t) ? u.get(t) : t;
          null != r && r < a && ((i[n] = r), y(d(r), e, n));
        });
      }
    });
    var g = 0;
  ...
  var iv = {
    cartesian2d: function (t, e, n, i) {
      var r = t.getReferringComponents('xAxis', Qr).models[0],
        o = t.getReferringComponents('yAxis', Qr).models[0];
      (e.coordSysDims = ['x', 'y']),
        n.set('x', r),
        n.set('y', o),
        rv(r) && (i.set('x', r), (e.firstCategoryDimIndex = 0)),
        rv(o) &&
          (i.set('y', o),
          null == e.firstCategoryDimIndex && (e.firstCategoryDimIndex = 1));
    },
    singleAxis: function (t, e, n, i) {
      var r = t.getReferringComponents('singleAxis', Qr).models[0];
      (e.coordSysDims = ['single']),
        n.set('single', r),
        rv(r) && (i.set('single', r), (e.firstCategoryDimIndex = 0));
    },
    polar: function (t, e, n, i) {
      var r = t.getReferringComponents('polar', Qr).models[0],
        o = r.findAxisModel('radiusAxis'),
        a = r.findAxisModel('angleAxis');
      (e.coordSysDims = ['radius', 'angle']),
        n.set('radius', o),
        n.set('angle', a),
        rv(o) && (i.set('radius', o), (e.firstCategoryDimIndex = 0)),
        rv(a) &&
          (i.set('angle', a),
          null == e.firstCategoryDimIndex && (e.firstCategoryDimIndex = 1));
    },
    ...
    parallel: function (t, e, n, i) {
      ...
      R(o.parallelAxisIndex, function (t, o) {
  ...
  function lv(t, e, n) {
    ...
    var i,
      ...
      o = !1;
    t ? ((o = !0), (i = Mp(t))) : (o = (i = r.getSource()).sourceFormat === cc);
    var a = (function (t) {
      ...
      f = ov(e, { schema: h, store: p }),
      d = new Jy(h, e);
    d.setCalculationInfo(f);
    var g =
      null != c &&
      (function (t) {
        if (t.sourceFormat === cc) {
          return !H(
            Fr(
              (function (t) {
                var e = 0;
        ...
        : null;
    return (d.hasItemOption = !1), d.initData(o ? i : p, null, g), d;
  }
  var uv = (function () {
    function t(t) {
  ...
  function pv(t) {
    return Y(t) && null != t.value ? t.value : t + '';
  }
  function fv(t) {
  ...
  function dv(t, e, n, i) {
    var r = {},
      o = t[1] - t[0],
      a = (r.interval = Dr(o / e, !0));
    null != n && a < n && (a = r.interval = n),
      null != i && a > i && (a = r.interval = i);
    var s = (r.intervalPrecision = yv(a));
    return (
      (function (t, e) {
        ...
        (r.niceTickExtent = [
          gr(Math.ceil(t[0] / a) * a, s),
          gr(Math.floor(t[1] / a) * a, s),
        ]),
        t
      ),
      r
  ...
  var wv = (function (t) {
    ...
    return (
      ...
      (e.prototype.contain = function (t) {
        return (
          mv((t = this.parse(t)), this._extent) &&
          null != this._ordinalMeta.categories[t]
        );
      }),
      (e.prototype.normalize = function (t) {
        return _v((t = this._getTickNumber(this.parse(t))), this._extent);
      }),
      (e.prototype.scale = function (t) {
        return (
          (t = Math.round(xv(t, this._extent))), this.getRawOrdinalNumber(t)
        );
      }),
    ...
    Sv = (function (t) {
      ...
      return (
        ...
        (e.prototype.getTicks = function (t) {
          ...
          if (!e) return o;
          n[0] < i[0] &&
            (t ? o.push({ value: bv(i[0] - e, r) }) : o.push({ value: n[0] }));
          for (
            var a = i[0];
            a <= i[1] &&
            (o.push({ value: a }),
          ...
          return (
            n[1] > s &&
              (t ? o.push({ value: bv(s + e, r) }) : o.push({ value: n[1] })),
            o
          );
        }),
        (e.prototype.getMinorTicks = function (t) {
        ...
        (e.prototype.calcNiceExtent = function (t) {
          ...
          t.fixMin || (e[0] = bv(Math.floor(e[0] / r) * r)),
            t.fixMax || (e[1] = bv(Math.ceil(e[1] / r) * r));
        }),
  ...
  uv.registerClass(Sv);
  var Mv = 'undefined' != typeof Float32Array,
    Tv = Mv ? Float32Array : Array;
  function Cv(t) {
    return H(t) ? (Mv ? new Float32Array(t) : t) : new Tv(t);
  }
  function Dv(t) {
  ...
  function Av(t) {
    ...
    return (
      R(t, function (t) {
        ...
        var p = dr(t.get('barWidth'), i),
          f = dr(t.get('barMaxWidth'), i),
          d = dr(t.get('barMinWidth') || (Ov(t) ? 0.5 : 1), i),
          g = t.get('barGap'),
      ...
      return (
        ...
        (e.prototype.getFormattedLabel = function (t, e, n) {
          ...
          return (function (t, e, n, i, r) {
            var o = null;
            if (G(n)) o = n;
            else if (W(n)) o = n(t.value, e, { level: t.level });
            else {
              var a = D({}, xh);
              if (t.level > 0)
                for (var s = 0; s < Sh.length; ++s)
                  a[Sh[s]] = '{primary|' + a[Sh[s]] + '}';
              var l = n ? (!1 === n.inherit ? n : I(n, a)) : a,
                u = kh(t.value, r);
              if (l[u]) o = l[u];
              else if (l.inherit) {
                for (s = Mh.indexOf(u) - 1; s >= 0; --s)
                  if (l[u]) {
                    o = l[u];
                    break;
                  }
            ...
            return Ih(new Date(t.value), o, r, i);
          ...
          var i = this.getSetting('useUTC'),
            r = (function (t, e, n, i) {
                ...
                if (
                  ...
                  for (var u = 0; u < r.length - 1; u++) {
                    ...
                    if (h !== c) {
                      ...
                      switch (t) {
                        case 'year':
                          (p = Math.max(1, Math.round(e / mh / 365))),
                            (f = Lh(n)),
                            (d = Bh(n));
                          break;
                        case 'half-year':
                        case 'quarter':
                        case 'month':
                          (p = zv(e)), (f = Ph(n)), (d = Fh(n));
                          break;
                        case 'week':
                        case 'half-week':
                        case 'day':
                          (p = Ev(e)), (f = Oh(n)), (d = Vh(n)), (g = !0);
                          break;
                        case 'half-day':
                        case 'quarter-day':
                        case 'hour':
                          (p = Bv(e)), (f = Rh(n)), (d = Hh(n));
                          break;
                        case 'minute':
                          (p = Fv(e, !0)), (f = Nh(n)), (d = Wh(n));
                          break;
                        case 'second':
                          (p = Fv(e, !1)), (f = Eh(n)), (d = Gh(n));
                          break;
                        case 'millisecond':
                          (p = Vv(e)), (f = zh(n)), (d = Uh(n));
                      }
                      s(p, h, c, f, d, g, a),
                        'year' === t &&
                          o.length > 1 &&
              ...
              for (f = 0; f < x.length; ++f)
                (0 !== f && x[f].value === x[f - 1].value) || M.push(x[f]);
              return M;
          ...
          var o = Nv.length,
            a = Math.min(
              (function (t, e, n, i) {
                ...
                return n;
              })(Nv, this._approxInterval, 0, o),
              o - 1
            );
          (this._interval = Nv[a][1]),
            (this._minLevelUnit = Nv[Math.max(a - 1, 0)][0]);
        }),
        (e.prototype.parse = function (t) {
          return X(t) ? t : +Mr(t);
        }),
        (e.prototype.contain = function (t) {
          return mv(this.parse(t), this._extent);
        }),
        (e.prototype.normalize = function (t) {
          return _v(this.parse(t), this._extent);
        }),
        (e.prototype.scale = function (t) {
          return xv(t, this._extent);
        }),
  ...
  function Ev(t, e) {
    return (t /= mh) > 16 ? 16 : t > 7.5 ? 7 : t > 3.5 ? 4 : t > 1.5 ? 2 : 1;
  }
  function zv(t) {
    return (t /= 2592e6) > 6 ? 6 : t > 3 ? 3 : t > 2 ? 2 : 1;
  }
  function Bv(t) {
    return (t /= vh) > 12 ? 12 : t > 6 ? 6 : t > 3.5 ? 4 : t > 2 ? 2 : 1;
  }
  function Fv(t, e) {
    return (t /= e ? yh : gh) > 30
      ? 30
      ...
      return (
        ...
        (e.prototype.getTicks = function (t) {
          var e = this._originalScale,
            ...
            i = e.getExtent();
          return N(
            Gv.getTicks.call(this, t),
            function (t) {
              var e = t.value,
                r = gr(qv(this.base, e));
              return (
                (r = e === n[0] && this._fixMin ? $v(r, i[0]) : r),
                { value: (r = e === n[1] && this._fixMax ? $v(r, i[1]) : r) }
              );
            },
            this
          );
        ...
        (e.prototype.setExtent = function (t, e) {
          ...
          (t = Zv(Math.max(0, t)) / n),
            (e = Zv(Math.max(0, e)) / n),
            Gv.setExtent.call(this, t, e);
        }),
        (e.prototype.getExtent = function () {
          var t = this.base,
            e = Wv.getExtent.call(this);
          (e[0] = qv(t, e[0])), (e[1] = qv(t, e[1]));
          var n = this._originalScale.getExtent();
          return (
            this._fixMin && (e[0] = $v(e[0], n[0])),
            this._fixMax && (e[1] = $v(e[1], n[1])),
            e
          );
        }),
        (e.prototype.unionExtent = function (t) {
        ...
        (e.prototype.calcNiceTicks = function (t) {
          ...
          if (!(n === 1 / 0 || n <= 0)) {
            ...
            for (
              ...
              i *= 10;
            var r = [gr(Yv(e[0] / i) * i), gr(Xv(e[1] / i) * i)];
            (this._interval = i), (this._niceExtent = r);
          }
        }),
        (e.prototype.calcNiceExtent = function (t) {
          Gv.calcNiceExtent.call(this, t),
        ...
        (e.prototype.contain = function (t) {
          return mv((t = Zv(t) / Zv(this.base)), this._extent);
        }),
        (e.prototype.normalize = function (t) {
          return _v((t = Zv(t) / Zv(this.base)), this._extent);
        }),
        (e.prototype.scale = function (t) {
          return (t = xv(t, this._extent)), qv(this.base, t);
        }),
        (e.type = 'log'),
        e
      );
  ...
  (Kv.getMinorTicks = Gv.getMinorTicks),
    (Kv.getLabel = Gv.getLabel),
    uv.registerClass(jv);
  var Qv = (function () {
      function t(t, e, n) {
      ...
      return (
        (t.prototype._prepareParams = function (t, e, n) {
          ...
          W(r)
            ? (this._modelMinNum = em(t, r({ min: n[0], max: n[1] })))
            : 'dataMin' !== r && (this._modelMinNum = em(t, r));
          var o = (this._modelMaxRaw = e.get('max', !0));
          if (
            (W(o)
              ? (this._modelMaxNum = em(t, o({ min: n[0], max: n[1] })))
              : 'dataMax' !== o && (this._modelMaxNum = em(t, o)),
            i)
          )
            ...
            'boolean' == typeof s[0] || 'boolean' == typeof s[1]
              ...
              : (this._boundaryGapInner = [qi(s[0], 1), qi(s[1], 1)]);
          }
        }),
    ...
    Jv = { min: '_determinedMin', max: '_determinedMax' },
    tm = { min: '_dataMin', max: '_dataMax' };
  function em(t, e) {
    return null == e ? null : J(e) ? NaN : t.parse(e);
  }
  function nm(t, e) {
    var n = t.type,
      i = (function (t, e, n) {
        var i = t.rawExtentInfo;
        return i || ((i = new Qv(t, e, n)), (t.rawExtentInfo = i), i);
  ...
  function im(t, e) {
    var n = e,
      ...
      r = i.extent,
      o = n.get('splitNumber');
    t instanceof jv && (t.base = n.get('logBase'));
    var a = t.type,
      s = n.get('interval'),
      l = 'interval' === a || 'time' === a;
    t.setExtent(r[0], r[1]),
  ...
  function lm(t) {
    return 'category' === t.type && 0 === sm(t.getLabelModel());
  }
  var um = (function () {
    function t() {}
    return (
  ...
  var cm = Object.freeze({
    ...
    createScale: function (t, e) {
      var n = e;
      e instanceof oh || (n = new oh(e));
      var i = rm(n);
      return i.setExtent(t[0], t[1]), im(i, n), i;
    },
    ...
    createTextStyle: function (t, e) {
      return Vu(t, null, null, 'normal' !== (e = e || {}).state);
    },
    createDimensions: function (t, e) {
      return tv(t, e).dimensions;
    },
    createSymbol: Nd,
    enableHoverEmphasis: js,
  });
  function pm(t, e) {
  ...
  function fm(t, e, n) {
    ...
    for (var o = 1; o < t.length; o++) {
      var a = t[o];
      (i += Ma(r[0], r[1], a[0], a[1], e, n)), (r = a);
    }
    var s = t[0];
    return (
      (pm(r[0], s[0]) && pm(r[1], s[1])) ||
        (i += Ma(r[0], r[1], s[0], s[1], e, n)),
      0 !== i
    );
  }
  var dm = [];
  function gm(t, e) {
    for (var n = 0; n < t.length; n++) Et(t[n], t[n], e);
  }
  function ym(t, e, n, i) {
    for (var r = 0; r < t.length; r++) {
      var o = t[r];
      i && (o = i.project(o)),
        o && isFinite(o[0]) && isFinite(o[1]) && (zt(e, e, o), Bt(n, n, o));
    }
  }
  var vm = (function () {
      function t(t) {
      ...
      return (
        ...
        (e.prototype.getBoundingRect = function (t) {
          ...
          return (
            ...
            (isFinite(n[0]) &&
              ...
              isFinite(i[1])) ||
              (n[0] = n[1] = i[0] = i[1] = 0),
            (e = new Ce(n[0], n[1], i[0] - n[0], i[1] - n[1])),
            t || (this._rect = e),
            e
          );
        }),
        ...
        (e.prototype.transformTo = function (t, e, n, i) {
          ...
          for (
            ...
            'polygon' === h.type
              ? (gm(h.exterior, s),
                R(h.interiors, function (t) {
                  gm(t, s);
                }))
              : R(h.points, function (t) {
                  gm(t, s);
                });
          }
          (r = this._rect).copy(a),
    ...
    n(e, t),
      (e.prototype.calcCenter = function () {
        for (
          ...
          ce(i, r.getLocalTransform(), i), (r = r.parent);
        return ge(i, i), Et(n, n, i), n;
      });
  })(vm);
  function wm(t, e, n) {
    for (var i = 0; i < t.length; i++) t[i] = bm(t[i], e[i], n);
  }
  function bm(t, e, n) {
    ...
    return N(
      ...
      function (t) {
        ...
        switch (i.type) {
          case 'Polygon':
            var o = i.coordinates;
            r.push(new mm(o[0], o.slice(1)));
            break;
          case 'MultiPolygon':
            R(i.coordinates, function (t) {
              t[0] && r.push(new mm(t[0], t.slice(1)));
            });
            break;
          case 'LineString':
            r.push(new _m([i.coordinates]));
            break;
          case 'MultiLineString':
            r.push(new _m(i.coordinates));
        }
        var a = new xm(n[e || 'name'], r, n.cp);
  ...
  var Mm = Object.freeze({
      ...
      getPercentWithPrecision: function (t, e, n) {
        return (t[e] && _r(t, n)[e]) || 0;
      },
      MAX_SAFE_INTEGER: 9007199254740991,
      remRadian: wr,
      isRadianAroundZero: br,
      parseDate: Mr,
      quantity: Tr,
      quantityExponent: Cr,
      nice: Dr,
    ...
    Tm = Object.freeze({ __proto__: null, parse: Mr, format: Ih }),
    Cm = Object.freeze({
      __proto__: null,
      ...
      createIcon: function (t, e, n) {
        var i = D({ rectHover: !0 }, e),
          r = (i.style = { strokeNoScale: !0 });
        if (((n = n || { x: -1, y: -1, width: 2, height: 2 }), t))
          return 0 === t.indexOf('image://')
            ? ((r.image = t.slice(8)), I(r, n), new Ha(i))
            : Du(t.replace('path://', ''), i, n, 'center');
      },
      updateProps: gu,
      initProps: yu,
      getTransform: function (t, e) {
        for (var n = ue([]); t && t !== e; )
          ce(n, t.getLocalTransform(), n), (t = t.parent);
        return n;
      },
      clipPointsByRect: function (t, e) {
        return N(t, function (t) {
          var n = t[0];
          (n = bu(n, e.x)), (n = Su(n, e.x + e.width));
          var i = t[1];
          return (i = bu(i, e.y)), [n, (i = Su(i, e.y + e.height))];
        });
      },
      clipRectByRect: function (t, e) {
        var n = bu(t.x, e.x),
          i = Su(t.x + t.width, e.x + e.width),
          r = bu(t.y, e.y),
          o = Su(t.y + t.height, e.y + e.height);
        if (i >= n && o >= r)
          return { x: n, y: r, width: i - n, height: o - r };
      },
      registerShape: Cu,
      getShapeClass: function (t) {
        if (Mu.hasOwnProperty(t)) return Mu[t];
      },
      Group: or,
      Image: Ha,
      Text: Ka,
    ...
    Dm = Object.freeze({
      ...
      normalizeCssArray: Yh,
      encodeHTML: $t,
      formatTpl: jh,
      getTooltipMarker: function (t, e) {
        var n = G(t) ? { color: t, extraCssText: e } : t || {},
          i = n.color,
          r = n.type;
        e = n.extraCssText;
    ...
    return 'category' === t.type
      ? (function (t, e) {
          ...
          if (W(o)) n = zm(t, o, !0);
            ...
            var s = Pm(t, t.getLabelModel());
            (i = s.labelCategoryInterval),
              (n = N(s.labels, function (t) {
                return t.tickValue;
              }));
          } else n = Em(t, (i = o), !0);
          return Nm(r, o, { ticks: n, tickCategoryInterval: i });
        })(t, e)
      : {
        ...
        : ((i =
            'auto' === o
              ? (function (t) {
                  ...
                  return null != e
                    ? e
                    : (km(t).autoInterval = t.calculateCategoryInterval());
                })(t)
              : o),
          (n = Em(t, i))),
      Nm(r, o, { labels: n, labelCategoryInterval: i }))
    );
  }
  function Om(t, e) {
    ...
    Fm = (function () {
      ...
      return (
        ...
        (t.prototype.coordToData = function (t, e) {
          var n = this._extent,
            i = this.scale;
          this.onBand && 'ordinal' === i.type && Vm((n = n.slice()), i.count());
          var r = fr(t, n, Bm, e);
        ...
        (t.prototype.getTicksCoords = function (t) {
          ...
          return (
            (function (t, e, n, i) {
              ...
              function c(t, e) {
                return (t = gr(t)), (e = gr(e)), h ? t > e : t < e;
              }
        ...
        (t.prototype.calculateCategoryInterval = function () {
          return (function (t) {
            ...
            for (
              ...
              var d,
                g,
                y = Gi(n({ value: l }), e.font, 'center', 'top');
              (d = 1.3 * y.width),
                (g = 1.3 * y.height),
                (p = Math.max(p, d, 7)),
                (f = Math.max(f, g, 7));
  ...
  function jm(t, e) {
    if (e <= 180 && e > 0) {
      ...
      var n = Xm.len(),
        i = Ym.len();
      if (!(n < 0.001 || i < 0.001)) {
        Xm.scale(1 / n), Ym.scale(1 / i);
        var r = Xm.dot(Ym);
        if (Math.cos(e) < r) {
          var o = Hm(Gm.x, Gm.y, Um.x, Um.y, Wm.x, Wm.y, qm, !1);
          Zm.fromArray(qm), Zm.scaleAndAdd(Ym, o / Math.tan(Math.PI - e));
          var a =
            Um.x !== Gm.x
              ? (Zm.x - Gm.x) / (Um.x - Gm.x)
              : (Zm.y - Gm.y) / (Um.y - Gm.y);
          if (isNaN(a)) return;
          a < 0 ? ve.copy(Zm, Gm) : a > 1 && ve.copy(Zm, Um), Zm.toArray(t[1]);
        }
      }
    }
  }
  function Km(t, e, n) {
    if (n <= 180 && n > 0) {
      ...
      var i = Xm.len(),
        r = Ym.len();
      if (!(i < 0.001 || r < 0.001))
        if ((Xm.scale(1 / i), Ym.scale(1 / r), Xm.dot(e) < Math.cos(n))) {
          var o = Hm(Gm.x, Gm.y, Um.x, Um.y, Wm.x, Wm.y, qm, !1);
          Zm.fromArray(qm);
          var a = Math.PI / 2,
            s = a + Math.acos(Ym.dot(e)) - n;
          if (s >= a) ve.copy(Zm, Um);
          else {
            Zm.scaleAndAdd(Ym, o / Math.tan(Math.PI / 2 - s));
            var l =
              Um.x !== Gm.x
                ? (Zm.x - Gm.x) / (Um.x - Gm.x)
                : (Zm.y - Gm.y) / (Um.y - Gm.y);
            if (isNaN(l)) return;
            l < 0 ? ve.copy(Zm, Gm) : l > 1 && ve.copy(Zm, Um);
          }
          Zm.toArray(t[1]);
        }
    }
    ...
    return (function (t, e, n, i, r, o) {
      ...
      if (!(a < 2)) {
        ...
        for (var s, l = 0, u = !1, h = 0, c = 0; c < a; c++) {
          var p = t[c],
            f = p.rect;
          (s = f[e] - l) < 0 && ((f[e] -= s), (p.label[e] -= s), (u = !0)),
            (h += Math.max(-s, 0)),
            (l = f[e] + f[n]);
        }
        h > 0 && o && x(-h / a, 0, a);
      ...
      function m() {
        (d = y.rect[e] - i), (g = r - v.rect[e] - v.rect[n]);
      }
      function _(t, e, n) {
        if (t < 0) {
          var i = Math.min(e, -t);
      ...
      function w(i, r) {
        ...
        if (s) {
          ...
          if (i > 0) for (l = 0; l < a - 1; l++) x(o[l] * c, 0, l + 1);
          else for (l = a - 1; l > 0; l--) x(-o[l - 1] * c, l, a);
        }
      }
      function b(t) {
        var e = t < 0 ? -1 : 1;
        ...
        for (var n = Math.ceil(t / (a - 1)), i = 0; i < a - 1; i++)
          if ((e > 0 ? x(n, 0, i + 1) : x(-n, a - i - 1, a), (t -= n) <= 0))
            return;
      }
    })(t, 'y', 'height', e, n, i);
  }
  ...
  var e_ = (function (t) {
      function e(e, n, i) {
        ...
        (o.motionBlur = !1),
          ...
          (i = i || Ii),
          'string' == typeof e ? (r = t_(e, n, i)) : Y(e) && (e = (r = e).id),
          (o.id = e),
          (o.dom = r);
        var a = r.style;
        return (
      ...
      return (
        ...
        (e.prototype.createBackBuffer = function () {
          var t = this.dpr;
          (this.domBack = t_('back-' + this.id, this.painter, t)),
        ...
        (e.prototype.createRepaintRects = function (t, e, n, i) {
          ...
          function u(t) {
            if (t.isFinite() && !t.isZero())
              if (0 === o.length) {
                (e = new Ce(0, 0, 0, 0)).copy(t), o.push(e);
              } else {
                for (
        ...
        (e.prototype.clear = function (t, e, n) {
          ...
          function p(t, n, i, o) {
            if ((r.clearRect(t, n, i, o), e && 'transparent' !== e)) {
              ...
              if (K(e))
                (a =
                  ((e.global || (e.__width === i && e.__height === o)) &&
                    e.__canvasGradient) ||
                  Bd(r, e, { x: 0, y: 0, width: i, height: o })),
  ...
  var o_ = (function () {
    function t(t, e, n, i) {
      ...
      (this._opts = n = D({}, n || {})),
        (this.dpr = n.devicePixelRatio || Ii),
        (this._singleCanvas = r),
        (this.root = t),
        t.style && (yt(t), (t.innerHTML = '')),
        (this.storage = e);
      ...
      if (r) {
        ...
        (this._width = Vd(t, 0, n)), (this._height = Vd(t, 1, n));
    ...
    return (
      ...
      (t.prototype._paintHoverList = function (t) {
        ...
        if ((n && n.clear(), e)) {
          for (
            ...
            var a = t[o];
            a.__inHover &&
              (n || (n = this._hoverlayer = this.getLayer(n_)),
              i || (i = n.ctx).save(),
              ig(i, a, r, o === e - 1));
          }
          i && i.restore();
          ...
          var h = !0,
            ...
            p = function (r) {
              var s,
                l = o[r],
                u = l.ctx,
                p = a && l.createRepaintRects(t, e, f._width, f._height),
                d = n ? l.__startIndex : l.__drawIndex,
                g = !n && l.incremental && Date.now,
                y = g && Date.now(),
                v = l.zlevel === f._zlevelList[0] ? f._backgroundColor : null;
              if (l.__startIndex === l.__endIndex) l.clear(!1, v, p);
              ...
              if (p)
                if (0 === p.length) s = l.__endIndex;
                  ...
                  for (var x = f.dpr, w = 0; w < p.length; ++w) {
                    var b = p[w];
                    u.save(),
                      u.beginPath(),
      ...
      (t.prototype._doPaintEl = function (t, e, n, i, r, o) {
        ...
        if (n) {
          ...
          (!i || (s && s.intersect(i))) &&
            (ig(a, t, r, o), t.setPrevPaintRect(s));
        } else ig(a, t, r, o);
      }),
      (t.prototype.getLayer = function (t, e) {
        this._singleCanvas && !this._needsManuallyCompositing && (t = i_);
        var n = this._layers[t];
        return (
          n ||
            (((n = new e_('zr_' + t, this, this.dpr)).zlevel = t),
            (n.__builtin__ = !0),
            this._layerConfig[t]
              ? C(n, this._layerConfig[t], !0)
              : this._layerConfig[t - r_] &&
                C(n, this._layerConfig[t - r_], !0),
            e && (n.virtual = e),
      ...
      (t.prototype._updateLayerStatus = function (t) {
        ...
        for (r = 0; r < t.length; r++) {
          ...
          i !== l && ((i = l), (a = 0)),
            ...
            u.__builtin__ ||
              M('ZLevel ' + l + ' has been used by unkown layer ' + u.id),
            u !== o &&
              ((u.__used = !0),
      ...
      (t.prototype.configLayer = function (t, e) {
        if (e) {
          ...
          for (var i = 0; i < this._zlevelList.length; i++) {
            ...
            if (r === t || r === t + r_) C(this._layers[r], n[t], !0);
          }
        }
      }),
      ...
      (t.prototype.resize = function (t, e) {
        if (this._domRoot.style) {
          ...
          (this._width = t), (this._height = e), this.getLayer(i_).resize(t, e);
        }
        return this;
      }),
  ...
  var a_ = (function (t) {
    ...
    return (
      ...
      (e.prototype.getInitialData = function (t) {
        return lv(null, this, { useEncodeDefaulter: !0 });
      }),
  ...
  function s_(t, e) {
    ...
    if (i) {
      for (var o = [], a = 0; a < n.length; a++) o.push(Vp(t, e, n[a]));
      return o.join(' ');
    }
  }
  function l_(t, e) {
  ...
  var u_ = (function (t) {
    ...
    return (
      ...
      (e.prototype.updateData = function (t, n, i, r) {
        ...
        if ((this._updateCommon(t, n, s, i, r), l)) {
          ...
          if (!u) {
            ...
            (p.scaleX = p.scaleY = 0), (p.style.opacity = 0), yu(p, c, a, n);
          }
        }
      ...
      (e.prototype._updateCommon = function (t, e, n, i, r) {
        ...
        if (
          ...
          (o = v.getModel('itemStyle').getItemStyle()),
            ...
            (f = y.getShallow('cursor'));
        }
        var m = t.getItemVisual(e, 'symbolRotate');
        d.attr('rotation', ((m || 0) * Math.PI) / 180 || 0);
        var _ = Ed(t.getItemVisual(e, 'symbolOffset'), n);
        _ && ((d.x = _[0]), (d.y = _[1])), f && d.attr('cursor', f);
        var x = t.getItemVisual(e, 'style'),
          w = x.fill;
        if (d instanceof Ha) {
          var b = d.style;
          d.useStyle(
          ...
          d.__isEmptyBrush ? d.useStyle(D({}, x)) : d.useStyle(x),
            (d.style.decal = null),
            d.setColor(w, r && r.symbolInnerColor),
            (d.style.strokeNoScale = !0);
        var S = t.getItemVisual(e, 'liftZ'),
          M = this._z2;
        null != S
          ? null == M && ((this._z2 = d.z2), (d.z2 += S))
          : null != M && ((d.z2 = M), (this._z2 = null));
        var T = r && r.useNameLabel;
        Bu(d, c, {
          labelFetcher: g,
          labelDataIndex: e,
          defaultText: function (e) {
            return T ? t.getName(e) : s_(t, e);
          },
          inheritColor: w,
          ...
          (this._sizeX = n[0] / 2),
          (this._sizeY = n[1] / 2);
        var C = d.ensureState('emphasis');
        (C.style = o),
          (d.ensureState('select').style = s),
          (d.ensureState('blur').style = a);
        var I =
          null == p || !0 === p
            ...
            : isFinite(p) && p > 0
              ? +p
              : 1;
        (C.scaleX = this._sizeX * I),
          (C.scaleY = this._sizeY * I),
      ...
      (e.prototype.fadeOut = function (t, e, n) {
        ...
        mu(i, { style: { opacity: 0 }, scaleX: 0, scaleY: 0 }, e, {
          dataIndex: r,
          cb: t,
          removeOpt: o,
        });
      ...
      (e.getSymbolSize = function (t, e) {
        return (
          H((n = t.getItemVisual(e, 'symbolSize'))) || (n = [+n, +n]),
          [n[0] || 0, n[1] || 0]
        );
        var n;
      }),
  ...
  function p_(t) {
    return null == t || Y(t) || (t = { isIgnore: t }), t || {};
  }
  function f_(t) {
    var e = t.hostModel,
    ...
    return {
      ...
      labelStatesModels: Fu(e),
      cursorStyle: e.get('cursor'),
    };
  }
  var d_ = (function () {
    function t(t) {
      (this.group = new or()), (this._SymbolCtor = t || u_);
    }
    return (
      (t.prototype.updateData = function (t, e) {
        (this._progressiveEls = null), (e = p_(e));
        var n = this.group,
          i = t.hostModel,
          r = this._data,
          o = this._SymbolCtor,
          ...
          t
            ...
            .update(function (h, c) {
              ...
              if (c_(t, f, h, e)) {
                ...
                if (!p || (g && g !== d))
                  n.remove(p), (p = new o(t, h, s, l)).setPosition(f);
                else {
      ...
      (t.prototype.eachRendered = function (t) {
        Nu(this._progressiveEls || this.group, t);
      }),
      (t.prototype.remove = function (t) {
        var e = this.group,
          n = this._data;
  ...
  function x_(t, e, n, i, r, o, a, s, l) {
    for (var u, h, c, p, f, d, g = n, y = 0; y < i; y++) {
      var v = e[2 * g],
        m = e[2 * g + 1];
      if (g >= r || g < 0) break;
      if (__(v, m)) {
      ...
      if (g === n) t[o > 0 ? 'moveTo' : 'lineTo'](v, m), (c = v), (p = m);
        ...
        if (a > 0) {
          ...
          if (l)
            for (; __(b, S) && M < i; )
              M++, (b = e[2 * (w += o)]), (S = e[2 * w + 1]);
          var T = 0.5,
            C = 0,
            D = 0,
            I = void 0,
            k = void 0;
          if (M >= i || __(b, S)) (f = v), (d = m);
          else {
            (C = b - u), (D = S - h);
            var A = v - u,
              L = b - v,
            ...
            if ('x' === s) {
              var E = C > 0 ? 1 : -1;
              (f = v - E * (R = Math.abs(A)) * a),
                (d = m),
                (I = v + E * (N = Math.abs(L)) * a),
                (k = m);
            } else if ('y' === s) {
              var z = D > 0 ? 1 : -1;
              (f = v),
                (d = m - z * (R = Math.abs(P)) * a),
                (I = v),
                (k = m + z * (N = Math.abs(O)) * a);
            } else
              (R = Math.sqrt(A * A + P * P)),
                (f =
                  v -
                  C * a * (1 - (T = (N = Math.sqrt(L * L + O * O)) / (N + R)))),
                (d = m - D * a * (1 - T)),
                (k = m + D * a * T),
                (I = v_((I = v + C * a * T), m_(b, v))),
                (k = v_(k, m_(S, m))),
                (I = m_(I, v_(b, v))),
                (d = m - ((D = (k = m_(k, v_(S, m))) - m) * R) / N),
                (f = v_((f = v - ((C = I - v) * R) / N), m_(u, v))),
                (d = v_(d, m_(h, m))),
                (I = v + ((C = v - (f = m_(f, v_(u, v)))) * N) / R),
                (k = m + ((D = m - (d = m_(d, v_(h, m)))) * N) / R);
          }
          t.bezierCurveTo(c, p, f, d, v, m), (c = I), (p = k);
        } else t.lineTo(v, m);
      }
      (u = v), (h = m), (g += o);
    }
      ...
      return (
        ...
        (e.prototype.buildPath = function (t, e) {
          var n = e.points,
            ...
            r = n.length / 2;
          if (e.connectNulls) {
            for (; r > 0 && __(n[2 * r - 2], n[2 * r - 1]); r--);
            for (; i < r && __(n[2 * i], n[2 * i + 1]); i++);
          }
          for (; i < r; )
            i +=
              x_(t, n, i, r, r, 1, e.smooth, e.smoothMonotone, e.connectNulls) +
              1;
        }),
            ...
            switch (r[l++]) {
              ...
              case o.C:
                (u = r[l++]),
                  ...
                  (f = r[l++]),
                  (d = r[l++]);
                var v = a ? un(n, u, c, f, t, s) : un(i, h, p, d, t, s);
                if (v > 0)
                  for (var m = 0; m < v; m++) {
                    var _ = s[m];
                    if (_ <= 1 && _ >= 0) {
                      y = a ? sn(i, h, p, d, _) : sn(n, u, c, f, _);
                      return a ? [t, y] : [y, t];
                    }
                  }
                (n = f), (i = d);
      ...
      return (
        ...
        (e.prototype.buildPath = function (t, e) {
          var n = e.points,
            ...
            a = e.smoothMonotone;
          if (e.connectNulls) {
            for (; o > 0 && __(n[2 * o - 2], n[2 * o - 1]); o--);
            for (; r < o && __(n[2 * r], n[2 * r + 1]); r++);
          }
          for (; r < o; ) {
            var s = x_(t, n, r, o, o, 1, e.smooth, a, e.connectNulls);
            x_(t, i, r + s - 1, s, o, -1, e.stackedOnSmooth, a, e.connectNulls),
              (r += s + 1),
              t.closePath();
          }
        }),
  ...
  function T_(t, e, n, i, r) {
    ...
    (a -= h / 2),
      ...
      (a = Math.floor(a)),
      (l = Math.round(l));
    var c = new qa({ shape: { x: a, y: s, width: l, height: u } });
    if (e) {
      var p = t.getBaseAxis(),
        f = p.isHorizontal(),
        d = p.inverse;
      ...
      var g = W(r)
        ...
        : null;
      yu(c, { shape: { width: l, height: u, x: a, y: s } }, n, null, i, g);
    }
    return c;
  }
  function C_(t, e, n) {
    ...
    e &&
      ('angle' === t.getBaseAxis().dim
        ...
        : (a.shape.r = r),
      yu(a, { shape: { endAngle: i.endAngle, r: o } }, n));
    return a;
  }
  function D_(t, e) {
    return t.type === e;
      ...
      if (o) {
        ...
        var p = (function (t, e) {
            ...
            function a(t, e, n) {
              ...
              return {
                coord: n,
                color: Hn((n - i) / (e.coord - i), [t.color, e.color]),
              };
            }
            for (var s = 0; s < o; s++) {
              var l = t[s],
        ...
        var v = new ru(0, 0, 0, 0, p, !0);
        return (v[r] = d), (v[r + '2'] = g), v;
      }
    }
  }
  function R_(t, e, n) {
        ...
        (!r ||
          !(function (t, e) {
            ...
            for (
              ...
              if (1.5 * u_.getSymbolSize(e, a)[t.isHorizontal() ? 1 : 0] > i)
                return !1;
            return !0;
          })(o, e))
      ) {
  ...
  function E_(t) {
    ...
    for (var e = 0; e < fs.length; e++)
      if (t.get([fs[e], 'endLabel', 'show'])) return !0;
    return !1;
  }
  function z_(t, e, n, i) {
    if (D_(e, 'cartesian2d')) {
    ...
    return (
      ...
      (e.prototype.render = function (t, e, n) {
        var i = this,
          ...
          x =
            ...
            (function (t, e, n) {
              ...
              for (var i = e.count(), r = Cv(2 * i), o = 0; o < i; o++) {
                var a = y_(n, t, e, o);
        ...
        r &&
          r.getArea &&
          t.get('clip', !0) &&
          (null != (T = r.getArea()).width
            ? ((T.x -= 0.1), (T.y -= 0.1), (T.width += 0.2), (T.height += 0.2))
            : T.r0 && ((T.r0 -= 0.5), (T.r += 0.5))),
          (this._clipShapeForSymbol = T);
        var D = O_(a, r, n) || a.getVisual('style')[a.getVisual('drawType')];
        if (f && c.type === r.type && C === this._step) {
          v && !d
            ? (d = this._newPolygon(u, x))
            : d && !v && (g.remove(d), (d = this._polygon = null)),
            h || this._initOrUpdateEndLabel(t, r, Kh(D));
          var k = g.getClipPath();
          if (k) yu(k, { shape: z_(this, r, !1, t).shape }, t);
          else g.setClipPath(z_(this, r, !0, t));
          w &&
            p.updateData(a, {
              isIgnore: S,
              clipShape: T,
            ...
            (I_(this._stackedOnPoints, x) && I_(this._points, u)) ||
              (y
                ? this._doUpdateAnimation(a, x, r, n, C, m, b)
                : (C && ((u = P_(u, r, C, b)), x && (x = P_(x, r, C, b))),
                  f.setShape({ points: u }),
                  d && d.setShape({ points: u, stackedOnPoints: x })));
        } else
          w &&
            p.updateData(a, {
              isIgnore: S,
            ...
            y && this._initSymbolLabelAnimation(a, r, T),
            C && ((u = P_(u, r, C, b)), x && (x = P_(x, r, C, b))),
            (f = this._newPolyline(u)),
            v
              ? (d = this._newPolygon(u, x))
              : d && (g.remove(d), (d = this._polygon = null)),
            h || this._initOrUpdateEndLabel(t, r, Kh(D)),
            g.setClipPath(z_(this, r, !0, t));
        var A = t.getModel('emphasis'),
          L = A.get('focus'),
          P = A.get('blurScope'),
          O = A.get('disabled');
        (f.useStyle(
          I(s.getLineStyle(), { fill: 'none', stroke: D, lineJoin: 'bevel' })
        ),
        Js(f, t, 'lineStyle'),
        f.style.lineWidth > 0 &&
          'bolder' === t.get(['emphasis', 'lineStyle', 'width'])) &&
          (f.getState('emphasis').style.lineWidth = +f.style.lineWidth + 1);
        (ls(f).seriesIndex = t.seriesIndex), Ks(f, L, P, O);
        var R = L_(t.get('smooth')),
          N = t.get('smoothMonotone');
        if (
          (f.setShape({ smooth: R, smoothMonotone: N, connectNulls: b }), d)
        ) {
          ...
          d.useStyle(
            ...
            Js(d, t, 'areaStyle'),
            (ls(d).seriesIndex = t.seriesIndex),
            Ks(d, L, P, O);
        }
        var B = function (t) {
        ...
        a.eachItemGraphicEl(function (t) {
          ...
          (this._polyline.onHoverStateChange = B),
          (this._data = a),
          (this._coordSys = r),
          ...
          t.get('triggerLineEvent') &&
            (this.packEventData(t, f), d && this.packEventData(t, d));
      }),
        ...
        if (
          ...
          if (!s) {
            ...
            var h = t.get('zlevel') || 0,
              c = t.get('z') || 0;
            ((s = new u_(r, o)).x = l), (s.y = u), s.setZ(h, c);
          ...
          s.highlight();
        } else Pf.prototype.highlight.call(this, t, e, n, i);
      }),
        ...
        if ((this._changePolyState('normal'), null != o && o >= 0)) {
          ...
          a &&
            (a.__temp
              ...
              : a.downplay());
        } else Pf.prototype.downplay.call(this, t, e, n, i);
      }),
      (e.prototype._changePolyState = function (t) {
        var e = this._polygon;
        Ps(this._polyline, t), e && Ps(e, t);
      }),
          ...
          if (s) {
            ...
            if (n)
              if (r) {
                ...
                var v = n;
                i
                  ? ((p = v.x), (f = v.x + v.width), (d = t.x))
                  : ((p = v.y + v.height), (f = v.y), (d = t.y));
              }
            var m = f === p ? 0 : (d - p) / (f - p);
            a && (m = 1 - m);
            var _ = W(u) ? u(o) : l * m + h,
      ...
      (e.prototype._initOrUpdateEndLabel = function (t, e, n) {
        ...
        if (E_(t)) {
          ...
          s ||
            (((s = this._endLabel = new Ka({ z2: 200 })).ignoreClip = !0),
          ...
          var l = (function (t) {
            for (
              ...
              i > 0 &&
              ((e = t[2 * i - 2]), (n = t[2 * i - 1]), isNaN(e) || isNaN(n));
              i--
            );
            return i - 1;
          })(a);
        ...
        if (s) {
          ...
          if (M >= 1) {
            if (M > 1 && !c) {
              ...
              (C = l.getPointOn(m, w)) && s.attr({ x: C[0] + _, y: C[1] + x });
              var D = h.getRawValue(S[0]),
                I = h.getRawValue(S[1]);
              r &&
                (T = (function (t, e, n, i, r) {
                  ...
                  if (X(i))
                    return gr(
                      (d = Rr(n || 0, i, r)),
                      o ? Math.max(yr(n || 0), yr(i)) : e
                    );
                  if (G(i)) return r < 1 ? n : i;
                  for (
                    var a = [],
                      s = n,
                      l = i,
                    ...
                    if (c && 'ordinal' === c.type)
                      ...
                      var p = s && s[h] ? s[h] : 0,
                        f = l[h],
                        d = Rr(p, f, r);
                      a[h] = gr(d, o ? Math.max(yr(p), yr(f)) : e);
                    }
                  }
                  return a;
                })(n, p, D, I, b.t));
      ...
      (e.prototype._doUpdateAnimation = function (t, e, n, i, r, o, a) {
        var s = this._polyline,
          ...
          h = (function (t, e, n, i, r, o, a, s) {
            for (
              ...
              switch (x.cmd) {
                case '=':
                  (b = 2 * x.idx), (S = 2 * x.idx1);
                  var M = v[b],
                    T = v[b + 1],
                    C = m[S],
                    D = m[S + 1];
                  (isNaN(M) || isNaN(T)) && ((M = C), (T = D)),
                    u.push(M, T),
                    h.push(C, D),
                    c.push(n[b], n[b + 1]),
                    p.push(i[S], i[S + 1]),
                ...
                case '+':
                  var I = x.idx,
                    ...
                    A = r.dataToPoint([e.get(k[0], I), e.get(k[1], I)]);
                  (S = 2 * I), u.push(A[0], A[1]), h.push(m[S], m[S + 1]);
                  var L = y_(y, r, e, I);
                  c.push(L[0], L[1]),
                    p.push(i[S], i[S + 1]),
                    g.push(e.getRawIndex(I));
                  break;
                case '-':
                  w = !1;
              }
              w && (f.push(x), d.push(d.length));
            }
            d.sort(function (t, e) {
              return g[t] - g[e];
            });
        ...
        if (
          (r &&
            ((c = P_(h.current, n, r, a)),
            (p = P_(h.stackedOnCurrent, n, r, a)),
            (f = P_(h.next, n, r, a)),
            (d = P_(h.stackedOnNext, n, r, a))),
          A_(c, f) > 3e3 || (l && A_(p, d) > 3e3))
        )
          return (
            s.stopAnimation(),
            s.setShape({ points: f }),
            void (
              l &&
              (l.stopAnimation(), l.setShape({ points: f, stackedOnPoints: d }))
            )
          );
      ...
      reset: function (t, e, n) {
        ...
        if (a > 10 && 'cartesian2d' === o.type && r) {
          ...
          if (isFinite(p) && p > 1) {
            ...
            var f = void 0;
            G(r) ? (f = F_[r]) : W(r) && (f = r),
              f && t.setData(i.downSample(i.mapDimension(l.dim), 1 / p, f, V_));
          }
        }
      },
    };
            ...
            R(i.getAxes(), function (t, n) {
              if ('category' === t.type && null != e) {
                ...
                for (
                  ...
                  1 === c && (h = f - i[0].tickValue);
                }
                null == u &&
                  (l ? l && (u = i[i.length - 1].coord) : (u = i[0].coord)),
                  (o[n] = t.toGlobalCoord(u));
              }
            });
          else {
            var a = this.getData(),
      ...
      return (
        ...
        (e.prototype.buildPath = function (t, e) {
          ...
          var f = Math.cos(l),
            ...
            y = Math.sin(u);
          p
            ? (t.moveTo(f * r + n, d * r + i),
              t.arc(f * s + n, d * s + i, a, -Math.PI + l, l, !h))
      ...
      return (
        ...
        (e.prototype._renderNormal = function (t, e, n, i) {
          ...
          var h = t.isAnimationEnabled() ? t : null,
            c = (function (t, e) {
              ...
              if (n && 'category' === i.type && 'cartesian2d' === e.type)
                return { baseAxis: i, otherAxis: e.getOtherAxis(i) };
            })(t, l);
          ...
          function b(t) {
            var e = ox[l.type](a, t),
              n = (function (t, e, n) {
                var i = 'polar' === t.type ? Fl : qa;
                return new i({ shape: px(e, n, t), silent: !0, z2: 0 });
              })(l, r, e);
            return (
          ...
          a.diff(s)
            .add(function (e) {
              var n = a.getItemModel(e),
                i = ox[l.type](a, e, n);
              if ((g && b(e), a.hasValue(e) && rx[l.type](i))) {
                var s = !1;
                p && (s = Q_[l.type](f, i));
                var y = J_[l.type](t, a, e, i, r, h, u.model, !1, d);
                c && (y.forceLabelAnimation = !0),
                  sx(y, a, e, n, i, t, r, 'polar' === l.type),
                  x
                    ? y.attr({ shape: i })
                    : c
                      ? tx(c, h, y, i, e, r, !1, !1)
            ...
            .update(function (e, n) {
              ...
              if (g) {
                ...
                0 === _.length
                  ? (M = b(n))
                  : ((M = _[n]).useStyle(y.getItemStyle()),
                    'cartesian2d' === l.type
                      ? M.setShape('r', v)
                      : M.setShape('cornerRadius', v),
                    (m[e] = M));
                var T = ox[l.type](a, e);
                gu(M, { shape: px(r, T, l) }, h, e);
              }
              var C = s.getItemGraphicEl(n);
              if (a.hasValue(e) && rx[l.type](S)) {
                var D = !1;
                if (
                  (p && (D = Q_[l.type](f, S)) && o.remove(C),
                  C
                    ? wu(C)
                    : (C = J_[l.type](t, a, e, S, r, h, u.model, !!C, d)),
                  c && (C.forceLabelAnimation = !0),
                  w)
                ) {
                  var I = C.getTextContent();
                  if (I) {
                    var k = Yu(I);
                    null != k.prevValue && (k.prevValue = k.value);
                  }
                } else sx(C, a, e, i, S, t, r, 'polar' === l.type);
                x
                  ? C.attr({ shape: S })
                  : c
                    ? tx(c, h, C, S, e, r, !0, w)
                    : gu(C, { shape: S }, t, e, null),
            ...
            .execute();
          var S = this._backgroundGroup || (this._backgroundGroup = new or());
          S.removeAll();
          for (var M = 0; M < m.length; ++M) S.add(m[M]);
          o.add(S), (this._backgroundEls = m), (this._data = a);
        }),
        (e.prototype._renderLarge = function (t, e, n) {
          this._clear(), hx(t, this.group), this._updateLargeClip(t);
        }),
        (e.prototype._incrementalRenderLarge = function (t, e) {
          this._removeBackground(), hx(e, this.group, this._progressiveEls, !0);
        }),
            ...
            if (this._isFirstFrame)
              ...
              var o = function (t) {
                var n = e.getItemGraphicEl(t),
                  i = n && n.shape;
                return (
                  (i && Math.abs(r.isHorizontal() ? i.height : i.width)) || 0
                );
              };
      ...
      polar: function (t, e, n, i, r, o, a, s, l) {
        ...
        if (
          ((h.calculateTextPosition =
            ((c = f),
            (p = ({ isRoundCap: u === X_ } || {}).isRoundCap),
            function (t, e, n) {
              var i = e.position;
              if (!i || i instanceof Array) return Zi(t, e, n);
              var r = c(i),
              ...
              switch (r) {
                ...
                case 'insideStartArc':
                  ...
                  break;
                case 'startAngle':
                  (x = s + f * m(d) + Y_(d, o + v, !1)),
                    (w = l + f * _(d) + q_(d, o + v, !1)),
                    (b = 'right'),
                    (S = 'middle');
                  break;
                ...
                case 'insideEndArc':
                  ...
                  break;
                case 'endAngle':
                  (x = s + f * m(g) + Y_(g, o + v, !0)),
                    (w = l + f * _(g) + q_(g, o + v, !0)),
                    (b = 'left'),
                    (S = 'middle');
                  break;
                case 'insideEndAngle':
  ...
  function tx(t, e, n, i, r, o, a, s) {
    var l, u;
    o
      ? ((u = { x: i.x, width: i.width }), (l = { y: i.y, height: i.height }))
      : ((u = { y: i.y, height: i.height }), (l = { x: i.x, width: i.width })),
      s || (a ? gu : yu)(n, { shape: l }, e, r, null),
      (a ? gu : yu)(n, { shape: u }, e ? t.baseAxis.model : null, r);
  }
  function ex(t, e) {
    for (var n = 0; n < e.length; n++) if (!isFinite(t[e[n]])) return !0;
    return !1;
  }
  var nx = ['x', 'y', 'width', 'height'],
    ix = ['cx', 'cy', 'r', 'startAngle', 'endAngle'],
    rx = {
  ...
  function sx(t, e, n, i, r, o, a, s) {
    ...
    if (s) {
      if (!o.get('roundCap')) {
        var u = t.shape;
        D(u, Z_(i.getModel('itemStyle'), u, !0)), t.setShape(u);
      }
    } else {
    ...
    if (s && d) {
      ...
      (t.textConfig.inside = 'middle' === g || null),
        (function (t, e, n, i) {
          if (X(i)) t.setTextConfig({ rotation: i });
          else if (H(e)) t.setTextConfig({ rotation: 0 });
          else {
            var r,
              o = t.shape,
        ...
        })(t, 'outside' === g ? p : g, ax(a), i.get(['label', 'rotate']));
    }
    !(function (t, e, n, i) {
      if (t) {
        var r = Yu(t);
    ...
    })(d, f, o.getRawValue(n), function (t) {
      return l_(e, t);
    });
    var y = i.getModel(['emphasis']);
    Ks(t, y.get('focus'), y.get('blurScope'), y.get('disabled')),
      Js(t, i),
      (function (t) {
        return (
          null != t.startAngle &&
  ...
  function hx(t, e, n, i) {
    ...
    (c.baseDimIdx = o),
      ...
      (ls(c).seriesIndex = t.seriesIndex),
      t.get('silent') || (c.on('mousedown', cx), c.on('mousemove', cx)),
      n && n.push(c);
  }
  var cx = Bf(
    function (t) {
  ...
  var fx = 2 * Math.PI,
    dx = Math.PI / 180;
  function gx(t, e) {
    return ec(t.getBoxLayoutParams(), {
      width: e.getWidth(),
      height: e.getHeight(),
    });
  }
  function yx(t, e) {
    ...
    var o,
      a,
      s = dr(n.width, e.getWidth()),
      l = dr(n.height, e.getHeight()),
      u = Math.min(s, l),
      h = dr(r[0], u / 2),
      c = dr(r[1], u / 2),
      p = t.coordinateSystem;
    if (p) {
      var f = p.dataToPoint(i);
      (o = f[0] || 0), (a = f[1] || 0);
    } else
      H(i) || (i = [i, i]), (o = dr(i[0], s) + n.x), (a = dr(i[1], l) + n.y);
  ...
  var mx = Math.PI / 180;
  function _x(t, e, n, i, r, o, a, s, l, u) {
    if (!(t.length < 2)) {
    ...
    function f(t) {
      for (var o = t.rB, a = o * o, s = 0; s < t.list.length; s++) {
        var l = t.list[s],
          ...
          f = e + (p + l.len2) * r,
          d = f - l.label.x;
        xx(l, l.targetTextWidth - d * r, !0), (l.label.x = f);
      }
    }
  }
  function xx(t, e, n) {
    if ((void 0 === n && (n = !1), null == t.labelStyleWidth)) {
      ...
      if (e < h || n) {
        ...
        if (u && u.match('break')) {
          ...
          var f = e - l,
            d = e < h ? f : n ? (f > t.unconstrainedWidth ? null : f) : null;
          i.setStyle('width', d);
        }
  ...
  function Sx(t) {
    var e,
      ...
      r = [],
      o = !1,
      a = (t.get('minShowLabelAngle') || 0) * mx,
    ...
    i.each(function (t) {
      var s = i.getItemGraphicEl(t),
        c = s.shape,
        p = s.getTextContent(),
        d = s.getTextGuideLine(),
        g = i.getItemModel(t),
        y = g.getModel('label'),
        v = y.get('position') || g.get(['emphasis', 'label', 'position']),
        m = y.get('distanceToLabelLine'),
        _ = y.get('alignTo'),
        x = dr(y.get('edgeDistance'), u),
        w = y.get('bleedMargin'),
        b = g.getModel('labelLine'),
        S = b.get('length');
      S = dr(S, u);
      var M = b.get('length2');
      if (((M = dr(M, u)), Math.abs(c.endAngle - c.startAngle) < a))
        return (
          R(p.states, f),
          (p.ignore = !0),
          void (d && (R(d.states, f), (d.ignore = !0)))
        );
      if (
        (function (t) {
        ...
        var T,
          ...
          D,
          I,
          k = (c.startAngle + c.endAngle) / 2,
          A = Math.cos(k),
          L = Math.sin(k);
        (e = c.cx), (n = c.cy);
        var P = 'inside' === v || 'inner' === v;
        if ('center' === v) (T = c.cx), (C = c.cy), (I = 'center');
        else {
          var O = (P ? ((c.r + c.r0) / 2) * A : c.r * A) + e,
            N = (P ? ((c.r + c.r0) / 2) * L : c.r * L) + n;
          if (((T = O + 3 * A), (C = N + 3 * L), !P)) {
            var E = O + A * (S + l - c.r),
              z = N + L * (S + l - c.r),
              B = E + (A < 0 ? -1 : 1) * M;
            (T =
        ...
        var F = Math.PI,
          ...
          H = y.get('rotate');
        if (X(H)) V = H * (F / 180);
        else if ('center' === v) V = 0;
        else if ('radial' === H || !0 === H) {
          V = A < 0 ? -k + F : -k;
        } else if ('tangential' === H && 'outside' !== v && 'outer' !== v) {
          var W = Math.atan2(A, L);
          W < 0 && (W = 2 * F + W), L > 0 && (W = F + W), (V = W - F);
        }
        if (
          ((o = !!V),
          (p.x = T),
          ...
          p.setStyle({ align: I });
          var G = p.states.select;
          G && ((G.x += p.x), (G.y += p.y));
        } else {
          var U = p.getBoundingRect().clone();
          U.applyTransform(p.getComputedTransform());
          var Y = (p.style.margin || 0) + 2.1;
          (U.y -= Y / 2),
            (U.height += Y),
            r.push({
              label: p,
          ...
          for (p = 0; p < t.length; p++)
            if (!bx((y = t[p])) && y.linePoints) {
              ...
              (g =
                'edge' === y.labelAlignTo
                  ? f.x < e
                    ? d[2][0] - y.labelDistance - a - y.edgeDistance
                    : a + r - y.edgeDistance - d[2][0] - y.labelDistance
                  : 'labelLine' === y.labelAlignTo
                    ...
                    : f.x < e
                      ? f.x - a - y.bleedMargin
                      : a + r - f.x - y.bleedMargin),
                (y.targetTextWidth = g),
                xx(y, g);
            }
          for (
            _x(u, e, n, i, 1, 0, o, 0, s, c),
              _x(l, e, n, i, -1, 0, o, 0, s, h),
              p = 0;
            p < t.length;
            p++
          ) {
            ...
            if (!bx((y = t[p])) && y.linePoints) {
              ...
              v
                ? f.x < e
                  ? (d[2][0] = a + y.edgeDistance + w + y.labelDistance)
                  : (d[2][0] = a + r - y.edgeDistance - w - y.labelDistance)
                : (f.x < e
                    ? (d[2][0] = f.x + y.labelDistance)
                    : (d[2][0] = f.x - y.labelDistance),
                  (d[1][0] = d[2][0] + b)),
                (d[1][1] = d[2][1] = f.y);
            }
    ...
    for (var d = 0; d < r.length; d++) {
      ...
      if (y) {
        y.setStyle({ align: g.textAlign }),
          m && (R(y.states, f), (y.ignore = !0));
        var _ = y.states.select;
        _ && ((_.x += y.x), (_.y += y.y));
      }
      if (v) {
        var x = g.linePoints;
        m || !x
          ? (R(v.states, f), (v.ignore = !0))
          : (jm(x, g.minTurnAngle),
            Km(x, g.surfaceNormal, g.maxSurfaceAngle),
            v.setShape({ points: x }),
            (y.__hostTarget.textGuideLineConfig = {
              anchor: new ve(x[0][0], x[0][1]),
            }));
      }
    }
  }
      ...
      return (
        ...
        (e.prototype.updateData = function (t, e, n, i) {
          var r = this,
            ...
            l = t.getItemLayout(e),
            u = D(Z_(a.getModel('itemStyle'), l, !0), l);
          if (isNaN(u.startAngle)) r.setShape(u);
            ...
            if (i) {
              ...
              o.ecModel.ssr
                ? (yu(r, { scaleX: 0, scaleY: 0 }, o, {
                  ...
                  (r.originY = u.cy))
                : 'scale' === h
                  ? ((r.shape.r = l.r0), yu(r, { shape: { r: l.r } }, o, e))
                  : null != n
                    ...
                    : ((r.shape.endAngle = l.startAngle),
                      gu(r, { shape: { endAngle: l.endAngle } }, o, e));
            } else wu(r), gu(r, { shape: u }, o, e);
            r.useStyle(t.getItemVisual(e, 'style')), Js(r, a);
            ...
            g && r.attr('cursor', g),
              ...
              (r.ensureState('emphasis').shape = D(
                { r: l.r + ((s.get('scale') && s.get('scaleSize')) || 0) },
                Z_(s.getModel('itemStyle'), l)
              )),
              D(r.ensureState('select'), {
                x: f,
                y: d,
                shape: Z_(a.getModel(['select', 'itemStyle']), l),
              }),
              D(r.ensureState('blur'), {
                shape: Z_(a.getModel(['blur', 'itemStyle']), l),
              });
            var y = r.getTextGuideLine(),
              v = r.getTextContent();
            y && D(y.ensureState('select'), { x: f, y: d }),
              D(v.ensureState('select'), { x: f, y: d }),
              Ks(this, s.get('focus'), s.get('blurScope'), s.get('disabled'));
          }
        }),
        (e.prototype._updateLabel = function (t, e, n) {
          ...
          if ('outside' !== h && 'outer' !== h) i.removeTextGuideLine();
            ...
            c || ((c = new Yl()), this.setTextGuideLine(c)),
              (function (t, e, n) {
                ...
                if (r) {
                  for (
                    ...
                    if (h) {
                      var p = h.get('show');
                      if (
                        (c ? s : et(r.states[u] && r.states[u].ignore, s)) ||
                        !et(p, a)
                      ) {
                        var f = c ? i : i && i.states[u];
                        f && (f.ignore = !0);
                        continue;
                      }
                      i ||
                        ...
                        c || (!s && a) || $m(i, !0, 'normal', e.normal),
                        t.stateProxy && (i.stateProxy = t.stateProxy)),
                        $m(i, !1, u, h);
                    }
                  }
                  if (i) {
                    I(i.style, n), (i.style.fill = null);
                    var d = o.get('showAbove');
                    ((t.textGuideLineConfig =
                      t.textGuideLineConfig || {}).showAbove = d || !1),
                      (i.buildPath = Qm);
                  }
                ...
                {
                  stroke: s,
                  opacity: nt(o.get(['lineStyle', 'opacity']), l, 1),
                }
              );
          }
        }),
      ...
      return (
        ...
        (e.prototype.init = function (e) {
          t.prototype.init.apply(this, arguments),
            (this.legendVisualProvider = new Cx(
              F(this.getData, this),
        ...
        (e.prototype.getInitialData = function () {
          return (function (t, e, n) {
            e =
              (H(e) && { coordDimensions: e }) ||
              D({ encodeDefine: t.getEncode() }, e);
            var i = t.getSource(),
              r = tv(i, e).dimensions,
              o = new Jy(r, t);
        ...
        (e.prototype.getDataParams = function (e) {
          ...
          if (!r) {
            ...
            n.each(n.mapDimension('value'), function (t) {
              ...
              (r = i.seats = _r(o, n.hostModel.get('percentPrecision')));
          }
    ...
    Ax = (function (t) {
      ...
      return (
        ...
        (e.prototype.getCoordSysModel = function () {
          return this.getReferringComponents('grid', Qr).models[0];
        }),
  ...
  var Lx = {
    ...
    Nx = { value: 1, category: 1, time: 1, log: 1 };
  function Ex(t, e, i, r) {
    R(Nx, function (o, a) {
      var s = C(C({}, Rx[a], !0), r, !0),
        l = (function (t) {
          function i() {
            var n = (null !== t && t.apply(this, arguments)) || this;
          ...
          return (
            ...
            (i.prototype.optionUpdated = function () {
              'category' === this.option.type &&
                (this.__ordinalMeta = cv.createByAxisModel(this));
            }),
      ...
      t.registerSubTypeDefaulter(e + 'Axis', zx);
  }
  function zx(t) {
  ...
  var Hx = (function (t) {
      function e() {
        var e = (null !== t && t.apply(this, arguments)) || this;
        return (e.type = 'cartesian2d'), (e.dimensions = Fx), e;
      }
      return (
        n(e, t),
        ...
        (e.prototype.containZone = function (t, e) {
          var n = this.dataToPoint(t),
            ...
            r = this.getArea(),
            o = new Ce(n[0], n[1], i[0] - n[0], i[1] - n[1]);
        ...
        (e.prototype.pointToData = function (t, e) {
          var n = [];
          if (this._invTransform) return Et(n, t, this._invTransform);
    ...
    return (
      R(e, function (n, i) {
        var r = i.replace(/Model$/, ''),
          o = t.getReferringComponents(r, Qr).models[0];
        e[i] = o;
      }),
      e
    );
  ...
  function Yx(t, e, n) {
    ...
    if (h && c) d = (y - g) / a;
      ...
      for (y = u[0] + d * a; y < u[1] && isFinite(y) && isFinite(u[1]); )
        (d = gv(d)), (y = u[0] + d * a);
    else if (c)
      for (g = u[1] - d * a; g > u[0] && isFinite(g) && isFinite(u[0]); )
        (d = gv(d)), (g = u[1] - d * a);
    else {
      t.getTicks().length - 1 > a && (d = gv(d));
      var v = d * a;
      (g = gr((y = Math.ceil(u[1] / d) * d) - v)) < 0 && u[0] >= 0
        ? ((g = 0), (y = gr(v)))
        : y > 0 && u[1] <= 0 && ((y = 0), (g = -gr(v)));
    }
    var m = (r[0].value - o[0].value) / s,
      _ = (r[a].value - o[a].value) / s;
    i.setExtent.call(t, g + d * m, y + d * _),
      i.setInterval.call(t, d),
      (m || _) && i.setNiceExtent.call(t, g + d, y - d);
  }
  var qx = (function () {
    function t(t, e, n) {
      (this.type = 'grid'),
    ...
    return (
          ...
          if (i) {
            for (var r = [], o = i - 1; o >= 0; o--) {
              var a = t[+n[o]],
                s = a.model,
                l = a.scale;
              fv(l) && s.get('alignTicks') && null == s.get('interval')
                ? r.push(a)
                : (im(l, s), fv(l) && (e = a));
            }
            r.length &&
              (e || im((e = r.pop()).scale, e.model),
              R(r, function (t) {
                Yx(t.scale, t.model, e.scale);
              }));
          }
        }
      ...
      (t.prototype.resize = function (t, e, n) {
        var i = t.getBoxLayoutParams(),
          ...
          o = ec(i, { width: e.getWidth(), height: e.getHeight() });
        this._rect = o;
                ...
                var e = (function (t) {
                  ...
                  if (e.get(['axisLabel', 'show']) && !n.isBlank()) {
                    var i,
                      r,
                      o = n.getExtent();
                    r = n instanceof wv ? n.count() : (i = n.getTicks()).length;
                    var a,
                      s = t.getLabelModel(),
                      l = om(t),
                      u = 1;
                    ...
                    for (var h = 0; h < r; h += u) {
                      var c = l(i ? i[h] : { value: o[0] + h }, h),
                        p = am(s.getTextRect(c), s.get('rotate') || 0);
                      a ? a.union(p) : (a = p);
                    }
                    return a;
                  }
      ...
      (t.prototype._findConvertTarget = function (t) {
        var e,
          ...
          r =
            t.xAxisModel ||
            (i && i.getReferringComponents('xAxis', Qr).models[0]),
          o =
            t.yAxisModel ||
            (i && i.getReferringComponents('yAxis', Qr).models[0]),
          a = t.gridModel,
          s = this._coordsList;
        if (i) A(s, (e = i.coordinateSystem)) < 0 && (e = null);
        else if (r && o)
            ...
            if (Zx(n, t)) {
              ...
              'x' === e
                ...
                : 'left' !== l &&
                  ...
                  (l = o.left ? 'right' : 'left'),
                (o[l] = !0);
              var u = new Wx(e, rm(n), [0, 0], n.get('type'), l),
                h = 'category' === u.type;
        ...
        function n(t, e) {
          R(
            (function (t, e) {
              var n = {};
              return (
                R(t.mapDimensionsAll(e), function (e) {
                  n[sv(t, e)] = !0;
                }),
                B(n)
              );
        ...
        return (
          R(this.getCartesians(), function (i) {
            var r = null != t && 'auto' !== t ? i.getAxis(t) : i.getBaseAxis(),
              o = i.getOtherAxis(r);
            A(e, r) < 0 && e.push(r), A(n, o) < 0 && n.push(o);
          }),
  ...
  function jx(t, e, n, i) {
    ...
    if (s) {
      if (null != l) Kx(o[l]) && (r = o[l]);
      else
        for (var u in o)
          if (o.hasOwnProperty(u) && Kx(o[u]) && !i[h(o[u])]) {
            r = o[u];
            break;
          }
      r && (i[h(r)] = !0);
  ...
  var $x = Math.PI,
    Qx = (function () {
      ...
      return (
        ...
        (t.prototype.add = function (t) {
          Jx[t](this.opt, this.axisModel, this.group, this._transformGroup);
        }),
    ...
    Jx = {
      axisLine: function (t, e, n, i) {
        ...
        if (
          ...
          Pu(c.shape, c.style.lineWidth), (c.anid = 'line'), n.add(c);
          var p = e.get(['axisLine', 'symbol']);
          if (null != p) {
            var f = e.get(['axisLine', 'symbolSize']);
            G(p) && (p = [p, p]), (G(f) || X(f)) && (f = [f, f]);
            var d = Ed(e.get(['axisLine', 'symbolOffset']) || 0, f),
              g = f[0],
              y = f[1];
            R(
              [
              ...
              function (e, i) {
                if ('none' !== p[i] && null != p[i]) {
                  var r = Nd(p[i], -g / 2, -y / 2, g, y, h.stroke, !0),
                    o = e.r + e.offset,
                    a = u ? l : s;
                  r.attr({
                    rotation: e.rotate,
      ...
      axisTickLabel: function (t, e, n, i) {
        var r = (function (t, e, n, i) {
          ...
          o = (function (t, e, n, i) {
            var r = n.axis,
              o = tt(i.axisLabelShow, n.get(['axisLabel', 'show']));
            if (!o || r.scale.isBlank()) return;
            var a = n.getModel('axisLabel'),
              s = a.get('margin'),
              l = r.getViewLabels(),
              u = ((tt(i.labelRotate, a.get('rotate')) || 0) * $x) / 180,
              h = Qx.innerTextLayout(i.rotation, u, i.labelDirection),
              c = n.getCategories && n.getCategories(!0),
              p = [],
              f = Qx.isLabelSilent(n),
            ...
            return (
              R(l, function (o, l) {
                ...
                if (c && c[u]) {
                  ...
                  Y(m) &&
                    m.textStyle &&
                    (v = new oh(m.textStyle, a, n.ecModel));
                }
                var _ =
                    v.getTextColor() ||
                    n.get(['axisLine', 'lineStyle', 'color']),
                  x = r.dataToCoord(u),
                  w = new Ka({
                    x: x,
                ...
                if (((w.anid = 'label_' + u), d)) {
                  var b = Qx.makeAxisEventDataBase(n);
        ...
        ((function (t, e, n) {
          ...
          !1 === i
            ? (tw(o), tw(u))
            : ew(o, a) && (i ? (tw(a), tw(h)) : (tw(o), tw(u)));
          !1 === r
            ? (tw(s), tw(c))
            : ew(l, s) && (r ? (tw(l), tw(p)) : (tw(s), tw(c)));
        })(e, o, r),
        (function (t, e, n, i) {
          var r = n.axis,
          ...
          for (
            var s = o.getModel('lineStyle'),
              ...
              u = I(
                s.getLineStyle(),
                I(n.getModel('axisTick').getLineStyle(), {
                  stroke: n.get(['axisLine', 'lineStyle', 'color']),
                })
              ),
              h = 0;
            ...
            for (
              var c = iw(a[h], e.transform, l, u, 'minorticks_' + h), p = 0;
              p < c.length;
              p++
            )
              t.add(c[p]);
          ...
          (function (t) {
            ...
            for (var r = 0; r < t.length; r++) {
              ...
              n.copy(o.rect),
                ...
                (n.x += 0.05),
                (n.y += 0.05);
              for (var c = o.obb, p = !1, f = 0; f < e.length; f++) {
                var d = e[f];
                if (n.intersect(d.rect)) {
                  if (a && d.axisAligned) {
                    p = !0;
                    break;
                  }
                  if (
                    (d.obb || (d.obb = new hu(d.localRect, d.transform)),
                    c || (c = new hu(s, l)),
                    c.intersect(d.obb))
                  ) {
                    p = !0;
      ...
      axisName: function (t, e, n, i) {
        var r = tt(t.axisName, e.get('name'));
        if (r) {
          var o,
            a,
            ...
            f = [
              'start' === s
                ...
                : 'end' === s
                  ? c[1] + p * h
                  : (c[0] + c[1]) / 2,
              nw(s) ? t.labelOffset + l * h : 0,
            ],
            d = e.get('nameRotate');
          null != d && (d = (d * $x) / 180),
            nw(s)
              ? (o = Qx.innerTextLayout(
                  t.rotation,
                  null != d ? d : t.rotation,
                  l
                ))
          ...
          var g = u.getFont(),
            ...
            v = y.ellipsis,
            m = tt(t.nameTruncateMaxWidth, y.maxWidth, a),
            _ = new Ka({
              x: f[0],
              y: f[1],
              rotation: o.rotation,
              silent: Qx.isLabelSilent(e),
              style: Vu(u, {
                text: r,
                font: g,
                overflow: 'truncate',
          ...
          if (
            ((function (t) {
              ...
              (u.componentMainType = o),
                ...
                (u.tooltipConfig = {
                  name: i,
                  option: I({ content: i, formatterParams: s }, r),
                });
            })({ el: _, componentModel: e, itemName: r }),
            (_.__fullText = r),
            (_.anid = 'name'),
            e.get('triggerEvent'))
          ) {
            var x = Qx.makeAxisEventDataBase(e);
            (x.targetType = 'axisName'), (x.name = r), (ls(_).eventData = x);
          }
  ...
  function ew(t, e) {
    ...
    if (n && i) {
      ...
      return (
        fe(r, r, -t.rotation),
        n.applyTransform(ce([], r, t.getLocalTransform())),
        i.applyTransform(ce([], r, e.getLocalTransform())),
        n.intersect(i)
      );
    }
  }
  ...
  function ow(t) {
    var e,
      n = (t.ecModel.getComponent('axisPointer') || {}).coordSysAxesInfo;
  ...
  var aw = {},
    ...
    lw = Zr();
  var uw = ['axisLine', 'axisTickLabel', 'axisName'],
    hw = ['splitArea', 'splitLine', 'minorSplitLine'],
    cw = (function (t) {
      function e() {
        var n = (null !== t && t.apply(this, arguments)) || this;
        return (
          (n.type = e.type), (n.axisPointerClass = 'CartesianAxisPointer'), n
        );
      }
      return (
        n(e, t),
          ...
          if (
            ...
            var a = e.getCoordSysModel(),
              s = (function (t, e, n) {
                ...
                (o.position = [
                  ...
                  tt(n.labelInside, e.get(['axisLabel', 'inside'])) &&
                ...
                D(
                  {
                    handleAutoShown: function (t) {
                      for (
                        ...
                        if (fv(n[i].getOtherAxis(e.axis).scale)) return !0;
                      return !1;
                    },
                  },
                  s
            ...
            R(uw, l.add, l),
              ...
              R(
                hw,
                function (t) {
                  e.get([t, 'show']) && pw[t](this, this._axisGroup, e, a);
                },
                this
              ),
                  ...
                  if (t && e) {
                    ...
                    e.traverse(function (t) {
                      if (Ou(t) && t.anid) {
                        ...
                        if (e) {
                          var i = o(t);
                          t.attr(o(e)), gu(t, i, n, ls(t).dataIndex);
                        }
                      }
                    });
                  }
          ...
          for (
            ...
            var v = h++ % s.length,
              ...
              _ = new jl({
                ...
                style: I({ stroke: s[v] }, d),
                silent: !0,
              });
            Pu(_.shape, d.lineWidth), e.add(_);
          }
        }
      },
        ...
        if (l.length)
          for (
            ...
            for (var f = 0; f < l[p].length; f++) {
              ...
              Pu(g.shape, c.lineWidth), e.add(g);
            }
      },
          ...
          if (!r.scale.isBlank()) {
            ...
            if (u.length) {
              ...
              var y = r.toGlobalCoord(u[0].coord),
                v = a.getAreaStyle();
              for (s = H(s) ? s : [s], d = 1; d < u.length; d++) {
    ...
    yw = { offset: 0 };
  var vw = { label: { enabled: !0 }, decal: { show: !1 } },
    mw = Zr(),
    _w = {};
  function xw(t, e) {
      ...
      C(i.label, t.getLocaleModel().get('aria'), !1),
        ...
        (function () {
          if (n.getModel('decal').get('show')) {
            ...
            t.eachSeries(function (t) {
              if (!t.isColorBySeries()) {
                var n = e.get(t.type);
                n || ((n = {}), e.set(t.type, n)), (mw(t).scope = n);
              }
            }),
              t.eachRawSeries(function (e) {
                if (!t.isSeriesFiltered(e))
                  if (W(e.enableAriaDecal)) e.enableAriaDecal();
                  else {
                    var n = e.getData();
                    if (e.isColorBySeries()) {
                      var i = Nc(e.ecModel, e.name, _w, t.getSeriesCount()),
                        r = n.getVisual('decal');
        ...
        (function () {
          var i = t.getLocaleModel().get('aria'),
            o = n.getModel('label');
          if (((o.option = I(o.option, i)), !o.get('enabled'))) return;
          var a = e.getZr().dom;
          ...
          s = p
            ? r(o.get(['general', 'withTitle']), { title: p })
            : o.get(['general', 'withoutTitle']);
          var f = [];
          (s += r(
            l > 1
              ? o.get(['series', 'multiple', 'prefix'])
              : o.get(['series', 'single', 'prefix']),
            { seriesCount: l }
          )),
            t.eachSeries(function (e, n) {
              if (n < c) {
                ...
                i = r(
                  (i =
                    l > 1
                      ? o.get(['series', 'multiple', a])
                      : o.get(['series', 'single', a])),
                  {
                    seriesId: e.seriesIndex,
                    seriesName: e.get('name'),
                    seriesType:
                      ((_ = e.subType),
                      t.getLocaleModel().get(['series', 'typeNames'])[_] ||
                        '自定义图'),
                  }
                );
                var s = e.getData();
                if (s.count() > u)
                  i += r(o.get(['data', 'partialData']), { displayCnt: u });
                else i += o.get(['data', 'allData']);
                for (
                  var h = o.get(['data', 'separator', 'middle']),
                    p = o.get(['data', 'separator', 'end']),
                    d = [],
                    g = 0;
                  g < s.count();
                  g++
                  ...
                  if (g < u) {
                    ...
                    d.push(r(m, { name: y, value: v.join(h) }));
                  }
                (i += d.join(h) + p), f.push(i);
              }
              var _;
            });
          var d = o.getModel(['series', 'multiple', 'separator']),
            g = d.get('middle'),
            y = d.get('end');
          (s += f.join(g) + y), a.setAttribute('aria-label', s);
        })();
    }
    function r(t, e) {
      if (!G(t)) return t;
  ...
  function ww(t) {
    if (t && t.aria) {
      ...
      null != e.show && (e.enabled = e.show),
        (e.label = e.label || {}),
        R(['description', 'general', 'series', 'data'], function (t) {
      ...
      return (
        ...
        (e.prototype.init = function (e, n, i) {
          t.prototype.init.call(this, e, n, i),
            (this._sourceManager = new pf(this)),
            ff(this);
        }),
        (e.prototype.mergeOption = function (e, n) {
          t.prototype.mergeOption.call(this, e, n), ff(this);
        }),
        ...
        (e.type = 'dataset'),
        (e.defaultOption = { seriesLayoutBy: vc }),
        e
      );
    })(ac),
    Sw = (function (t) {
  ...
  Dy([
    function (t) {
      t.registerPainter('canvas', o_);
    },
  ]),
    Dy([
      function (t) {
        t.registerChartView(B_),
          t.registerSeriesModel(a_),
          t.registerLayout(
            (function (t, e) {
              return {
                seriesType: t,
          ...
          t.registerProcessor(t.PRIORITY.PROCESSOR.STATISTIC, H_('line'));
      },
      function (t) {
        t.registerChartView($_),
          t.registerSeriesModel(G_),
          t.registerLayout(t.PRIORITY.VISUAL.LAYOUT, V(Lv, 'bar')),
          t.registerLayout(
                ...
                reset: function (t) {
                  if (Pv(t)) {
                    var e = t.getData(),
                      ...
                      h = av(e, l) && !!e.getCalculationInfo('stackedOnSeries'),
                      c = r.isHorizontal(),
                      p = (function (t, e) {
                        return e.toGlobalCoord(
                          e.dataToCoord('log' === e.type ? 1 : 0)
                        );
                      })(0, r),
                      f = Ov(t),
                      ...
                      progress: function (t, e) {
                        for (
                          ...
                          if (c) {
                            ...
                            h && (T = n.dataToPoint([C, M])[0]),
                              (D = T),
                              (I = L[1] + v),
                              (k = L[0] - T),
                              (A = y),
                              Math.abs(k) < d && (k = (k < 0 ? -1 : 1) * d);
                          } else
                            (L = n.dataToPoint([M, S])),
                              h && (T = n.dataToPoint([M, C])[1]),
                              (D = L[0] + v),
                              (I = T),
                              (k = y),
                              (A = L[1] - T),
                              Math.abs(A) < d && (A = (A <= 0 ? -1 : 1) * d);
                          f
                            ? ((l[b] = D),
                              (l[b + 1] = I),
                              (l[b + 2] = c ? k : A),
          ...
          t.registerProcessor(t.PRIORITY.PROCESSOR.STATISTIC, H_('bar')),
          t.registerAction(
            {
              type: 'changeAxisOrder',
            ...
            R(
              ...
              function (t) {
                e(t[0], function (e, i, r) {
                  (e = D({}, e)),
                    r.dispatchAction(
                      D(e, { type: t[1], seriesIndex: n(i, e) })
                    );
                });
              }
            );
          })('pie', t.registerAction),
          t.registerLayout(V(vx, 'pie')),
          t.registerProcessor(
            (function (t) {
              return {
                seriesType: t,
    ...
    Dy([
      function (t) {
        t.registerComponentView(gw),
          t.registerComponentModel(kx),
          t.registerCoordinateSystem('cartesian2d', qx),
          Ex(t, 'x', Ax, yw),
          Ex(t, 'y', Ax, yw),
          t.registerComponentView(fw),
          t.registerComponentView(dw),
          t.registerPreprocessor(function (t) {
            t.xAxis && t.yAxis && !t.grid && (t.grid = {});
          });
      },
      function (t) {
        t.registerPreprocessor(ww),
          t.registerVisual(t.PRIORITY.VISUAL.ARIA, xw);
      },
      function (t) {
        t.registerComponentModel(bw), t.registerComponentView(Sw);
      },
    ]),
    (t.Axis = Fm),
    (t.ChartView = Pf),
    ...
    (t.dispose = function (t) {
      G(t) ? (t = ny[t]) : t instanceof Xg || (t = uy(t)),
        t instanceof Xg && !t.isDisposed() && t.dispose();
    }),
    (t.env = r),
    (t.extendChartView = function (t) {
      var e = Pf.extend(t);
      return Pf.registerClass(e), e;
    }),
    (t.extendComponentModel = function (t) {
      var e = ac.extend(t);
      return ac.registerClass(e), e;
    }),
    (t.extendComponentView = function (t) {
      var e = If.extend(t);
      return If.registerClass(e), e;
    }),
    (t.extendSeriesModel = function (t) {
      var e = xf.extend(t);
      return xf.registerClass(e), e;
    }),
    (t.format = Dm),
    ...
    (t.init = function (t, e, n) {
      ...
      return (
        ...
        i && to(t, ay, o.id),
        Vg(o),
        cg.trigger('afterinit', o),
        o
      );
    }),
    (t.innerDrawElementOnCanvas = ng),
    (t.matrix = ye),
    (t.number = Mm),
    (t.parseGeoJSON = Sm),
    (t.parseGeoJson = Sm),
    (t.registerAction = yy),
    (t.registerCoordinateSystem = vy),
    (t.registerLayout = my),
    (t.registerLoading = by),
    (t.registerLocale = dh),
    (t.registerMap = Sy),
    (t.registerPostInit = fy),
    (t.registerPostUpdate = dy),
    (t.registerPreprocessor = cy),
    (t.registerProcessor = py),
    (t.registerTheme = hy),
    (t.registerTransform = My),
    (t.registerUpdateLifecycle = gy),
    (t.registerVisual = _y),
