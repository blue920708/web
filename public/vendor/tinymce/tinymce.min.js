    ...
    Ru = (e, t) => {
      ...
      return er(n)
        ...
        : n
          ? ts(n)
            ? I.some(
                e ? Vi.before(n) : ar((o = n)) ? Vi.before(o) : Vi.after(o)
              )
            : ((e, t, n) => {
                ...
                .bind((e) => {
                  ...
                  if (r.length > 0) {
                    if (o) return I.some(Uh.partialTable(r, I.none()));
                    {
                      const e = Kh(n, t);
                      return I.some(
                        Uh.partialTable(r, I.some({ ...t, rng: e }))
                      );
                    }
                  }
                  return I.none();
            ...
            : (t && dr(r.getNode())) || (!t && dr(r.getNode(!0)))
              ? ((e, t, n, o) => {
                  ...
                  return Ah(yn(e), yn(n.getNode()))
                    .map((e) =>
                      gs(e) ? Dx.remove(e.dom) : Dx.moveToElement(r)
                    )
                      ...
                      : ((e, t, n, o) =>
                          ((e, t) => {
                            const n = t.getNode(!e),
                              o = e ? 'after' : 'before';
                            return (
                              qo(n) && n.getAttribute('data-mce-caret') === o
                            );
                          })(t, n)
                            ? ((e, t) =>
                                y(t)
                                  ...
                                  : e && dr(t.nextSibling)
                                    ...
                                    : !e && dr(t.previousSibling)
                                      ? I.some(
                                          Dx.moveToElement(t.previousSibling)
                                        )
